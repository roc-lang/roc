...
render =
    ...
    Col
        [
            Row
                [
                    Button (Text "Corner     ") styles onClick,
                    Button (Text "Top Mid    ") { styles & bgColor: rgba 100 100 50 1 } onClick,
                    Button (Text "Top Right  ") { styles & bgColor: rgba 50 50 150 1 } onClick,
                ],
            Button (Text "Mid Left   ") { styles & bgColor: rgba 150 100 100 1 } onClick,
            Button (Text "Bottom Left") { styles & bgColor: rgba 150 50 50 1 } onClick,
        ]
