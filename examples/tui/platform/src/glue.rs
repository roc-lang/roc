...
impl core::fmt::Debug for discriminant_Color {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            Self::None => f.write_str("discriminant_Color::None"),
...
impl Color {
    ...
    pub fn discriminant(&self) -> discriminant_Color {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_Color>(*bytes.as_ptr().add(0))
        }
    }
    ...
    pub const Black: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::Black as u8;
    ...
    pub const Blue: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::Blue as u8;
    ...
    pub const Cyan: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::Cyan as u8;
    ...
    pub const DarkGray: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::DarkGray as u8;
    ...
    pub const Gray: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::Gray as u8;
    ...
    pub const Green: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::Green as u8;
    ...
    pub const LightBlue: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::LightBlue as u8;
    ...
    pub const LightCyan: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::LightCyan as u8;
    ...
    pub const LightGreen: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::LightGreen as u8;
    ...
    pub const LightMagenta: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::LightMagenta as u8;
    ...
    pub const LightRed: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::LightRed as u8;
    ...
    pub const LightYellow: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::LightYellow as u8;
    ...
    pub const Magenta: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::Magenta as u8;
    ...
    pub const None: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::None as u8;
    ...
    pub const Red: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::Red as u8;
    ...
    pub const White: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::White as u8;
    ...
    pub const Yellow: Self = unsafe {
        ...
        bytes[0] = discriminant_Color::Yellow as u8;
    ...
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        ...
        unsafe {
            match self.discriminant() {
                ...
                discriminant_Color::None => Some(core::cmp::Ordering::Equal),
...
impl Ord for Color {
    ...
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
            ...
            match self.discriminant() {
                ...
                discriminant_Color::None => core::cmp::Ordering::Equal,
        ...
        let mut answer = unsafe {
            match self.discriminant() {
                ...
                discriminant_Color::Magenta => core::mem::transmute::<
                    ...
                    Color,
                >(core::mem::MaybeUninit::uninit()),
                discriminant_Color::None => core::mem::transmute::<
                    core::mem::MaybeUninit<Color>,
                    Color,
                >(core::mem::MaybeUninit::uninit()),
...
impl core::hash::Hash for Color {
    ...
    fn hash<H: core::hash::Hasher>(&self, state: &mut H) {        match self.discriminant() {
            ...
            discriminant_Color::None => discriminant_Color::None.hash(state),
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        unsafe {
            match self.discriminant() {
                ...
                discriminant_Color::None => f.write_str("None"),
