...
pub extern "C" fn rust_main() {
    ...
    unsafe {
        ...
        let answer: *mut RocStr = buffer.cast();
...
#[no_mangle]
pub extern "C" fn roc_fx_envVar(roc_str: &RocStr) -> RocStr {
    println!("roc_fx_envVar is running and will return empty string");
    println!("roc_fx_envVar received {:?} as its argument", roc_str);
