...
// The serialized header includes three 24-byte publication/attachment descriptors.
const expected_moduleenv_size = 3520; // Platform-independent size
const expected_nodestore_size = 528; // Platform-independent size
