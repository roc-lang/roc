BoxyParserCountedFormat :: [].{}

## The counted-format parser fixture, run with Boxy specialization so the
## driver's counted container paths are covered by that lowering too.
