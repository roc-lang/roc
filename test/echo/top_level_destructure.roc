...
# binding of the destructured value), a destructured value is readable, a tuple
# destructure works the same way, and any of them may be referenced ahead of
# its declaration like a plainly named top-level value.
first = greet("Ada")
