...
It has the type:
    __arg, _arg2, (e -> e), (h -> h) -> _ret where [Num.Numeral.from_numeral : Num.Numeral -> Try(_i, [InvalidNumeral(Str)]), Num.Numeral.from_numeral : Num.Numeral -> Try(_j, [InvalidNumeral(Str)]), Num.Numeral.from_numeral : Num.Numeral -> Try(_k, [InvalidNumeral(Str)]), Num.Numeral.from_numeral : Num.Numeral -> Try(_l, [InvalidNumeral(Str)]), Num.Numeral.from_numeral : Num.Numeral -> Try(_m, [InvalidNumeral(Str)]), Num.Numeral.from_numeral : Num.Numeral -> Try(_n, [InvalidNumeral(Str)])]_
