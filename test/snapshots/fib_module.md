...
(inferred-types
	(defs
		(patt (type "_size -> _size2 where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]")))
	(expressions
		(expr (type "_size -> _size2 where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]"))))
~~~
