			...
			(e-lambda
				...
				(e-block
					(s-let
						...
						(e-dispatch-call (method "shl_wrap") (constraint-fn-var 328)
							(receiver
								(e-dispatch-call (method "to_u64") (constraint-fn-var 319)
									(receiver
										(e-lookup-local
											(p-assign (ident "hi"))))
									(args)))
							(args
								(e-num (value "32")))))
					(e-dispatch-call (method "bitwise_or") (constraint-fn-var 332)
						(receiver
							(e-lookup-local
								(p-assign (ident "hi_shifted"))))
						(args
							(e-dispatch-call (method "to_u64") (constraint-fn-var 330)
								(receiver
									(e-lookup-local
										(p-assign (ident "lo"))))
								(args)))))))
