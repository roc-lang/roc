...
(can-ir
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x")))
			(e-dispatch-call (method "get_value") (constraint-fn-var 425)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args)))
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x"))
				(p-assign (ident "fn")))
			(e-dispatch-call (method "transform") (constraint-fn-var 442)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args
	...
	(d-let
		...
		(e-dispatch-call (method "get_value") (constraint-fn-var 509)
			(receiver
				(e-lookup-local
					(p-assign (ident "myContainer"))))
			(args))
			...
			(e-lambda
				...
				(e-block
					(s-let
						...
						(e-lookup-local
							(p-assign (ident "s"))))
					(e-interpolation (constraint-fn-var 540) (dispatcher-var 116)
						(first
							(e-literal (string "")))
						(parts
							(e-lookup-local
