...
(can-ir
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x")))
			(e-dispatch-call (method "get_value") (constraint-fn-var 248)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args)))
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x"))
				(p-assign (ident "fn")))
			(e-dispatch-call (method "transform") (constraint-fn-var 281)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args
	...
	(d-let
		...
		(e-dispatch-call (method "get_value") (constraint-fn-var 404)
			(receiver
				(e-lookup-local
					(p-assign (ident "myContainer"))))
			(args))
