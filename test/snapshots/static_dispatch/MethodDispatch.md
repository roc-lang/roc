...
(can-ir
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x")))
			(e-dispatch-call (method "get_value") (constraint-fn-var 241)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args)))
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x"))
				(p-assign (ident "fn")))
			(e-dispatch-call (method "transform") (constraint-fn-var 274)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args
	...
	(d-let
		...
		(e-dispatch-call (method "get_value") (constraint-fn-var 335)
			(receiver
				(e-lookup-local
					(p-assign (ident "myContainer"))))
			(args))
