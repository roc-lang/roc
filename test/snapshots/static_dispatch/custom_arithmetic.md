...
(can-ir
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				(fields
					(field (name "x")
						(e-dispatch-call (method "minus") (constraint-fn-var 454)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
							...
							(args
								(e-field-access
									...
									(segments
										(segment (name "x") (mode "required")))))))
					(field (name "y")
						(e-dispatch-call (method "minus") (constraint-fn-var 475)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				(fields
					(field (name "x")
						(e-dispatch-call (method "times") (constraint-fn-var 509)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
							...
							(args
								(e-field-access
									...
									(segments
										(segment (name "x") (mode "required")))))))
					(field (name "y")
						(e-dispatch-call (method "times") (constraint-fn-var 530)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "minus") (constraint-fn-var 632)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
