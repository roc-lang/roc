...
(can-ir
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				(fields
					(field (name "x")
						(e-dispatch-call (method "minus") (constraint-fn-var 295)
							(receiver
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
								...
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
											(p-assign (ident "b"))))))))
					(field (name "y")
						(e-dispatch-call (method "times") (constraint-fn-var 406)
							(receiver
								(e-field-access (field "y")
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "minus") (constraint-fn-var 897)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 918)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
