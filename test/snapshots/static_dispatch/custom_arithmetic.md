...
(can-ir
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				(fields
					(field (name "x")
						(e-dispatch-call (method "minus") (constraint-fn-var 607)
							(receiver
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
								...
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
											(p-assign (ident "b"))))))))
					(field (name "y")
						(e-dispatch-call (method "minus") (constraint-fn-var 625)
							(receiver
								(e-field-access (field "y")
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				(fields
					(field (name "x")
						(e-dispatch-call (method "times") (constraint-fn-var 700)
							(receiver
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
								...
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
											(p-assign (ident "b"))))))))
					(field (name "y")
						(e-dispatch-call (method "times") (constraint-fn-var 718)
							(receiver
								(e-field-access (field "y")
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 1200)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "minus") (constraint-fn-var 1221)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 1242)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
