...
(can-ir
								...
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
											(p-assign (ident "b"))))))))
					(field (name "y")
						(e-dispatch-call (method "minus") (constraint-fn-var 315)
							(receiver
								(e-field-access (field "y")
									(receiver
										(e-lookup-local
								...
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
											(p-assign (ident "b"))))))))
					(field (name "y")
						(e-dispatch-call (method "times") (constraint-fn-var 408)
							(receiver
								(e-field-access (field "y")
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "minus") (constraint-fn-var 911)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 932)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
