...
(can-ir
							...
							(args
								(e-field-access
									...
									(segments
										(segment (name "x") (mode "required")))))))
					(field (name "y")
						(e-dispatch-call (method "minus") (constraint-fn-var 462)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
							...
							(args
								(e-field-access
									...
									(segments
										(segment (name "x") (mode "required")))))))
					(field (name "y")
						(e-dispatch-call (method "times") (constraint-fn-var 517)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 584)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "minus") (constraint-fn-var 589)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 594)
			(receiver
				(e-lookup-local
					(p-assign (ident "v1"))))
			(args
