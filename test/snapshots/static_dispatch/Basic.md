...
(can-ir
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "test")))
			(e-dispatch-call (method "to_str") (constraint-fn-var 135)
				(receiver
					(e-lookup-local
						(p-assign (ident "test"))))
				(args)))
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x")))
			(e-dispatch-call (method "to_str") (constraint-fn-var 143)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args)))
	...
	(d-let
		...
		(e-lambda
			(args
				(p-assign (ident "x")))
			(e-dispatch-call (method "to_str2") (constraint-fn-var 151)
				(receiver
					(e-lookup-local
						(p-assign (ident "x"))))
				(args)))
