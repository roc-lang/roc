	...
	(d-let
		...
		(e-block
			...
			(s-let
				...
				(e-dispatch-call (method "get_or") (constraint-fn-var 262)
					(receiver
						(e-dispatch-call (method "flat_map") (constraint-fn-var 242)
							(receiver
								(e-dispatch-call (method "map") (constraint-fn-var 214)
									(receiver
										(e-lookup-local
											(p-assign (ident "num_container"))))
									(args
