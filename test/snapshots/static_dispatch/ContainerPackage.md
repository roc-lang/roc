	...
	(d-let
		...
		(e-block
								...
								(e-lambda
									...
									(e-block
										(s-let
											...
											(e-dispatch-call (method "map") (constraint-fn-var 752)
												(receiver
													(e-lookup-local
														(p-assign (ident "container"))))
												(args
													(e-lookup-local
														(p-assign (ident "f"))))))
										(e-dispatch-call (method "get_or") (constraint-fn-var 754)
											(receiver
												(e-lookup-local
													(p-assign (ident "mapped"))))
											(args
				...
				(e-dispatch-call (method "map") (constraint-fn-var 874)
					...
					(args
						(e-lambda
							(args
								(p-assign (ident "x")))
							(e-dispatch-call (method "plus") (constraint-fn-var 891)
								(receiver
									(e-lookup-local
										(p-assign (ident "x"))))
								(args
			...
			(s-let
				...
				(e-dispatch-call (method "get_or") (constraint-fn-var 960)
					(receiver
						(e-dispatch-call (method "flat_map") (constraint-fn-var 925)
							(receiver
								(e-dispatch-call (method "map") (constraint-fn-var 905)
									(receiver
										(e-lookup-local
											(p-assign (ident "num_container"))))
									(args
										(e-lambda
											(args
												(p-assign (ident "x")))
											(e-dispatch-call (method "plus") (constraint-fn-var 922)
												(receiver
													(e-lookup-local
														(p-assign (ident "x"))))
												(args
			...
			(s-let
				...
				(e-lambda
					(args
						(p-assign (ident "x")))
					(e-dispatch-call (method "plus") (constraint-fn-var 972)
						(receiver
							(e-lookup-local
								(p-assign (ident "x"))))
						(args
