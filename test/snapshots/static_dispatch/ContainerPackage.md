	...
	(d-let
		...
		(e-block
								...
								(e-lambda
									...
									(e-block
										(s-let
											...
											(e-dispatch-call (method "map") (constraint-fn-var 750)
												(receiver
													(e-lookup-local
														(p-assign (ident "container"))))
												(args
													(e-lookup-local
														(p-assign (ident "f"))))))
										(e-dispatch-call (method "get_or") (constraint-fn-var 752)
											(receiver
												(e-lookup-local
													(p-assign (ident "mapped"))))
											(args
			...
			(s-let
				...
				(e-call (constraint-fn-var 856)
					(e-lookup-local
						(p-assign (ident "processor")))
					(e-num (value "5"))))
			(s-let
				(p-assign (ident "num_result"))
				(e-dispatch-call (method "map") (constraint-fn-var 866)
					(receiver
						(e-lookup-local
							(p-assign (ident "num_container"))))
					(args
						(e-lambda
							(args
								(p-assign (ident "x")))
							(e-dispatch-call (method "plus") (constraint-fn-var 864)
								(receiver
									(e-lookup-local
										(p-assign (ident "x"))))
								(args
			...
			(s-let
				...
				(e-dispatch-call (method "map") (constraint-fn-var 874)
					(receiver
						(e-lookup-local
							(p-assign (ident "str_container"))))
					(args
			...
			(s-let
				...
				(e-dispatch-call (method "get_or") (constraint-fn-var 931)
					(receiver
						(e-dispatch-call (method "flat_map") (constraint-fn-var 916)
							(receiver
								(e-dispatch-call (method "map") (constraint-fn-var 891)
									(receiver
										(e-lookup-local
											(p-assign (ident "num_container"))))
									(args
							...
							(args
								(e-lambda
									...
									(e-nominal (nominal "Container")
										(e-tag (name "Value")
											(args
												(e-dispatch-call (method "plus") (constraint-fn-var 906)
													(receiver
														(e-lookup-local
															(p-assign (ident "x"))))
													(args
			...
			(s-let
				...
				(e-lambda
					(args
						(p-assign (ident "x")))
					(e-dispatch-call (method "plus") (constraint-fn-var 936)
						(receiver
							(e-lookup-local
								(p-assign (ident "x"))))
						(args
				...
				(fields
					...
					(field (name "transformed")
						(e-lookup-local
							(p-assign (ident "transformed"))))
					(field (name "final")
						(e-dispatch-call (method "get_or") (constraint-fn-var 963)
							(receiver
								(e-lookup-local
									(p-assign (ident "num_result"))))
							(args
