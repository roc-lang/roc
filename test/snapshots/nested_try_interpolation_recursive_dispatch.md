			...
			(e-tag (name "Ok")
				(args
					(e-nominal (nominal "Url")
						(e-tag (name "Url")
							(args
								(e-dispatch-call (method "fold") (constraint-fn-var 324)
									(receiver
										(e-lookup-local
											(p-assign (ident "rest"))))
									(args
										...
										(e-lambda
											...
											(e-dispatch-call (method "concat") (constraint-fn-var 322)
												(receiver
													(e-dispatch-call (method "concat") (constraint-fn-var 320)
														(receiver
															(e-lookup-local
																(p-assign (ident "acc"))))
														(args
