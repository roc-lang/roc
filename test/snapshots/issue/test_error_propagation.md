...
MISSING METHOD - test_error_propagation.md:6:10:6:14
# PROBLEMS
...
**MISSING METHOD**
This **try_from_str** method is being called on the type **GoodAlias**, which has no method with that name:
**test_error_propagation.md:6:10:6:14:**
```roc
value = "test"
```
         ^^^^
