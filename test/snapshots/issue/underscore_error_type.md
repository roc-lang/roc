...
(can-ir
	...
	(d-let
		...
		(e-list @9.7-9.16
			(elems
				(e-num @9.8-9.9 (value "1"))
				(e-num @9.11-9.12 (value "2"))
				(e-num @9.14-9.15 (value "3"))))
		(annotation @9.1-9.4
			(declared-type
				(ty-lookup @8.7-8.14 (name "BadList") (local)))))
	(d-let
		...
		(e-record @14.7-14.32
			(fields
				...
				(field (name "other")
					(e-num @14.29-14.30 (value "5")))))
		(annotation @14.1-14.4
			(declared-type
				(ty-lookup @13.7-13.16 (name "BadRecord") (local)))))
	(d-let
		...
		(annotation @19.1-19.4
			(declared-type
				(ty-lookup @18.7-18.18 (name "BadFunction") (local)))))
	(d-let
	...
	(s-nominal-decl @11.1-11.38
		...
		(ty-record @11.14-11.38
			(field (field "field")
				(ty-underscore @1.1-1.1))
			(field (field "other")
				(ty-lookup @11.33-11.36 (name "U32") (builtin)))))
	...
	(s-nominal-decl @21.1-21.21
		...
		(ty-tuple @21.13-21.21
			...
			(ty-lookup @21.17-21.20 (name "U32") (builtin)))))
~~~
# TYPES
~~~clojure
(inferred-types
	...
	(type_decls
		(nominal @1.1-1.13 (type "BadType")
			(ty-header @1.1-1.8 (name "BadType")))
		(nominal @6.1-6.19 (type "BadList")
			(ty-header @6.1-6.8 (name "BadList")))
		(nominal @11.1-11.38 (type "BadRecord")
			(ty-header @11.1-11.10 (name "BadRecord")))
		(nominal @16.1-16.22 (type "BadFunction")
			(ty-header @16.1-16.12 (name "BadFunction")))
		(nominal @21.1-21.21 (type "BadTuple")
			(ty-header @21.1-21.9 (name "BadTuple"))))
	(expressions
