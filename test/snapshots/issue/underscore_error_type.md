...
It has the type:
    _List(_a) where [Numeral.from_numeral : Numeral -> Try(_b, [InvalidNumeral(Str)])]_
...
It has the type:
    _{ field: Str, other: _field2 } where [Numeral.from_numeral : Numeral -> Try(_a, [InvalidNumeral(Str)])]_
...
It has the type:
    _(Str, _field2) where [Numeral.from_numeral : Numeral -> Try(_a, [InvalidNumeral(Str)])]_
