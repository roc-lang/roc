...
~~~
# EXPECTED
MISSING MAIN! FUNCTION - simple_lambda_constraint_success.md:2:1:7:24
# PROBLEMS
...
`main! = |arg| { ... }`
**simple_lambda_constraint_success.md:2:1:7:24:**
```roc
addTwo : I64 -> I64
addTwo = |x| x + 2
...
(inferred-types
	(defs
		(patt @3.1-3.7 (type "I64 -> I64"))
		(patt @7.1-7.10 (type "F64 -> F64")))
	(expressions
		(expr @3.10-3.19 (type "I64 -> I64"))
		(expr @7.13-7.24 (type "F64 -> F64"))))
~~~
