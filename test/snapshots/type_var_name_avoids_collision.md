...
(inferred-types
	(defs
		(patt (type "_ac where [_ad.from_num_literal : _arg2 -> _ret]"))
		(patt (type "ac -> ac"))
		(patt (type "Str"))
		(patt (type "_ac where [_ad.from_num_literal : _arg2 -> _ret]"))
		...
		(patt (type "_ac where [_ad.from_num_literal : _arg2 -> _ret]"))
		(patt (type "ac -> ac"))
		(patt (type "_arg2 -> _ret where [_ac.from_num_literal : _arg3 -> _ret2]")))
	(expressions
		(expr (type "_ac where [_ad.from_num_literal : _arg2 -> _ret]"))
		(expr (type "ac -> ac"))
		(expr (type "Str"))
		(expr (type "_ac where [_ad.from_num_literal : _arg2 -> _ret]"))
		...
		(expr (type "_ac where [_ad.from_num_literal : _arg2 -> _ret]"))
		(expr (type "ac -> ac"))
		(expr (type "_arg2 -> _ret where [_ac.from_num_literal : _arg3 -> _ret2]"))))
~~~
