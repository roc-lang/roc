...
(inferred-types
	(defs
		(patt (type "_size where [_ac.from_int_digits : _arg -> _ret, _ad.from_dec_digits : _arg -> _ret]"))
		(patt (type "ac -> ac"))
		(patt (type "Str"))
		(patt (type "_size where [_ac.from_dec_digits : _arg -> _ret]"))
		...
		(patt (type "_size where [_ac.from_int_digits : _arg -> _ret, _ad.from_dec_digits : _arg -> _ret]"))
		(patt (type "ac -> ac"))
		(patt (type "_arg2 -> _size where [_ac.from_int_digits : _arg -> _ret, _ad.from_dec_digits : _arg -> _ret]")))
	(expressions
		(expr (type "_size where [_ac.from_int_digits : _arg -> _ret, _ad.from_dec_digits : _arg -> _ret]"))
		(expr (type "ac -> ac"))
		(expr (type "Str"))
		(expr (type "_size where [_ac.from_dec_digits : _arg -> _ret]"))
		...
		(expr (type "_size where [_ac.from_int_digits : _arg -> _ret, _ad.from_dec_digits : _arg -> _ret]"))
		(expr (type "ac -> ac"))
		(expr (type "_arg2 -> _size where [_ac.from_int_digits : _arg -> _ret, _ad.from_dec_digits : _arg -> _ret]"))))
~~~
