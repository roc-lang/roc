...
It has the type:
    __arg, _arg2 -> _ret where [Num.Numeral.from_numeral : Num.Numeral -> Try(_c, [InvalidNumeral(Str)]), Num.Numeral.from_numeral : Num.Numeral -> Try(_d, [InvalidNumeral(Str)])]_
