# META
~~~ini
description=Derived == on a tuple must check a nominal element's own is_eq method where clause like a direct comparison does (issue 11575)
type=snippet
~~~
# SOURCE
~~~roc
...
~~~
# EXPECTED
MISSING METHOD - derived_eq_tuple_nominal_component_issue_11575.md:12:5:12:11
# PROBLEMS
~~~clojure
(reports
	(report
		...
		(document
			(source-region (file "derived_eq_tuple_nominal_component_issue_11575.md") (start 12 5) (end 12 11) (annotation error) (line-text "y = x == x"))
			(line-break)
...
CloseCurly,
CloseCurly,
LowerIdent,OpColon,OpenRound,UpperIdent,NoSpaceOpenRound,UpperIdent,CloseRound,Comma,UpperIdent,CloseRound,
LowerIdent,OpAssign,OpenRound,UpperIdent,NoSpaceOpenRound,StringStart,StringPart,StringEnd,CloseRound,Comma,StringStart,StringPart,StringEnd,CloseRound,
...
(can-ir
	(d-let
		(p-assign (ident "derived_eq_tuple_nominal_component_issue_11575.Nullable.is_eq"))
		(e-lambda
			(args
				(p-assign (ident "x"))
				(p-assign (ident "_y")))
