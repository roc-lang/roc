...
~~~
# EXPECTED
MISSING MAIN! FUNCTION - module_record_destructure.md:1:1:6:2
# PROBLEMS
...
`main! = |arg| { ... }`
**module_record_destructure.md:1:1:6:2:**
```roc
extract_age : { age : U64 } -> U64
extract_age = |person| {
    { age } = person
...
(inferred-types
	(defs
		(patt @2.1-2.12 (type "{ age: U64 } -> U64")))
	(expressions
		(expr @2.15-6.2 (type "{ age: U64 } -> U64"))))
~~~
