			...
			(field (name "greeting")
				(e-block
					(s-let
						...
						(e-lookup-local
							(p-assign (ident "name"))))
					(e-interpolation (constraint-fn-var 135)
						(first
							(e-literal (string "Hello ")))
						(rest
							(e-dispatch-call (method "prepended") (constraint-fn-var 93)
								(receiver
									(e-dispatch-call (method "iter") (constraint-fn-var 42)
										(receiver
											(e-empty_list))
										(args)))
								(args
							...
							(destructs
								...
								(record-destruct (label "a") (ident "a")
									(rest-pattern
										(p-assign (ident "a")))))))))
			(field (name "is_adult")
				(e-dispatch-call (method "is_gte") (constraint-fn-var 170)
					(receiver
						(e-lookup-local
							(p-assign (ident "age"))))
					(args
