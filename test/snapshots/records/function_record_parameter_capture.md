			...
			(field (name "greeting")
				(e-block
					(s-let
						...
						(e-lookup-local
							(p-assign (ident "name"))))
					(e-interpolation (constraint-fn-var 246) (dispatcher-var 15)
						(first
							...
							(destructs
								...
								(record-destruct (label "a") (ident "a")
									(rest-pattern
										(p-assign (ident "a")))))))))
			(field (name "is_adult")
				(e-dispatch-call (method "is_gte") (constraint-fn-var 258)
					(receiver
						(e-lookup-local
							(p-assign (ident "age"))))
					(args
...
# TYPES
~~~clojure
(expr (type "{ age: b, name: c, ..d } -> { full_record: { age: b, name: c, ..d }, greeting: e, is_adult: Bool } where [b.from_numeral : Numeral -> Try(b, [InvalidNumeral(Str)]), b.is_gte : b, b -> Bool, e.from_interpolation : Str, Iter((_field, Str)) -> e]"))
~~~
