...
# TYPES
~~~clojure
(expr (type "{ a: b, age: _size, name: c } -> { full_record: { a: b, age: _size2, name: c }, greeting: Str, is_adult: Bool } where [_d.from_int_digits : _arg -> _ret, _e.from_dec_digits : _arg -> _ret]"))
~~~
