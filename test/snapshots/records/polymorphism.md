...
The value's type, which does not have a method named **to_str**, is:
    ...
    _{ first: a, first: Str, first: [True]b, pair1: { first: a, second: Str }, pair2: { first: Str, second: c }, pair3: { first: [True]b, second: [False]d }, second: Str, second: c, second: [False]d } where [a.from_numeral : Num.Numeral -> Try(_e, [InvalidNumeral(Str)]), c.from_numeral : Num.Numeral -> Try(_f, [InvalidNumeral(Str)])]_
