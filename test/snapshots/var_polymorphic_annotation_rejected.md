...
(reports
	(report
		...
		(document
			...
			(line-break)
			(line-break)
			(source-region (file "var_polymorphic_annotation_rejected.md") (start 5 9) (end 5 11) (annotation warning) (line-text "    var xs = []"))))
	(report
		(severity warning)
		...
		(document
			...
			(line-break)
			(source-region (file "var_polymorphic_annotation_rejected.md") (start 5 9) (end 5 11) (annotation error) (line-text "    var xs = []"))))
	(report
