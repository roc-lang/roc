			...
			(e-block
				...
				(s-for
					...
					(e-block
						...
						(s-reassign
							(p-assign (ident "number"))
							(e-dispatch-call (method "plus") (constraint-fn-var 4792)
								(receiver
									(e-lookup-local
										(p-assign (ident "number"))))
								(args
				...
				(s-let
					...
					(e-if
						(if-branches
							(if-branch
								(e-dispatch-call (method "is_gt") (constraint-fn-var 5268)
									(receiver
										(e-match
											(match
												(cond
												...
												(branches
													...
													(branch
														...
														(value
															(e-num (value "12"))))))))
									(args
										(e-dispatch-call (method "times") (constraint-fn-var 5263)
											(receiver
												(e-num (value "5")))
											(args
												(e-num (value "5"))))))
								...
								(if-branches
									(if-branch
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_lt") (constraint-fn-var 5385)
														(receiver
															(e-dispatch-call (method "plus") (constraint-fn-var 5347)
																(receiver
																	(e-num (value "13")))
																(args
																	(e-num (value "2")))))
														(args
															(e-num (value "5"))))
													(e-dispatch-call (method "is_gte") (constraint-fn-var 5494)
														(receiver
															(e-dispatch-call (method "minus") (constraint-fn-var 5456)
																(receiver
																	(e-num (value "10")))
																(args
																	(e-num (value "1")))))
										...
										(e-nominal-external
											...
											(e-tag (name "True")))))
								(if-else
									(e-dispatch-call (method "is_lte") (constraint-fn-var 5613)
										(receiver
											(e-num (value "12")))
										(args
											(e-dispatch-call (method "div_by") (constraint-fn-var 5608)
												(receiver
													(e-num (value "3")))
												(args
													(e-num (value "5")))))))))))
								...
								(e-field-access (field "record_field")
									(receiver
										(e-match
											(match
												(cond
													(e-dispatch-call (method "next_static_dispatch_method") (constraint-fn-var 5679)
														(receiver
															(e-match
																(match
																	(cond
																		(e-dispatch-call (method "static_dispatch_method") (constraint-fn-var 5646)
																			(receiver
																				(e-match
																					(match
																						(cond
