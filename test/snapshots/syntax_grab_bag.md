...
-- ⚠️ UNUSED VARIABLE --------------------------------- syntax_grab_bag.md:97:3
...
-- ⚠️ UNUSED VARIABLE ---------------------------------- syntax_grab_bag.md:1:1
...
-- ⚠️ UNUSED VARIABLE ------------------------------- syntax_grab_bag.md:121:21
...
-- ⚠️ UNUSED VARIABLE -------------------------------- syntax_grab_bag.md:127:4
...
-- ⚠️ UNUSED VARIABLE --------------------------------- syntax_grab_bag.md:82:2
...
-- ⚠️ UNUSED VARIABLE -------------------------------- syntax_grab_bag.md:164:2
...
-- ⚠️ UNUSED VARIABLE -------------------------------- syntax_grab_bag.md:178:2
...
-- ⚠️ UNUSED VARIABLE -------------------------------- syntax_grab_bag.md:180:2
...
-- ⚠️ UNUSED VARIABLE -------------------------------- syntax_grab_bag.md:188:2
...
-- ⚠️ UNUSED VARIABLE -------------------------------- syntax_grab_bag.md:189:2
...
-- ⚠️ DECLARATION HAS NO VALUE ----------------------- syntax_grab_bag.md:201:1
			...
			(e-block
				...
				(s-let
					...
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "world"))))
						(e-interpolation (constraint-fn-var 1520) (dispatcher-var 373)
							(first
				...
				(s-for
					...
					(e-block
						...
						(s-reassign
							(p-assign (ident "number"))
							(e-dispatch-call (method "plus") (constraint-fn-var 1602)
								(receiver
									(e-runtime-error (tag "erroneous_value_use")))
								(args
									(e-runtime-error (tag "erroneous_value_use")))))
				...
				(s-let
					...
					(e-if
						(if-branches
							(if-branch
								(e-dispatch-call (method "is_gt") (constraint-fn-var 1738)
									(receiver
										(e-runtime-error (tag "erroneous_value_expr")))
									(args
										(e-dispatch-call (method "times") (constraint-fn-var 1735)
											(receiver
												(e-num (value "5")))
											(args
												(e-num (value "5"))))))
								...
								(if-branches
									(if-branch
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_lt") (constraint-fn-var 1771)
														(receiver
														...
														(args
															(e-num (value "5"))))
													(e-dispatch-call (method "is_gte") (constraint-fn-var 1798)
														(receiver
															(e-dispatch-call (method "minus") (constraint-fn-var 1788)
																(receiver
																	(e-num (value "10")))
																(args
																	(e-num (value "1")))))
										...
										(e-nominal-external
											...
											(e-tag (name "True")))))
								(if-else
									(e-dispatch-call (method "is_lte") (constraint-fn-var 1835)
										(receiver
											(e-num (value "12")))
										(args
											(e-dispatch-call (method "div_by") (constraint-fn-var 1832)
												(receiver
													(e-num (value "3")))
												(args
													(e-num (value "5")))))))))))
								...
								(e-field-access (field "record_field")
									(receiver
										(e-match
											(match
												(cond
													(e-dispatch-call (method "next_static_dispatch_method") (constraint-fn-var 1893)
														(receiver
															(e-match
																(match
																	(cond
																		(e-dispatch-call (method "static_dispatch_method") (constraint-fn-var 1864)
																			(receiver
																				(e-runtime-error (tag "erroneous_value_expr")))
																			(args)))
																	(branches
