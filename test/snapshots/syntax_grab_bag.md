...
~~~
# EXPECTED
UNEXPECTED TOKEN IN EXPRESSION - syntax_grab_bag.md:189:65:189:66
UNEXPECTED TOKEN IN EXPRESSION - syntax_grab_bag.md:189:66:189:94
...
NOT IMPLEMENTED - :0:0:0:0
UNRECOGNIZED SYNTAX - syntax_grab_bag.md:189:65:189:66
UNRECOGNIZED SYNTAX - syntax_grab_bag.md:189:66:189:94
NOT IMPLEMENTED - :0:0:0:0
NOT IMPLEMENTED - :0:0:0:0
...
**syntax_grab_bag.md:189:66:189:94:**
```roc
	static_dispatch_style = some_fn(arg1)?.static_dispatch_method()?.next_static_dispatch_method()?.record_field?
```
	                                                                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
