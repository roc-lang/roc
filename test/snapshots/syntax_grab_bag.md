...
MOD NOT FOUND - syntax_grab_bag.md:43:32:43:41
MOD NOT FOUND - syntax_grab_bag.md:46:8:46:17
MOD NOT FOUND - syntax_grab_bag.md:53:8:53:17
DOES NOT EXIST - syntax_grab_bag.md:175:3:175:15
DOES NOT EXIST - syntax_grab_bag.md:190:2:190:14
...
(reports
	...
	(report
		...
		(headline
			...
			(reflow "."))
		(document
			(source-region (file "syntax_grab_bag.md") (start 6 1) (end 12 4) (annotation error) (line-text "import # Comment after import keyword\n\tpf # Comment after qualifier\n\t\t.StdoutMultiline # Comment after ident\n\t\texposing [ # Comment after exposing open\n\t\t\tline!, # Comment after exposed item\n\t\t\twrite!, # Another after exposed item\n\t\t] # Comment after exposing close"))
			(line-break)
	...
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 102 19) (end 102 23))
		(headline
			(reflow "Variable ")
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "syntax_grab_bag.md") (start 102 19) (end 102 23) (annotation error) (line-text "\t\t[1, 2, 3, .. as rest] # After pattern comment"))))
	(report
		(severity fatal)
		(title "Not Implemented")
	...
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 108 23) (end 108 27))
		(headline
			(reflow "Variable ")
			(annotated symbol-unqualified "rest")
			(reflow " is defined here and then never used:"))
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "syntax_grab_bag.md") (start 108 23) (end 108 27) (annotation error) (line-text "\t\t[1, 2 | 5, 3, .. as rest] => 123"))))
	(report
		(severity fatal)
		(title "Not Implemented")
	...
	(report
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "syntax_grab_bag.md") (start 115 6) (end 115 10) (annotation error) (line-text "\t\t\t\t\trest, # After last pattern in list"))))
	(report
		(severity fatal)
		(title "Not Implemented")
	...
	(report
		...
		(document
			...
			(line-break)
			(line-break)
			(source-region (file "syntax_grab_bag.md") (start 146 6) (end 146 12) (annotation warning) (line-text "\tvar number = 123"))))
	(report
		(severity runtime_error)
		(title "Name Not In Scope")
