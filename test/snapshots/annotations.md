...
~~~
# EXPECTED
TYPE MODULE MISSING MATCHING TYPE - annotations.md:1:1:26:44
...
TYPE MISMATCH - annotations.md:26:35:26:35
# PROBLEMS
**TYPE MODULE MISSING MATCHING TYPE**
Type modules must have a type declaration matching the module name.

This file is named `annotations.roc`, but no top-level type declaration named `annotations` was found.

Add either:
`annotations := ...` (nominal type)
or:
`annotations : ...` (type alias)
**annotations.md:1:1:26:44:**
```roc
Pair(a) := [Pair(a, a)]
...
LowerIdent(24:1-24:15),OpAssign(24:16-24:17),OpBar(24:18-24:19),LowerIdent(24:19-24:20),Comma(24:20-24:21),LowerIdent(24:22-24:23),OpBar(24:23-24:24),UpperIdent(24:25-24:29),NoSpaceDotUpperIdent(24:29-24:34),NoSpaceOpenRound(24:34-24:35),LowerIdent(24:35-24:36),Comma(24:36-24:37),LowerIdent(24:38-24:39),CloseRound(24:39-24:40),
LowerIdent(26:1-26:17),OpAssign(26:18-26:19),LowerIdent(26:20-26:34),NoSpaceOpenRound(26:34-26:35),StringStart(26:35-26:36),StringPart(26:36-26:39),StringEnd(26:39-26:40),Comma(26:40-26:41),Int(26:42-26:43),CloseRound(26:43-26:44),
EndOfFile(27:1-27:1),
~~~
# PARSE
~~~clojure
(file @1.1-26.44
	...
	(statements
		...
		(s-decl @24.1-24.40
			(p-ident @24.1-24.15 (raw "mkPairInferred"))
			(e-lambda @24.18-24.40
				(args
					(p-ident @24.19-24.20 (raw "x"))
					(p-ident @24.22-24.23 (raw "y")))
				(e-apply @24.25-24.40
					(e-tag @24.25-24.34 (raw "Pair.Pair"))
					(e-ident @24.35-24.36 (raw "x"))
					(e-ident @24.38-24.39 (raw "y")))))
		(s-decl @26.1-26.44
			(p-ident @26.1-26.17 (raw "failWithImplicit"))
			(e-apply @26.20-26.44
				(e-ident @26.20-26.34 (raw "mkPairInferred"))
				(e-string @26.35-26.40
					(e-string-part @26.36-26.39 (raw "str")))
				(e-int @26.42-26.43 (raw "2"))))))
~~~
# FORMATTED
~~~roc
NO CHANGE
	...
	(d-let
		...
		(e-nominal @4.11-4.26 (nominal "Pair")
			(e-tag @4.11-4.26 (name "Pair")
				(args
					(e-int @4.21-4.22 (value "1"))
					(e-int @4.24-4.25 (value "2")))))
		(annotation @4.1-4.8
			(declared-type
				(ty-apply @3.11-3.20 (symbol "Pair")
					(ty @3.16-3.19 (name "U64"))))))
	(d-let
		...
		(annotation @7.1-7.8
			(declared-type
				(ty-apply @6.11-6.20 (symbol "Pair")
					(ty @6.16-6.19 (name "Str"))))))
	(d-let
		...
		(annotation @10.1-10.7
			(declared-type
				(ty-fn @9.10-9.25 (effectful false)
					...
					(ty-var @9.13-9.14 (name "a"))
					(ty-apply @9.18-9.25 (symbol "Pair")
						(ty-var @9.23-9.24 (name "a")))))))
	(d-let
		(p-assign @13.1-13.20 (ident "succeedPairSameType"))
		(e-call @13.23-13.35
			(e-lookup-local @13.23-13.29
				(p-assign @10.1-10.7 (ident "mkPair")))
			(e-int @13.30-13.31 (value "1"))
			(e-int @13.33-13.34 (value "2")))
		(annotation @13.1-13.20
			(declared-type
				(ty-apply @12.23-12.31 (symbol "Pair")
					(ty @12.28-12.30 (name "U8"))))))
	(d-let
		...
		(e-call @16.21-16.35
			...
			(e-int @16.33-16.34 (value "2")))
		(annotation @16.1-16.18
			(declared-type
				(ty-apply @15.21-15.29 (symbol "Pair")
					(ty @15.26-15.28 (name "U8"))))))
	(d-let
		...
		(e-nominal @19.22-19.41 (nominal "Pair")
			(e-tag @19.22-19.41 (name "Pair")
				(args
					(e-int @19.32-19.33 (value "1"))
					(e-string @19.35-19.40
						(e-literal @19.36-19.39 (string "str"))))))
		(annotation @19.1-19.19
			(declared-type
				(ty-apply @18.22-18.31 (symbol "Pair")
					(ty @18.27-18.30 (name "U64"))))))
	(d-let
		...
		(annotation @22.1-22.14
			(declared-type
				(ty-fn @21.17-21.32 (effectful false)
					(ty-var @21.17-21.18 (name "a"))
					(ty-var @21.20-21.21 (name "b"))
					(ty-apply @21.25-21.32 (symbol "Pair")
						(ty-var @21.30-21.31 (name "a")))))))
	(d-let
		(p-assign @24.1-24.15 (ident "mkPairInferred"))
		(e-lambda @24.18-24.40
			(args
				(p-assign @24.19-24.20 (ident "x"))
				(p-assign @24.22-24.23 (ident "y")))
			(e-nominal @24.25-24.40 (nominal "Pair")
				(e-tag @24.25-24.40 (name "Pair")
					(args
						(e-lookup-local @24.35-24.36
							(p-assign @24.19-24.20 (ident "x")))
						(e-lookup-local @24.38-24.39
							(p-assign @24.22-24.23 (ident "y"))))))))
	(d-let
		(p-assign @26.1-26.17 (ident "failWithImplicit"))
		(e-call @26.20-26.44
			(e-lookup-local @26.20-26.34
				(p-assign @24.1-24.15 (ident "mkPairInferred")))
			(e-string @26.35-26.40
				(e-literal @26.36-26.39 (string "str")))
			(e-int @26.42-26.43 (value "2"))))
	(s-nominal-decl @1.1-1.24
		(ty-header @1.1-1.8 (name "Pair")
			(ty-args
				(ty-var @1.6-1.7 (name "a"))))
		(ty-tag-union @1.12-1.24
			(ty-apply @1.13-1.23 (symbol "Pair")
				(ty-var @1.18-1.19 (name "a"))
				(ty-var @1.21-1.22 (name "a"))))))
~~~
# TYPES
~~~clojure
(inferred-types
	(defs
		(patt @4.1-4.8 (type "Pair(U64)"))
		(patt @7.1-7.8 (type "Pair(Str)"))
		(patt @10.1-10.7 (type "a, a -> Pair(a)"))
		(patt @13.1-13.20 (type "Pair(U8)"))
		(patt @16.1-16.18 (type "Pair(U8)"))
		(patt @19.1-19.19 (type "Error"))
		(patt @22.1-22.14 (type "a, b -> Error"))
		(patt @24.1-24.15 (type "a, a -> Pair(a)"))
		(patt @26.1-26.17 (type "_c")))
	(type_decls
		(nominal @1.1-1.24 (type "Pair(a)")
			(ty-header @1.1-1.8 (name "Pair")
				(ty-args
					(ty-var @1.6-1.7 (name "a"))))))
	(expressions
		(expr @4.11-4.26 (type "Pair(U64)"))
		(expr @7.11-7.38 (type "Pair(Str)"))
		(expr @10.10-10.32 (type "a, a -> Pair(a)"))
		(expr @13.23-13.35 (type "Pair(U8)"))
		(expr @16.21-16.35 (type "Pair(U8)"))
		(expr @19.22-19.41 (type "Error"))
		(expr @22.17-22.39 (type "a, b -> Error"))
		(expr @24.18-24.40 (type "a, a -> Pair(a)"))
		(expr @26.20-26.44 (type "_c"))))
~~~
