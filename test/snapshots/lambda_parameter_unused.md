...
-- ⚠️ UNUSED VARIABLE -------------------------- lambda_parameter_unused.md:5:8
...
-- ⚠️ UNDERSCORE VARIABLE USED ---------------- lambda_parameter_unused.md:9:22
...
(can-ir
	...
	(d-let
		...
		(e-lambda
			...
			(e-dispatch-call (method "times") (constraint-fn-var 326)
				(receiver
					(e-lookup-local
						(p-assign (ident "value"))))
				(args
