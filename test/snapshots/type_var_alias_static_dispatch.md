		...
		(e-lambda
			...
			(e-block
				(s-type-var-alias (alias "A") (type-var "a")
					(ty-rigid-var (name "a")))
				(e-type-dispatch-call (method "from_b") (type-dispatch-stmt 27) (constraint-fn-var 415)
					(args
						(e-lookup-local
							(p-assign (ident "second")))))))
		(annotation
		...
		(e-lambda
			...
			(e-block
				...
				(e-if
					(if-branches
						(if-branch
							(e-type-dispatch-call (method "validate") (type-dispatch-stmt 47) (constraint-fn-var 431)
								(args
									(e-lookup-local
										(p-assign (ident "input")))))
							(e-block
								(e-type-dispatch-call (method "transform") (type-dispatch-stmt 47) (constraint-fn-var 436)
									(args
										(e-lookup-local
											(p-assign (ident "input"))))))))
					(if-else
		...
		(e-lambda
			...
			(e-block
				...
				(s-let
					...
					(e-type-dispatch-call (method "first") (type-dispatch-stmt 73) (constraint-fn-var 449)
						(args)))
				(e-type-dispatch-call (method "second") (type-dispatch-stmt 73) (constraint-fn-var 452)
					(args
						(e-lookup-local
							(p-assign (ident "initial")))))))
		(annotation
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				...
				(e-tuple
					(elems
						(e-type-dispatch-call (method "convert") (type-dispatch-stmt 100) (constraint-fn-var 464)
							(args
								(e-lookup-local
									(p-assign (ident "x")))))
						(e-type-dispatch-call (method "convert") (type-dispatch-stmt 101) (constraint-fn-var 467)
							(args
								(e-lookup-local
									(p-assign (ident "y")))))))))
		(annotation
		...
		(e-lambda
			...
			(e-block
				(s-type-var-alias (alias "T") (type-var "t")
					(ty-rigid-var (name "t")))
				(e-type-dispatch-call (method "create") (type-dispatch-stmt 123) (constraint-fn-var 487)
					(args
						(e-lookup-local
							(p-assign (ident "name")))
						(e-num (value "42"))))))
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				(s-type-var-alias (alias "Thing") (type-var "thing")
					(ty-rigid-var (name "thing")))
				(e-type-dispatch-call (method "from_str") (type-dispatch-stmt 140) (constraint-fn-var 501)
					(args
						(e-lookup-local
							(p-assign (ident "str")))))))
		(annotation
