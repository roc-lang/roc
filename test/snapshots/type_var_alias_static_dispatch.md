		...
		(e-lambda
			...
			(e-block
				...
				(e-if
					(if-branches
						(if-branch
							(e-type-dispatch-call (method "validate") (type-var-alias-stmt 47) (constraint-fn-var 185)
								(args
									(e-lookup-local
										(p-assign (ident "input")))))
							(e-block
								(e-type-dispatch-call (method "transform") (type-var-alias-stmt 47) (constraint-fn-var 190)
									(args
										(e-lookup-local
											(p-assign (ident "input"))))))))
					(if-else
		...
		(e-lambda
			...
			(e-block
				...
				(s-let
					...
					(e-type-dispatch-call (method "first") (type-var-alias-stmt 73) (constraint-fn-var 199)
						(args)))
				(e-type-dispatch-call (method "second") (type-var-alias-stmt 73) (constraint-fn-var 201)
					(args
						(e-lookup-local
							(p-assign (ident "initial")))))))
		(annotation
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				...
				(e-tuple
					(elems
						(e-type-dispatch-call (method "convert") (type-var-alias-stmt 100) (constraint-fn-var 212)
							(args
								(e-lookup-local
									(p-assign (ident "x")))))
						(e-type-dispatch-call (method "convert") (type-var-alias-stmt 101) (constraint-fn-var 214)
							(args
								(e-lookup-local
									(p-assign (ident "y")))))))))
		(annotation
		...
		(e-lambda
			...
			(e-block
				(s-type-var-alias (alias "T") (type-var "t")
					(ty-rigid-var (name "t")))
				(e-type-dispatch-call (method "create") (type-var-alias-stmt 123) (constraint-fn-var 271)
					(args
						(e-lookup-local
							(p-assign (ident "name")))
						(e-num (value "42"))))))
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				(s-type-var-alias (alias "Thing") (type-var "thing")
					(ty-rigid-var (name "thing")))
				(e-type-dispatch-call (method "from_str") (type-var-alias-stmt 140) (constraint-fn-var 360)
					(args
						(e-lookup-local
							(p-assign (ident "str")))))))
		(annotation
