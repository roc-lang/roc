		...
		(s-let
			...
			(e-lambda
				...
				(e-if
					(if-branches
						(if-branch
							(e-dispatch-call (method "is_lte") (constraint-fn-var 75)
								(receiver
									(e-lookup-local
										(p-assign (ident "x"))))
								(args
							...
							(e-num (value "1"))))
					(if-else
						(e-dispatch-call (method "times") (constraint-fn-var 151)
							(receiver
								(e-lookup-local
									(p-assign (ident "x"))))
							(args
								(e-call (constraint-fn-var 150)
									(e-lookup-local
										(p-assign (ident "fac")))
									(e-dispatch-call (method "minus") (constraint-fn-var 146)
										(receiver
											(e-lookup-local
												(p-assign (ident "x"))))
										(args
