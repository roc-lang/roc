		...
		(s-let
			...
			(e-lambda
				...
				(e-if
					(if-branches
						(if-branch
							(e-dispatch-call (method "is_lte") (constraint-fn-var 238)
								(receiver
									(e-lookup-local
										(p-assign (ident "x"))))
								(args
							...
							(e-num (value "1"))))
					(if-else
						(e-dispatch-call (method "times") (constraint-fn-var 261)
							(receiver
								(e-lookup-local
									(p-assign (ident "x"))))
							(args
								(e-call (constraint-fn-var 260)
									(e-lookup-local
										(p-assign (ident "fac")))
									(e-dispatch-call (method "minus") (constraint-fn-var 258)
										(receiver
											(e-lookup-local
												(p-assign (ident "x"))))
										(args
