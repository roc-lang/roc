...
# TYPES
~~~clojure
(expr (type "(Num(_size), Num(_size2), Num(_size3), Num(_size4), Num(_size5), Builtin.Bool, Builtin.Bool, Builtin.Bool, Builtin.Bool, Builtin.Bool, Builtin.Bool, Num(_size6), Error, Error, Error)"))
~~~
