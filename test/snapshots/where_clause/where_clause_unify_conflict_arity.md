# META
~~~ini
description=Unifying two type variables with different method arities
type=file
~~~
# SOURCE
~~~roc
...
foo : a -> a where module(a).process : a, Str -> Str
foo = |x| x

use_foo : b -> b where module(b).process : b -> Str
use_foo = |x| foo(x)
~~~
# EXPECTED
NIL
...
LowerIdent(3:1-3:4),OpColon(3:5-3:6),LowerIdent(3:7-3:8),OpArrow(3:9-3:11),LowerIdent(3:12-3:13),KwWhere(3:14-3:19),KwModule(3:20-3:26),NoSpaceOpenRound(3:26-3:27),LowerIdent(3:27-3:28),CloseRound(3:28-3:29),NoSpaceDotLowerIdent(3:29-3:37),OpColon(3:38-3:39),LowerIdent(3:40-3:41),Comma(3:41-3:42),UpperIdent(3:43-3:46),OpArrow(3:47-3:49),UpperIdent(3:50-3:53),
	...
	(module @1.1-1.17
		(exposes @1.8-1.17
			(exposed-lower-ident @1.9-1.16
				(text "use_foo"))))
	(statements
		(s-type-anno @3.1-3.53 (name "foo")
			(ty-fn @3.7-3.13
				(ty-var @3.7-3.8 (raw "a"))
				(ty-var @3.12-3.13 (raw "a")))
			(where
				(method @3.20-3.53 (module-of "a") (name "process")
					(args
						(ty-var @3.40-3.41 (raw "a"))
						(ty @3.43-3.46 (name "Str")))
					(ty @3.50-3.53 (name "Str")))))
		(s-decl @4.1-4.12
		...
		(s-type-anno @6.1-6.52 (name "use_foo")
			...
			(where
				(method @6.24-6.52 (module-of "b") (name "process")
					(args
						(ty-var @6.44-6.45 (raw "b")))
					(ty @6.49-6.52 (name "Str")))))
		(s-decl @7.1-7.21
...
(can-ir
	(d-let
		...
		(annotation @4.1-4.4
			...
			(where
				(method @3.20-3.53 (module-of "a") (ident "process")
					(args
						(ty-rigid-var-lookup (ty-rigid-var @3.7-3.8 (name "a")))
						(ty-lookup @3.43-3.46 (name "Str") (builtin)))
					(ty-lookup @3.50-3.53 (name "Str") (builtin))))))
	(d-let
		...
		(annotation @7.1-7.8
			...
			(where
				(method @6.24-6.52 (module-of "b") (ident "process")
					(args
						(ty-rigid-var-lookup (ty-rigid-var @6.11-6.12 (name "b"))))
					(ty-lookup @6.49-6.52 (name "Str") (builtin))))))
	(s-type-anno @3.1-3.53 (name "foo")
		(ty-fn @3.7-3.13 (effectful false)
			(ty-rigid-var @3.7-3.8 (name "a"))
			(ty-rigid-var-lookup (ty-rigid-var @3.7-3.8 (name "a"))))
		...
		(where
			(method @6.24-6.52 (module-of "b") (ident "process")
				(args
					(ty-rigid-var-lookup (ty-rigid-var @6.11-6.12 (name "b"))))
				(ty-lookup @6.49-6.52 (name "Str") (builtin)))))
	(ext-decl @3.20-3.53 (ident "module(a).process") (kind "value"))
	(ext-decl @6.24-6.52 (ident "module(b).process") (kind "value")))
~~~
# TYPES
~~~clojure
(inferred-types
