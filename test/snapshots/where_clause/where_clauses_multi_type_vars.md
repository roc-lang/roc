...
~~~
# EXPECTED
MISSING MAIN! FUNCTION - where_clauses_multi_type_vars.md:1:1:2:21
# PROBLEMS
...
`main! = |arg| { ... }`
**where_clauses_multi_type_vars.md:1:1:2:21:**
```roc
process : a, b -> c where module(a).convert : a -> c, module(b).transform : b -> c
process = |_, _| ...
```
	...
	(s-type-anno @1.1-1.83 (name "process")
		...
		(where
			(method @1.27-1.53 (module-of "a") (ident "convert")
				...
				(ty-var @1.52-1.53 (name "c")))
			(method @1.55-1.83 (module-of "b") (ident "transform")
				(args
					(ty-var @1.77-1.78 (name "b")))
				(ty-var @1.82-1.83 (name "c")))))
