...
type=file:WhereClausesMultiTypeVars.roc
~~~
# SOURCE
~~~roc
WhereClausesMultiTypeVars := {}
...
(file @1.1-4.21
	...
	(statements
		(s-type-decl @1.1-1.32
			(header @1.1-1.26 (name "WhereClausesMultiTypeVars")
				(args))
			(ty-record @1.30-1.32))
...
(can-ir
	...
	(s-nominal-decl @1.1-1.32
		(ty-header @1.1-1.26 (name "WhereClausesMultiTypeVars"))
		(ty-record @1.30-1.32))
	(s-type-anno @3.1-3.83 (name "process")
		(ty-fn @3.11-3.20 (effectful false)
			(ty-rigid-var @3.11-3.12 (name "a"))
...
(inferred-types
	...
	(type_decls
		(nominal @1.1-1.32 (type "WhereClausesMultiTypeVars")
			(ty-header @1.1-1.26 (name "WhereClausesMultiTypeVars"))))
	(expressions
