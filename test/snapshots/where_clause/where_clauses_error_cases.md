...
-- [Δ] declaration has no value --------------- where_clauses_error_cases.md:2:1
...
-- [Δ] declaration has no value --------------- where_clauses_error_cases.md:6:1
...
-- [Δ] declaration has no value -------------- where_clauses_error_cases.md:10:1
