...
**fuzz_crash_023.md:118:21:119:3:**
```roc
		3.14 | 6.28 => 314
		(1, 2, 3) => 123
```
...
**fuzz_crash_023.md:119:19:120:3:**
```roc
		(1, 2, 3) => 123
		(1, 2 | 5, 3) => 123
```
...
**fuzz_crash_023.md:175:9:175:15:**
```roc
		Stdout.line!("Adding ${n} to ${number}")
```
		      ^^^^^^
...
**fuzz_crash_023.md:178:42:178:61:**
```roc
	record = { foo: 123, bar: "Hello", ;az: tag, qux: Ok(world), punned }
```
	                                        ^^^^^^^^^^^^^^^^^^^
...
**fuzz_crash_023.md:190:8:190:14:**
```roc
	Stdout.line!(interpolated)?
```
	      ^^^^^^
...
**fuzz_crash_023.md:191:8:191:14:**
```roc
	Stdout.line!(
```
	      ^^^^^^
...
**fuzz_crash_023.md:193:14:193:20:**
```roc
			Num.toStr(number) # Comment after string interpolation expr
```
			          ^^^^^^
