...
(reports
	...
	(report
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "fuzz_crash_023.md") (start 102 19) (end 102 23) (annotation error) (line-text "\t\t[1, 2, 3, .. as rest] # After pattern comment"))))
	(report
		(severity fatal)
	...
	(report
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "fuzz_crash_023.md") (start 108 23) (end 108 27) (annotation error) (line-text "\t\t[1, 2 | 5, 3, .. as rest] => 123"))))
	(report
		(severity fatal)
		(title "Not Implemented")
	...
	(report
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "fuzz_crash_023.md") (start 115 6) (end 115 10) (annotation error) (line-text "\t\t\t\t\trest, # After last pattern in list"))))
	(report
		(severity fatal)
		(title "Not Implemented")
	...
	(report
		...
		(document
			...
			(line-break)
			(line-break)
			(source-region (file "fuzz_crash_023.md") (start 146 6) (end 146 12) (annotation warning) (line-text "\tvar number = 123"))))
	(report
		(severity runtime_error)
		(title "Name Not In Scope")
