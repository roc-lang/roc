			...
			(e-block
							...
							(e-call
								...
								(e-string
									...
									(e-lookup-local
										(p-assign (ident "er")))
									(e-literal (string "")))))
						(e-dispatch-call (method "plus") (constraint-fn-var 1548)
							(receiver
								(e-runtime-error (tag "ident_not_in_scope")))
							(args
								(e-lookup-local
				...
				(s-expr
					(e-if
						(if-branches
							(if-branch
								(e-dispatch-call (method "is_gt") (constraint-fn-var 1931)
									(receiver
										(e-match
											(match
												(cond
								...
								(if-branches
									(if-branch
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_lt") (constraint-fn-var 2039)
														(receiver
															(e-dispatch-call (method "plus") (constraint-fn-var 2004)
																(receiver
																	(e-num (value "13")))
																(args
																	(e-num (value "2")))))
													...
													(e-dispatch-call (method "is_gte") (constraint-fn-var 2139)
														(receiver
															(e-dispatch-call (method "minus") (constraint-fn-var 2104)
																(receiver
																	(e-num (value "10")))
																(args
																	(e-num (value "1")))))
										...
										(e-nominal-external
											...
											(e-tag (name "True")))))
								(if-else
									(e-dispatch-call (method "is_lte") (constraint-fn-var 2217)
										(receiver
											(e-num (value "12")))
										(args
											(e-num (value "3")))))))))
								...
								(e-field-access (field "recd")
									(receiver
										(e-match
											(match
												(cond
													(e-dispatch-call (method "ned") (constraint-fn-var 2284)
														(receiver
															(e-match
																(match
																	(cond
																		(e-dispatch-call (method "od") (constraint-fn-var 2251)
																			(receiver
																				(e-match
																					(match
																						(cond
