...
MISSING METHOD - fuzz_crash_019.md:94:3:94:10
...
The `me` function has the type:
    ...
    [Blue, ..], [Tb] -> f
      where [f.from_numeral : Numeral -> Try(f, [InvalidNumeral(Str)])]
...
(inferred-types
	(defs
		...
		(patt (type "Bool -> Dec"))
		(patt (type "Error"))
		(patt (type "Bool -> (_arg -> Str)"))
		(patt (type "[Blue, ..], [Tb] -> Dec"))
		(patt (type "Error"))
	...
	(expressions
		...
		(expr (type "Bool -> Dec"))
		(expr (type "Error"))
		(expr (type "Bool -> (_arg -> Str)"))
		(expr (type "[Blue, ..], [Tb] -> Dec"))
		(expr (type "Error"))
