							...
							(e-call
								...
								(e-block
									...
									(s-let
										...
										(e-lookup-local
											(p-assign (ident "er"))))
									(e-interpolation (constraint-fn-var 2592)
										(first
											(e-literal (string "Ag ")))
										(parts
											(e-lookup-local
								...
								(if-branches
									(if-branch
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_lt") (constraint-fn-var 3158)
														(receiver
															(e-dispatch-call (method "plus") (constraint-fn-var 3120)
																(receiver
																	(e-num (value "13")))
																(args
																	(e-num (value "2")))))
													...
													(e-dispatch-call (method "is_gte") (constraint-fn-var 3267)
														(receiver
															(e-dispatch-call (method "minus") (constraint-fn-var 3229)
																(receiver
																	(e-num (value "10")))
																(args
																	(e-num (value "1")))))
										...
										(e-nominal-external
											...
											(e-tag (name "True")))))
								(if-else
									(e-dispatch-call (method "is_lte") (constraint-fn-var 3351)
										(receiver
											(e-num (value "12")))
										(args
											(e-num (value "3")))))))))
								...
								(e-field-access (field "recd")
									(receiver
										(e-match
											(match
												(cond
													(e-dispatch-call (method "ned") (constraint-fn-var 3418)
														(receiver
															(e-match
																(match
																	(cond
																		(e-dispatch-call (method "od") (constraint-fn-var 3385)
																			(receiver
																				(e-match
																					(match
																						(cond
