...
(can-ir
	...
	(d-let
		...
		(e-num @8.5-8.14 (value "429496729"))
		(annotation @8.1-8.2
			(declared-type
	...
	(d-let
		...
		(annotation @12.1-12.2
			(declared-type
				(ty-lookup @11.5-11.9 (name "U128") (builtin)))))
	(d-let
		(p-assign @16.1-16.2 (ident "g"))
		(e-num @16.5-16.11 (value "-32768"))
		(annotation @16.1-16.2
			(declared-type
				(ty-lookup @15.5-15.8 (name "I16") (builtin)))))
	(d-let
		(p-assign @19.1-19.2 (ident "h"))
		(e-num @19.5-19.12 (value "-483648"))
		(annotation @19.1-19.2
			(declared-type
				(ty-lookup @18.5-18.8 (name "I32") (builtin)))))
	(d-let
		(p-assign @22.1-22.2 (ident "i"))
		(e-num @22.5-22.17 (value "-92233725808"))
		(annotation @22.1-22.2
			(declared-type
				(ty-lookup @21.5-21.8 (name "I64") (builtin)))))
	(d-let
		(p-assign @25.1-25.2 (ident "j"))
		(e-num @25.5-25.29 (value "-17011687303715884105728"))
		(annotation @25.1-25.2
			(declared-type
				(ty-lookup @24.5-24.9 (name "I128") (builtin))))))
~~~
# TYPES
~~~clojure
(inferred-types
	(defs
		...
		(patt @16.1-16.2 (type "Num(Int(Signed16))"))
		(patt @19.1-19.2 (type "Num(Int(Signed32))"))
		(patt @22.1-22.2 (type "Num(Int(Signed64))"))
		(patt @25.1-25.2 (type "Num(Int(Signed128))")))
	(expressions
		(expr @2.5-2.8 (type "Num(Int(Unsigned8))"))
		(expr @5.5-5.10 (type "Num(Int(Unsigned16))"))
		(expr @8.5-8.14 (type "Num(Int(Unsigned32))"))
		(expr @12.5-12.48 (type "Error"))
		(expr @16.5-16.11 (type "Num(Int(Signed16))"))
		(expr @19.5-19.12 (type "Num(Int(Signed32))"))
		(expr @22.5-22.17 (type "Num(Int(Signed64))"))
		(expr @25.5-25.29 (type "Num(Int(Signed128))"))))
~~~
