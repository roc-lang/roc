			...
			(e-block
							...
							(e-call
								...
								(e-block
									...
									(s-let
										...
										(e-lookup-local
											(p-assign (ident "er"))))
									(e-interpolation (constraint-fn-var 1245) (dispatcher-var 256)
										(first
											(e-literal (string "Ag ")))
										(parts
											(e-lookup-local
				...
				(s-expr
					(e-if
						(if-branches
							(if-branch
								(e-dispatch-call (method "is_gt") (constraint-fn-var 1376)
									(receiver
										(e-match
											(match
												(cond
								...
								(if-branches
									(if-branch
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_lt") (constraint-fn-var 1409)
														(receiver
														...
														(args
															(e-num (value "5"))))
													(e-dispatch-call (method "is_gte") (constraint-fn-var 1436)
														(receiver
															(e-dispatch-call (method "minus") (constraint-fn-var 1426)
																(receiver
																	(e-num (value "10")))
																(args
																	(e-num (value "1")))))
										...
										(e-nominal-external
											...
											(e-tag (name "True")))))
								(if-else
									(e-dispatch-call (method "is_lte") (constraint-fn-var 1464)
										(receiver
											(e-num (value "12")))
										(args
											(e-num (value "3")))))))))
								...
								(e-field-access (field "recd")
									(receiver
										(e-match
											(match
												(cond
													(e-dispatch-call (method "ned") (constraint-fn-var 1525)
														(receiver
															(e-match
																(match
																	(cond
																		(e-dispatch-call (method "od") (constraint-fn-var 1496)
																			(receiver
																				(e-match
																					(match
																						(cond
