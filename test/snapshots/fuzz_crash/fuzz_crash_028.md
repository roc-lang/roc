...
(reports
	...
	(report
		...
		(document
			...
			(line-break)
			(source-region (file "fuzz_crash_028.md") (start 70 38) (end 70 42) (annotation error) (line-text "\t\t\"foo\" | \"bar\" => 20[1, 2, 3, .. as rest] # t"))))
	(report
		(severity fatal)
	...
	(report
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "fuzz_crash_028.md") (start 72 23) (end 72 27) (annotation error) (line-text "\t\t[1, 2 | 5, 3, .. as rest] => 123"))))
	(report
		(severity fatal)
		(title "Not Implemented")
	...
	(report
		...
		(document
			...
			(line-break)
			(line-break)
			(source-region (file "fuzz_crash_028.md") (start 98 6) (end 98 12) (annotation warning) (line-text "\tvar number = 123"))))
	(report
		(severity runtime_error)
		(title "Name Not In Scope")
