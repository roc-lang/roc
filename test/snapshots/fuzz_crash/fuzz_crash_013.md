...
(reports
	(report
		...
		(document
			...
			(line-break)
			(line-break)
			(source-region (file "fuzz_crash_013.md") (start 1 1) (end 1 2) (annotation error) (line-text "0{"))))
	(report
		(severity runtime_error)
		(title "Unexpected Statement")
		...
		(document
			...
			(line-break)
			(line-break)
			(source-region (file "fuzz_crash_013.md") (start 1 2) (end 1 3) (annotation error) (line-text "0{")))))
~~~
# TOKENS
~~~zig
Int,OpenCurly,
