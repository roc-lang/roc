...
TYPE MODULE MISSING MATCHING TYPE - fuzz_crash_032.md:1:1:10:2
...
This file is named `fuzz_crash_032.roc`, but no top-level type declaration named `fuzz_crash_032` was found.

Add either:
`fuzz_crash_032 := ...` (nominal type)
or:
`fuzz_crash_032 : ...` (type alias)
**fuzz_crash_032.md:1:1:10:2:**
```roc
LocalStatus :lue => Loc= [Pending, Complete]
...
(inferred-types
	(defs
		(patt @4.1-4.5 (type "Error -> Error")))
	(type_decls
		(alias @1.1-1.24 (type "LocalStatus")
			(ty-header @1.1-1.12 (name "LocalStatus"))))
	(expressions
		(expr @4.8-10.2 (type "Error -> Error"))))
~~~
