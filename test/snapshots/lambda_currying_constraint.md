...
~~~
# EXPECTED
MISSING MAIN! FUNCTION - lambda_currying_constraint.md:2:1:15:45
# PROBLEMS
...
`main! = |arg| { ... }`
**lambda_currying_constraint.md:2:1:15:45:**
```roc
makeAdder : a -> (a -> a)
makeAdder = |x| |y| x + y
		...
		(annotation @3.1-3.10
			(declared-type
				(ty-fn @2.13-2.26 (effectful false)
					(ty-var @2.13-2.14 (name "a"))
					(ty-parens @2.18-2.26
						(ty-fn @2.19-2.25 (effectful false)
							(ty-var @2.19-2.20 (name "a"))
				...
				(ty-fn @10.14-10.30 (effectful false)
					(ty-parens @10.14-10.22
						(ty-fn @10.15-10.21 (effectful false)
							(ty-var @10.15-10.16 (name "a"))
							(ty-var @10.20-10.21 (name "a"))))
					(ty-var @10.24-10.25 (name "a"))
					(ty-var @10.29-10.30 (name "a"))))))
	(d-let
...
(inferred-types
	(defs
		...
		(patt @7.1-7.11 (type "I64 -> I64"))
		(patt @11.1-11.11 (type "a -> a, a -> a"))
		(patt @15.1-15.14 (type "I64 -> I64")))
	(expressions
		(expr @3.13-3.26 (type "a -> a -> a"))
		(expr @7.14-7.26 (type "I64 -> I64"))
		(expr @11.14-11.28 (type "a -> a, a -> a"))
		(expr @15.17-15.45 (type "I64 -> I64"))))
~~~
