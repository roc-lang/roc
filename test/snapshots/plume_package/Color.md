...
(can-ir
			...
			(e-block
				(s-let
					...
					(e-dispatch-call (method "div_by") (constraint-fn-var 599)
						(receiver
							(e-dispatch-call (method "to_frac") (constraint-fn-var 586)
								(receiver
									(e-lookup-local
										(p-assign (ident "a"))))
								(args)))
							...
							(if-branches
								(if-branch
									(e-if
										(if-branches
											(if-branch
												(e-dispatch-call (method "is_gte") (constraint-fn-var 756)
													(receiver
														(e-lookup-local
															(p-assign (ident "b"))))
													(args
								...
								(e-if
									(if-branches
										(if-branch
											(e-if
												(if-branches
													(if-branch
														(e-dispatch-call (method "is_gte") (constraint-fn-var 805)
															(receiver
																(e-lookup-local
																	(p-assign (ident "b"))))
															(args
																(e-num (value "97"))))
														(e-dispatch-call (method "is_lte") (constraint-fn-var 823)
															(receiver
																(e-lookup-local
																	(p-assign (ident "b"))))
															(args
									...
									(if-else
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_gte") (constraint-fn-var 851)
														(receiver
															(e-lookup-local
																(p-assign (ident "b"))))
														(args
															(e-num (value "65"))))
													(e-dispatch-call (method "is_lte") (constraint-fn-var 869)
														(receiver
															(e-lookup-local
																(p-assign (ident "b"))))
														(args
									...
									(e-block
										(s-let
											...
											(e-if
												(if-branches
													(if-branch
														(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 918)
															(receiver
																(e-lookup-local
																	(p-assign (ident "a"))))
															(args))
														(e-if
															(if-branches
																(if-branch
																	(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 924)
																		(receiver
																			(e-lookup-local
																				(p-assign (ident "b"))))
																		(args))
																	(e-if
																		(if-branches
																			(if-branch
																				(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 930)
																					(receiver
																						(e-lookup-local
																							(p-assign (ident "c"))))
																					(args))
																				(e-if
																					(if-branches
																						(if-branch
																							(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 936)
																								(receiver
																									(e-lookup-local
																										(p-assign (ident "d"))))
																								(args))
																							(e-if
																								(if-branches
																									(if-branch
																										(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 942)
																											(receiver
																												(e-lookup-local
																													(p-assign (ident "e"))))
																											(args))
																										(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 948)
																											(receiver
																												(e-lookup-local
																													(p-assign (ident "f"))))
																											(args))))
	...
	(d-let
		...
		(e-lambda
			...
			(e-if
				(if-branches
					(if-branch
						(e-dispatch-call (method "is_named_color") (constraint-fn-var 1370)
							(receiver
								(e-lookup-local
									(p-assign (ident "str"))))
							(args))
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				...
				(e-dispatch-call (method "contains") (constraint-fn-var 1496)
					(receiver
						(e-lookup-local
							(p-assign (ident "colors"))))
					(args
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 1669)
					(receiver
						(e-call (constraint-fn-var 1578)
							(e-lookup-local
								(p-assign (ident "rgb")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 1847)
					(receiver
						(e-call (constraint-fn-var 1726)
							(e-lookup-local
								(p-assign (ident "rgba")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "map_ok") (constraint-fn-var 1871)
					(receiver
						(e-call (constraint-fn-var 1870)
							(e-lookup-local
								(p-assign (ident "hex")))
							(e-string
