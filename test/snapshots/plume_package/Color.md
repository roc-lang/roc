...
(can-ir
		...
		(e-lambda
			...
			(e-block
				(s-let
					...
					(e-dispatch-call (method "to_utf8") (constraint-fn-var 756)
						(receiver
							(e-lookup-local
								(p-assign (ident "str"))))
						(args)))
										...
										(if-branches
											(if-branch
												(e-dispatch-call (method "is_gte") (constraint-fn-var 811)
													...
													(args
														(e-num (value "48"))))
												(e-dispatch-call (method "is_lte") (constraint-fn-var 849)
													(receiver
														(e-lookup-local
															(p-assign (ident "b"))))
													(args
								...
								(e-if
									(if-branches
										(if-branch
											(e-if
												(if-branches
													(if-branch
														(e-dispatch-call (method "is_gte") (constraint-fn-var 900)
															(receiver
																(e-lookup-local
																	(p-assign (ident "b"))))
															(args
																(e-num (value "97"))))
														(e-dispatch-call (method "is_lte") (constraint-fn-var 938)
															(receiver
																(e-lookup-local
																	(p-assign (ident "b"))))
															(args
									...
									(if-else
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_gte") (constraint-fn-var 986)
														(receiver
															(e-lookup-local
																(p-assign (ident "b"))))
														(args
															(e-num (value "65"))))
													(e-dispatch-call (method "is_lte") (constraint-fn-var 1024)
														(receiver
															(e-lookup-local
																(p-assign (ident "b"))))
														(args
									...
									(e-block
										(s-let
											...
											(e-if
												(if-branches
													(if-branch
														(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 1153)
															(receiver
																(e-lookup-local
																	(p-assign (ident "a"))))
															(args))
														(e-if
															(if-branches
																(if-branch
																	(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 1159)
																		(receiver
																			(e-lookup-local
																				(p-assign (ident "b"))))
																		(args))
																	(e-if
																		(if-branches
																			(if-branch
																				(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 1165)
																					(receiver
																						(e-lookup-local
																							(p-assign (ident "c"))))
																					(args))
																				(e-if
																					(if-branches
																						(if-branch
																							(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 1171)
																								(receiver
																									(e-lookup-local
																										(p-assign (ident "d"))))
																								(args))
																							(e-if
																								(if-branches
																									(if-branch
																										(e-dispatch-call (method "is_char_in_hex_range") (constraint-fn-var 1177)
																											(receiver
																												(e-lookup-local
																													(p-assign (ident "e"))))
																											(args))
															...
															(args
																(e-block
																	(s-let
																		...
																		(e-lookup-local
																			(p-assign (ident "str"))))
																	(e-interpolation (constraint-fn-var 1302)
																		(first
												...
												(args
													(e-block
														(s-let
															...
															(e-lookup-local
																(p-assign (ident "str"))))
														(e-interpolation (constraint-fn-var 1366)
															(first
	...
	(d-let
		...
		(e-lambda
			...
			(e-if
				(if-branches
					(if-branch
						(e-dispatch-call (method "is_named_color") (constraint-fn-var 1778)
							(receiver
								(e-lookup-local
									(p-assign (ident "str"))))
							(args))
								...
								(args
									(e-block
										(s-let
											...
											(e-lookup-local
												(p-assign (ident "str"))))
										(e-interpolation (constraint-fn-var 1871)
											(first
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				...
				(e-dispatch-call (method "contains") (constraint-fn-var 1953)
					(receiver
						(e-lookup-local
							(p-assign (ident "colors"))))
					(args
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 2286)
					(receiver
						(e-call (constraint-fn-var 2075)
							(e-lookup-local
								(p-assign (ident "rgb")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 2711)
					(receiver
						(e-call (constraint-fn-var 2430)
							(e-lookup-local
								(p-assign (ident "rgba")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "map_ok") (constraint-fn-var 2773)
					(receiver
						(e-call (constraint-fn-var 2748)
							(e-lookup-local
								(p-assign (ident "hex")))
							(e-string
