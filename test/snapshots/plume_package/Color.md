...
(can-ir
		...
		(e-lambda
			...
			(e-block
				(s-let
					...
					(e-dispatch-call (method "div_by") (constraint-fn-var 619)
						(receiver
		...
		(e-lambda
			...
			(e-block
				(s-let
					...
					(e-dispatch-call (method "to_utf8") (constraint-fn-var 741)
						(receiver
							(e-lookup-local
								(p-assign (ident "str"))))
						(args)))
										...
										(if-branches
											(if-branch
												(e-dispatch-call (method "is_gte") (constraint-fn-var 796)
													...
													(args
														(e-num (value "48"))))
												(e-dispatch-call (method "is_lte") (constraint-fn-var 834)
													(receiver
														(e-lookup-local
															(p-assign (ident "b"))))
													(args
								...
								(e-if
									(if-branches
										(if-branch
											(e-if
												(if-branches
													(if-branch
														(e-dispatch-call (method "is_gte") (constraint-fn-var 885)
															(receiver
																(e-lookup-local
																	(p-assign (ident "b"))))
															(args
																(e-num (value "97"))))
														(e-dispatch-call (method "is_lte") (constraint-fn-var 923)
															(receiver
																(e-lookup-local
																	(p-assign (ident "b"))))
															(args
									...
									(if-else
										(e-if
											(if-branches
												(if-branch
													(e-dispatch-call (method "is_gte") (constraint-fn-var 971)
														(receiver
															(e-lookup-local
																(p-assign (ident "b"))))
														(args
															(e-num (value "65"))))
													(e-dispatch-call (method "is_lte") (constraint-fn-var 1009)
														(receiver
															(e-lookup-local
																(p-assign (ident "b"))))
														(args
	...
	(d-let
		...
		(e-lambda
			...
			(e-if
				(if-branches
					(if-branch
						(e-dispatch-call (method "is_named_color") (constraint-fn-var 1570)
							(receiver
								(e-lookup-local
									(p-assign (ident "str"))))
							(args))
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				...
				(e-dispatch-call (method "contains") (constraint-fn-var 1696)
					(receiver
						(e-lookup-local
							(p-assign (ident "colors"))))
					(args
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 2049)
					(receiver
						(e-call (constraint-fn-var 1838)
							(e-lookup-local
								(p-assign (ident "rgb")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 2467)
					(receiver
						(e-call (constraint-fn-var 2186)
							(e-lookup-local
								(p-assign (ident "rgba")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "map_ok") (constraint-fn-var 2491)
					(receiver
