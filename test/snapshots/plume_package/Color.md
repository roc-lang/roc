...
(can-ir
															...
															(args
																(e-block
																	(s-let
																		...
																		(e-lookup-local
																			(p-assign (ident "str"))))
																	(e-interpolation (constraint-fn-var 1407)
																		(first
												...
												(args
													(e-block
														(s-let
															...
															(e-lookup-local
																(p-assign (ident "str"))))
														(e-interpolation (constraint-fn-var 1479)
															(first
	...
	(d-let
		...
		(e-lambda
			...
			(e-if
				(if-branches
					(if-branch
						(e-dispatch-call (method "is_named_color") (constraint-fn-var 1907)
							(receiver
								(e-lookup-local
									(p-assign (ident "str"))))
							(args))
								...
								(args
									(e-block
										(s-let
											...
											(e-lookup-local
												(p-assign (ident "str"))))
										(e-interpolation (constraint-fn-var 2008)
											(first
	...
	(d-let
		...
		(e-lambda
			...
			(e-block
				...
				(e-dispatch-call (method "contains") (constraint-fn-var 2099)
					(receiver
						(e-lookup-local
							(p-assign (ident "colors"))))
					(args
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 2441)
					(receiver
						(e-call (constraint-fn-var 2230)
							(e-lookup-local
								(p-assign (ident "rgb")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "to_str") (constraint-fn-var 2881)
					(receiver
						(e-call (constraint-fn-var 2600)
							(e-lookup-local
								(p-assign (ident "rgba")))
							(e-num (value "124"))
							(e-num (value "56"))
	...
	(s-expect
		(e-method-eq (negated "false")
			(lhs
				(e-dispatch-call (method "map_ok") (constraint-fn-var 2949)
					(receiver
						(e-call (constraint-fn-var 2924)
							(e-lookup-local
								(p-assign (ident "hex")))
							(e-string
