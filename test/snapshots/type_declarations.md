...
TYPE MODULE MISSING MATCHING TYPE - type_declarations.md:1:1:13:24
# PROBLEMS
**UNDECLARED TYPE**
...
This file is named `type_declarations.roc`, but no top-level type declaration named `type_declarations` was found.

Add either:
`type_declarations := ...` (nominal type)
or:
`type_declarations : ...` (type alias)
**type_declarations.md:1:1:13:24:**
```roc
Map(a, b) : List(a), (a -> b) -> List(b)
...
(can-ir
	(s-alias-decl @1.1-1.41
		(ty-header @1.1-1.10 (name "Map")
			(ty-args
				...
				(ty-var @1.8-1.9 (name "b"))))
		(ty-fn @1.13-1.41 (effectful false)
			(ty-apply @1.13-1.20 (symbol "List")
				(ty-var @1.18-1.19 (name "a")))
			(ty-parens @1.22-1.30
				(ty-fn @1.23-1.29 (effectful false)
					(ty-var @1.23-1.24 (name "a"))
					(ty-var @1.28-1.29 (name "b"))))
			(ty-apply @1.34-1.41 (symbol "List")
				(ty-var @1.39-1.40 (name "b")))))
	...
	(s-alias-decl @7.1-7.27
		(ty-header @7.1-7.9 (name "Maybe")
			(ty-args
				(ty-var @7.7-7.8 (name "a"))))
		(ty-tag-union @7.12-7.27
			(ty-apply @7.13-7.20 (symbol "Some")
				(ty-var @7.18-7.19 (name "a")))
			(ty @7.22-7.26 (name "None"))))
	(s-alias-decl @9.1-9.38
		(ty-header @9.1-9.12 (name "SomeFunc")
			(ty-args
				(ty-var @9.10-9.11 (name "a"))))
		(ty-fn @9.15-9.38 (effectful false)
			(ty-apply @9.15-9.23 (symbol "Maybe")
				(ty-var @9.21-9.22 (name "a")))
			(ty-var @9.25-9.26 (name "a"))
			(ty-apply @9.30-9.38 (symbol "Maybe")
				(ty-var @9.36-9.37 (name "a")))))
