...
TYPE NOT EXPOSED - qualified_type_canonicalization.md:22:38:22:44
...
TYPE NOT EXPOSED - qualified_type_canonicalization.md:39:70:39:76
...
**TYPE NOT EXPOSED**
The type `TypeC` is not an exposed by the module `ModuleA`.
