...
-- ⚠️ PRIVATE TYPE IN EXPOSED FIELD ----- type_mod_nominal_field_depends_on_later_private_toplevel_type.md:2:13
...
Hint: Expose the referenced type, make ModType opaque with `::`, or move the
type into ModType's associated block.
# TOKENS
~~~zig
