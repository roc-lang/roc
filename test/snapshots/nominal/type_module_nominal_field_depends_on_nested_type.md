# META
~~~ini
description=Nominal type mod whose field depends on a nested associated type (qualified ModType.InternalType). This compiles because the nested type is exposed as ModType.InternalType.
