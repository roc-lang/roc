...
type=file:NominalTagPackageImport.roc
~~~
# SOURCE
~~~roc
NominalTagPackageImport := {}
...
(file @1.1-8.29
	...
	(statements
		(s-type-decl @1.1-1.30
			(header @1.1-1.24 (name "NominalTagPackageImport")
				(args))
			(ty-record @1.28-1.30))
...
(can-ir
	...
	(s-nominal-decl @1.1-1.30
		(ty-header @1.1-1.24 (name "NominalTagPackageImport"))
		(ty-record @1.28-1.30))
...
(inferred-types
	...
	(type_decls
		(nominal @1.1-1.30 (type "NominalTagPackageImport")
			(ty-header @1.1-1.24 (name "NominalTagPackageImport"))))
	(expressions
