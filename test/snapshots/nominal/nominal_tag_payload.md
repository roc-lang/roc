...
(can-ir
		...
		(annotation @4.1-4.6
			(declared-type
				(ty-fn @3.9-3.22 (effectful false)
					...
					(ty-apply @3.14-3.22 (name "Maybe") (local)
	...
	(d-let
		...
		(annotation @7.1-7.6
			(declared-type
				(ty-apply @6.9-6.18 (name "Maybe") (local)
					(ty-rigid-var @6.9-6.18 (name "_a"))))))
	(d-let
	...
	(s-nominal-decl @1.1-1.28
		...
		(ty-tag-union @1.13-1.28
			(ty-tag-name @1.14-1.21 (name "Some")
				(ty-rigid-var-lookup (ty-rigid-var @1.7-1.8 (name "a"))))
			(ty-tag-name @1.23-1.27 (name "None")))))
~~~
# TYPES
~~~clojure
(inferred-types
