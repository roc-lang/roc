...
(can-ir
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 1544)
			(receiver
				(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 1606)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D2_Siblings_Backward.InnerA.valA"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 1700)
			(receiver
				(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 1762)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D3_Pattern1.val1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 1824)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D3_Pattern3.L2.L3.val3"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 1856)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D3_Pattern3.L2.val2"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 1918)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D3_Pattern4.val1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 1920)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D3_Pattern4.L2.L3.val3"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2046)
			(receiver
				(e-lookup-local
	...
	(d-let
		(p-assign (ident "associated_items_truly_comprehensive.D3_Pattern6.L2.val2"))
		(e-dispatch-call (method "times") (constraint-fn-var 2044)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D3_Pattern6.val1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2200)
			(receiver
				(e-dispatch-call (method "plus") (constraint-fn-var 2198)
					(receiver
						(e-lookup-local
							(p-assign (ident "associated_items_truly_comprehensive.D4_Pattern1.val1"))))
					(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 2262)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D4_Pattern2.L2.L3.L4.val4"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 2294)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D4_Pattern2.L2.L3.val3"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 2326)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D4_Pattern2.L2.val2"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2388)
			(receiver
				(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2390)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D4_Pattern3.val1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 2422)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D4_Pattern3.L2.L3.val3"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2484)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D4_Pattern4.val1"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2486)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D4_Pattern4.L2.L3.val3"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2612)
			(receiver
				(e-dispatch-call (method "plus") (constraint-fn-var 2610)
					(receiver
						(e-dispatch-call (method "plus") (constraint-fn-var 2608)
							(receiver
								(e-lookup-local
									(p-assign (ident "associated_items_truly_comprehensive.D5_Pattern1.val1"))))
							(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2674)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D5_Pattern2.L2.L3.L4.L5.val5"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2706)
			(receiver
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2738)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D5_Pattern2.L2.L3.val3"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2770)
			(receiver
				(e-runtime-error (tag "ident_not_in_scope")))
			(args
				(e-num (value "1")))))
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2832)
			(receiver
				(e-lookup-local
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 2902)
			(receiver
				(e-dispatch-call (method "plus") (constraint-fn-var 2900)
					(receiver
						(e-dispatch-call (method "plus") (constraint-fn-var 2898)
							(receiver
								(e-lookup-local
									(p-assign (ident "associated_items_truly_comprehensive.D5_Pattern3.val1"))))
							(args
	...
	(d-let
		(p-assign (ident "associated_items_truly_comprehensive.D5_Pattern3.L2.L3.L4.val4"))
		(e-dispatch-call (method "times") (constraint-fn-var 2864)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D5_Pattern3.L2.L3.val3"))))
			(args
	...
	(d-let
		(p-assign (ident "associated_items_truly_comprehensive.D5_Pattern3.L2.val2"))
		(e-dispatch-call (method "plus") (constraint-fn-var 2896)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.D5_Pattern3.L2.L3.L4.val4"))))
			(args
	...
	(d-let
		...
		(e-dispatch-call (method "plus") (constraint-fn-var 3166)
			(receiver
				(e-lookup-local
					(p-assign (ident "associated_items_truly_comprehensive.Annotated.typed"))))
			(args
