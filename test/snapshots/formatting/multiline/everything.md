...
(reports
	...
	(report
		(severity runtime_error)
		(title "Where Clause Not Allowed In Type Declaration")
		(region (start 24 1) (end 34 3))
		(headline
			(text "You cannot define a ")
			(annotated code "where")
			(reflow " clause inside a type declaration."))
		(document
			(source-region (file "everything.md") (start 24 1) (end 34 3) (annotation error) (line-text "B(b) : b\n\twhere [\n\t\tb.b1 : (\n\t\t\tb,\n\t\t\tb,\n\t\t) -> Str,\n\t\tb.b2 : (\n\t\t\tb,\n\t\t\tb,\n\t\t) -> Str,\n\t]"))))
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 98 5) (end 98 6))
		(headline
			(reflow "Variable ")
		...
		(document
			...
			(line-break)
			(source-region (file "everything.md") (start 98 5) (end 98 6) (annotation error) (line-text "\t\t\t\tb,"))))
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 103 4) (end 103 5))
		(headline
			(reflow "Variable ")
			(annotated symbol-unqualified "b")
			(reflow " is defined here and then never used:"))
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "everything.md") (start 103 4) (end 103 5) (annotation error) (line-text "\t\t\tb,"))))
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 108 5) (end 108 6))
		(headline
			(reflow "Variable ")
			(annotated symbol-unqualified "b")
			(reflow " is defined here and then never used:"))
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "everything.md") (start 108 5) (end 108 6) (annotation error) (line-text "\t\t\t\tb,"))))
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 114 5) (end 114 6))
		(headline
			(reflow "Variable ")
			(annotated symbol-unqualified "b")
			(reflow " is defined here and then never used:"))
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "everything.md") (start 114 5) (end 114 6) (annotation error) (line-text "\t\t\t\tb,"))))
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 69 2) (end 69 4))
		(headline
			(reflow "Variable ")
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "everything.md") (start 69 2) (end 69 4) (annotation error) (line-text "\th1 = {"))))
	(report
		(severity warning)
		(title "Unused Variable")
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "everything.md") (start 77 2) (end 77 4) (annotation error) (line-text "\th2 = h("))))
	(report
		(severity warning)
		(title "Unused Variable")
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "everything.md") (start 81 2) (end 81 4) (annotation error) (line-text "\th3 = A("))))
	(report
		(severity warning)
		(title "Unused Variable")
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "everything.md") (start 85 2) (end 85 4) (annotation error) (line-text "\th4 = ["))))
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 89 2) (end 89 4))
		(headline
			(reflow "Variable ")
	...
	(report
		...
		(headline
			...
			(reflow "is a type."))
		(document
			(source-region (file "everything.md") (start 64 4) (end 64 6) (annotation error) (line-text "\t\te.A,"))
			(line-break)
	...
	(report
		...
		(headline
			...
			(reflow "is a type."))
		(document
			(source-region (file "everything.md") (start 65 4) (end 65 6) (annotation error) (line-text "\t\te.B,"))
			(line-break)
			(reflow "A where alias names a set of method constraints, declared like")
			(reflow " ")
			(annotated code "a.Sortable : where [a.compare : a -> [LT, EQ, GT]]")
	...
	(report
		...
		(region (start 62 1) (end 66 3))
		(headline
			(reflow "This declaration has a type annotation but no implementation."))
		(document
			(source-region (file "everything.md") (start 62 1) (end 66 3) (annotation error) (line-text "g : e -> e\n\twhere [\n\t\te.A,\n\t\te.B,\n\t]"))
			(line-break)
			(line-break)
