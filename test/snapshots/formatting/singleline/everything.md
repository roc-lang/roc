...
~~~
# EXPECTED
WHERE CLAUSE IN TYPE DECLARATION - everything.md:6:10:6:74
WHERE CLAUSE IN TYPE DECLARATION - everything.md:7:10:7:74
TYPE MODULE MISSING MATCHING TYPE - everything.md:2:1:29:2
...
(can-ir
	...
	(s-alias-decl @6.1-6.74
		(ty-header @6.1-6.5 (name "A")
			(ty-args
				(ty-var @6.3-6.4 (name "a"))))
		(ty-var @6.8-6.9 (name "a")))
	(s-alias-decl @7.1-7.74
		(ty-header @7.1-7.5 (name "B")
			(ty-args
				(ty-var @7.3-7.4 (name "b"))))
		(ty-var @7.8-7.9 (name "b")))
	(s-alias-decl @9.1-9.17
		(ty-header @9.1-9.8 (name "C")
			(ty-args
				(ty-var @9.3-9.4 (name "a"))
				(ty-var @9.6-9.7 (name "b"))))
		(ty-tuple @9.11-9.17
			(ty-var @9.12-9.13 (name "a"))
			(ty-var @9.15-9.16 (name "b"))))
	(s-alias-decl @10.1-10.18
		(ty-header @10.1-10.8 (name "D")
			(ty-args
				(ty-var @10.3-10.4 (name "a"))
				(ty-var @10.6-10.7 (name "b"))))
		(ty-apply @10.11-10.18 (symbol "C")
			(ty-var @10.13-10.14 (name "a"))
			(ty-var @10.16-10.17 (name "b"))))
	...
	(s-type-anno @14.1-14.42 (name "g")
		(ty-fn @14.5-14.11 (effectful false)
			(ty-var @14.5-14.6 (name "e"))
			(ty-var @14.10-14.11 (name "e")))
		(where
...
(inferred-types
	(defs
		(patt @16.1-16.2 (type "[Z1((field, field2)), Z2(c, d), Z3(f), Z4(List(elem))]others, [Z1((field3, field4)), Z2(i, j), Z3(k), Z4(List(elem2))]others2 -> _ret")))
	(type_decls
		...
		(alias @12.1-12.11 (type "F")
			(ty-header @12.1-12.2 (name "F"))))
	(expressions
		(expr @16.5-29.2 (type "[Z1((field, field2)), Z2(c, d), Z3(f), Z4(List(elem))]others, [Z1((field3, field4)), Z2(i, j), Z3(k), Z4(List(elem2))]others2 -> _ret"))))
~~~
