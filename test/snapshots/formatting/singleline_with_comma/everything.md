...
~~~
# EXPECTED
WHERE CLAUSE IN TYPE DECLARATION - everything.md:6:10:6:77
WHERE CLAUSE IN TYPE DECLARATION - everything.md:7:10:7:77
...
(can-ir
	...
	(s-alias-decl @9.1-9.19
		...
		(ty-tuple @9.12-9.19
			...
			(ty-var @9.16-9.17 (name "b"))))
	(s-alias-decl @10.1-10.20
		(ty-header @10.1-10.9 (name "D")
			(ty-args
				(ty-var @10.3-10.4 (name "a"))
				(ty-var @10.6-10.7 (name "b"))))
		(ty-apply @10.12-10.20 (symbol "C")
			(ty-var @10.14-10.15 (name "a"))
			(ty-var @10.17-10.18 (name "b"))))
