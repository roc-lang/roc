...
MISSING MAIN! FUNCTION - underscore_in_regular_annotations.md:1:1:29:21
...
`main! = |arg| { ... }`
**underscore_in_regular_annotations.md:1:1:29:21:**
```roc
main : _ -> _
main = |x| x
		...
		(annotation @9.1-9.8
			(declared-type
				(ty-fn @8.11-8.25 (effectful false)
					(ty-apply @8.11-8.18 (symbol "List")
		...
		(annotation @17.1-17.14
			(declared-type
				(ty-fn @16.17-16.38 (effectful false)
					(ty-apply @16.17-16.31 (symbol "Result")
				...
				(ty-fn @24.7-24.35 (effectful false)
					(ty-parens @24.7-24.15
						(ty-fn @24.8-24.14 (effectful false)
							(ty-var @24.8-24.9 (name "a"))
							(ty-var @24.13-24.14 (name "b"))))
					(ty-apply @24.17-24.24 (symbol "List")
						(ty-var @24.22-24.23 (name "a")))
					(ty-apply @24.28-24.35 (symbol "List")
						(ty-var @24.33-24.34 (name "b")))))))
	(d-let
...
(inferred-types
	(defs
		...
		(patt @9.1-9.8 (type "List(_c) -> Str"))
		(patt @13.1-13.9 (type "{ field: _field2, other: U32 } -> U32"))
		(patt @17.1-17.14 (type "Result(ok, Str) -> Str"))
		(patt @25.1-25.4 (type "a -> b, List(a) -> List(b)"))
		(patt @29.1-29.10 (type "_arg, _arg2 -> _ret")))
	(expressions
		(expr @2.8-2.13 (type "_arg -> _ret"))
		(expr @5.12-5.17 (type "a -> a"))
		(expr @9.11-9.29 (type "List(_c) -> Str"))
		(expr @13.12-13.33 (type "{ field: _field2, other: U32 } -> U32"))
		(expr @17.17-21.6 (type "Result(ok, Str) -> Str"))
		(expr @25.7-25.16 (type "a -> b, List(a) -> List(b)"))
		(expr @29.13-29.21 (type "_arg, _arg2 -> _ret"))))
~~~
