...
TYPE MODULE MISSING MATCHING TYPE - underscore_in_type_parameters.md:2:1:14:23
# PROBLEMS
...
This file is named `underscore_in_type_parameters.roc`, but no top-level type declaration named `underscore_in_type_parameters` was found.

Add either:
`underscore_in_type_parameters := ...` (nominal type)
or:
`underscore_in_type_parameters : ...` (type alias)
**underscore_in_type_parameters.md:2:1:14:23:**
```roc
MyType(_) : Str
	...
	(s-alias-decl @5.1-5.18
		(ty-header @5.1-5.14 (name "MyType2")
			(ty-args
				...
				(ty-var @5.12-5.13 (name "b"))))
		(ty-var @5.17-5.18 (name "b")))
	(s-alias-decl @8.1-8.18
		(ty-header @8.1-8.14 (name "MyType3")
			(ty-args
				(ty-var @8.9-8.10 (name "a"))
				(ty-underscore @8.12-8.13)))
		(ty-var @8.17-8.18 (name "a")))
