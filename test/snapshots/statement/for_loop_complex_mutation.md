				...
				(e-block
					(e-if
						(if-branches
							(if-branch
								(e-method-eq (negated "false")
									(lhs
										(e-dispatch-call (method "rem_by") (constraint-fn-var 606)
											(receiver
												(e-lookup-local
													(p-assign (ident "n"))))
											(args
								...
								(e-block
									(s-reassign
										(p-assign (ident "count_"))
										(e-dispatch-call (method "plus") (constraint-fn-var 676)
											(receiver
												(e-lookup-local
													(p-assign (ident "count_"))))
											(args
						...
						(if-else
							(e-block
								(e-empty_record))))))
			(e-dispatch-call (method "times") (constraint-fn-var 688)
				(receiver
					(e-lookup-local
						(p-assign (ident "count_"))))
				(args
