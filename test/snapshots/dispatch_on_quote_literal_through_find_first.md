			...
			(e-block
				(s-let
					...
					(e-match
						(match
							(cond
								(e-dispatch-call (method "find_first") (constraint-fn-var 270)
									(receiver
										(e-list
											(elems
												(e-string
									...
									(args
										(e-closure
											...
											(e-lambda
												...
												(e-dispatch-call (method "contains") (constraint-fn-var 268)
													(receiver
														(e-dispatch-call (method "to_utf8") (constraint-fn-var 266)
															(receiver
																(e-lookup-local
																	(p-assign (ident "letters"))))
															(args)))
