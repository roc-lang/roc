		...
		(annotation @2.1-2.6
			(declared-type
				(ty-fn @1.9-1.21 (effectful false)
					(ty-lookup @1.9-1.11 (name "U8") (builtin))
					(ty-lookup @1.13-1.15 (name "U8") (builtin))
					(ty-lookup @1.19-1.21 (name "U8") (builtin))))))
	(s-expect @4.1-4.24
		(e-binop @4.8-4.24 (op "eq")
			(e-call @4.8-4.19
				(e-lookup-local @4.8-4.13
					(p-assign @2.1-2.6 (ident "addU8")))
				(e-num @4.14-4.15 (value "1"))
				(e-num @4.17-4.18 (value "2")))
			(e-num @4.23-4.24 (value "3"))))
	(s-expect @5.1-5.26
		(e-binop @5.8-5.26 (op "eq")
			(e-call @5.8-5.20
				(e-lookup-local @5.8-5.13
					(p-assign @2.1-2.6 (ident "addU8")))
				(e-num @5.14-5.15 (value "0"))
				(e-num @5.17-5.19 (value "10")))
			(e-num @5.24-5.26 (value "10")))))
~~~
# TYPES
~~~clojure
(inferred-types
	(defs
		(patt @2.1-2.6 (type "Num(Int(Unsigned8)), Num(Int(Unsigned8)) -> Num(Int(Unsigned8))")))
	(expressions
		(expr @2.9-2.21 (type "Num(Int(Unsigned8)), Num(Int(Unsigned8)) -> Num(Int(Unsigned8))"))))
~~~
