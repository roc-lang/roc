	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				...
				(fields
					(field (name "y")
						(e-dispatch-call (method "plus") (constraint-fn-var 450)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				...
				(fields
					(field (name "x")
						(e-dispatch-call (method "plus") (constraint-fn-var 532)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				...
				(fields
					(field (name "x")
						(e-dispatch-call (method "minus") (constraint-fn-var 571)
							(receiver
								(e-field-access
									(receiver
										(e-lookup-local
