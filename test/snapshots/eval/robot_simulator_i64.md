	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				...
				(fields
					(field (name "x")
						(e-dispatch-call (method "plus") (constraint-fn-var 540)
							(receiver
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				...
				(fields
					(field (name "x")
						(e-dispatch-call (method "minus") (constraint-fn-var 596)
							(receiver
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
