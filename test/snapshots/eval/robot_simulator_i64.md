	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				...
				(fields
					(field (name "y")
						(e-dispatch-call (method "minus") (constraint-fn-var 503)
							(receiver
								(e-field-access (field "y")
									(receiver
										(e-lookup-local
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				...
				(fields
					(field (name "x")
						(e-dispatch-call (method "plus") (constraint-fn-var 559)
							(receiver
	...
	(d-let
		...
		(e-lambda
			...
			(e-record
				...
				(fields
					(field (name "x")
						(e-dispatch-call (method "minus") (constraint-fn-var 615)
							(receiver
								(e-field-access (field "x")
									(receiver
										(e-lookup-local
