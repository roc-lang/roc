...
(e-tuple
	(elems
		...
		(e-nominal-external
			(builtin)
			(e-tag (name "False")))
		(e-dispatch-call (method "not") (constraint-fn-var 210)
			(receiver
				(e-tag (name "True")))
			(args))
		(e-dispatch-call (method "not") (constraint-fn-var 214)
			(receiver
				(e-tag (name "False")))
			(args))
		(e-if
		...
		(e-if
			(if-branches
				(if-branch
					(e-dispatch-call (method "not") (constraint-fn-var 232)
						(receiver
							(e-tag (name "True")))
						(args))
					(e-nominal-external
						...
						(e-tag (name "True")))))
			(if-else
				(e-dispatch-call (method "not") (constraint-fn-var 242)
					(receiver
						(e-tag (name "True")))
					(args))))))
~~~
