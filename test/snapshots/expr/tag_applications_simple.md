...
# PROBLEMS
**MISSING METHOD**
This `from_numeral` method is being called on the type _[Ok([Just(_a)]_others)]_others2 where [Numeral.from_numeral : Numeral -> Try(_b, [InvalidNumeral(Str)])]_, which has no method with that name:
