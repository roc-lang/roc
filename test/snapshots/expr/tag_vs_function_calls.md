...
# TYPES
~~~clojure
(expr (type "{ addOne: a -> a, errTag: [Err(Str)]_others, nested: [Some([Ok([Just(_b)]_others2)]_others3)]_others4, noneTag: [None]_others5, okTag: [Ok(Str)]_others6, result: Error, someTag: [Some(_c)]_others7, tagList: List([Some(_d)][None]_others8) }"))
~~~
