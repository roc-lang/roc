...
(reports
	(report
		...
		(region (start 14 12) (end 14 19))
		(headline
			(reflow "This number literal does not fit in the inferred type."))
		(document
			(source-region (file "number_literal_suffixes.md") (start 14 12) (end 14 19) (annotation error) (line-text "  u8Neg:   -123.U8,"))
			(line-break)
	...
	(report
		...
		(headline
			(reflow "This number literal does not fit in the inferred type."))
		(document
			(source-region (file "number_literal_suffixes.md") (start 15 12) (end 15 20) (annotation error) (line-text "  u16Neg:  -123.U16,"))
			(line-break)
			(reflow "The inferred type is:")
			(line-break)
			(line-break)
	...
	(report
		...
		(headline
			(reflow "This number literal does not fit in the inferred type."))
		(document
			(source-region (file "number_literal_suffixes.md") (start 16 12) (end 16 20) (annotation error) (line-text "  u32Neg:  -123.U32,"))
			(line-break)
			(reflow "The inferred type is:")
			(line-break)
			(line-break)
	...
	(report
		(severity runtime_error)
		(title "Invalid Number")
		(region (start 17 12) (end 17 20))
		(headline
			(reflow "This number literal does not fit in the inferred type."))
		(document
			(source-region (file "number_literal_suffixes.md") (start 17 12) (end 17 20) (annotation error) (line-text "  u64Neg:  -123.U64,"))
			(line-break)
			(reflow "The inferred type is:")
			(line-break)
			(line-break)
	...
	(report
		(severity runtime_error)
		(title "Invalid Number")
		(region (start 18 12) (end 18 21))
		(headline
			(reflow "This number literal does not fit in the inferred type."))
		(document
			(source-region (file "number_literal_suffixes.md") (start 18 12) (end 18 21) (annotation error) (line-text "  u128Neg: -123.U128,"))
			(line-break)
			(reflow "The inferred type is:")
			(line-break)
			(line-break)
