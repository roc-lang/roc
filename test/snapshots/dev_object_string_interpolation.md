...
main = {
	cinterp_0 = greeting
	cinterp_1 = name
	<interpolation>("", [].iter().prepended((cinterp_1, "!")).prepended((cinterp_0, ", ")))
}

~~~
# DEV OUTPUT
~~~ini
x64mac=4f68135494bfa11c8b64f6a2b6094582714c3be19dd54344b412b573311be11f
...
arm64mac=be1f2e3f4902fc2d114cbc8581a14b2243f6a032a82deaead45b6f6e1746af0e
