...
(inferred-types
	(defs
		...
		(patt (type "{ count: Num(_size), items: List(_a) }"))
		(patt (type "{ count: Num(_size), items: List(Num(_size2)) }"))
		(patt (type "{ count: Num(_size), items: List(Str) }"))
		(patt (type "{ data: List(_a), metadata: { description: Str, ratio: Num(Frac(_size)), version: Num(_size2) } }"))
		...
		(patt (type "{ level1: { collection: List(_a), level2: { items: List(Num(_size)), level3: { data: List(_b), value: Num(_size2) } } }, results: List({ data: List(Num(_size3)), tag: Str }) }"))
		(patt (type "Num(_size)"))
		(patt (type "Num(_size)"))
		(patt (type "List(Num(_size))"))
		(patt (type "{ base: Num(_size), derived: List(Num(_size2)) }"))
		(patt (type "{ computations: { from_frac: Num(Frac(_size)), from_num: Num(_size2), list_from_num: List(Num(_size3)) }, empty_lists: { in_list: List(List(_a)), in_record: { data: List(_b) }, raw: List(_c) }, numbers: { float: Num(Frac(_size4)), list: List(Num(_size5)), value: Num(_size6) }, strings: { list: List(Str), value: Str } }"))
	...
	(expressions
		...
		(expr (type "{ count: Num(_size), items: List(_a) }"))
		(expr (type "{ count: Num(_size), items: List(Num(_size2)) }"))
		(expr (type "{ count: Num(_size), items: List(Str) }"))
		(expr (type "{ data: List(_a), metadata: { description: Str, ratio: Num(Frac(_size)), version: Num(_size2) } }"))
		...
		(expr (type "{ level1: { collection: List(_a), level2: { items: List(Num(_size)), level3: { data: List(_b), value: Num(_size2) } } }, results: List({ data: List(Num(_size3)), tag: Str }) }"))
		(expr (type "Num(_size)"))
		(expr (type "Num(_size)"))
		(expr (type "List(Num(_size))"))
		(expr (type "{ base: Num(_size), derived: List(Num(_size2)) }"))
		(expr (type "{ computations: { from_frac: Num(Frac(_size)), from_num: Num(_size2), list_from_num: List(Num(_size3)) }, empty_lists: { in_list: List(List(_a)), in_record: { data: List(_b) }, raw: List(_c) }, numbers: { float: Num(Frac(_size4)), list: List(Num(_size5)), value: Num(_size6) }, strings: { list: List(Str), value: Str } }"))
