...
(inferred-types
	(defs
		...
		(patt (type "List(List(_a)) where [_b.from_numeral : _arg -> _ret]"))
		(patt (type "{ count: _field, items: List(_a) } where [_b.from_numeral : _arg -> _ret]"))
		(patt (type "{ count: _field, items: List(_a) } where [_b.from_numeral : _arg -> _ret, _c.from_numeral : _arg2 -> _ret2]"))
		(patt (type "{ count: _field, items: List(Str) } where [_a.from_numeral : _arg -> _ret]"))
		(patt (type "{ data: List(_a), metadata: { description: Str, ratio: _field, version: _field2 } } where [_b.from_numeral : _arg -> _ret, _c.from_numeral : _arg2 -> _ret2]"))
		(patt (type "{ data: List(_a), metadata: { description: Str, ratio: _field, version: _field2 }, name: Str } where [_b.from_numeral : _arg -> _ret, _c.from_numeral : _arg2 -> _ret2, _d.from_numeral : _arg3 -> _ret3]"))
		(patt (type "{ data: List(Str), metadata: { description: Str, ratio: _field, version: _field2 }, name: Str } where [_a.from_numeral : _arg -> _ret, _b.from_numeral : _arg2 -> _ret2]"))
		(patt (type "a -> { value: a, wrapper: List(a) }"))
		(patt (type "{ value: a, wrapper: List(a) } where [a.from_numeral : b -> c]"))
		(patt (type "{ value: Str, wrapper: List(Str) }"))
		(patt (type "{ value: a, wrapper: List(a) } where [a.from_numeral : b -> c]"))
		(patt (type "{ level1: { collection: List(_a), level2: { items: List(_b), level3: { data: List(_c), value: _field } } }, results: List({ data: List(_d), tag: Str }) } where [_e.from_numeral : _arg -> _ret, _f.from_numeral : _arg2 -> _ret2, _g.from_numeral : _arg3 -> _ret3]"))
		(patt (type "_a where [_b.from_numeral : _arg -> _ret]"))
		(patt (type "_a where [_b.from_numeral : _arg -> _ret]"))
		(patt (type "List(_a) where [_b.from_numeral : _arg -> _ret]"))
		(patt (type "{ base: _field, derived: List(_a) } where [_b.from_numeral : _arg -> _ret, _c.from_numeral : _arg2 -> _ret2]"))
		(patt (type "{ computations: { from_frac: _field, from_num: _field2, list_from_num: List(_a) }, empty_lists: { in_list: List(List(_b)), in_record: { data: List(_c) }, raw: List(_d) }, numbers: { float: _field3, list: List(_e), value: _field4 }, strings: { list: List(Str), value: Str } } where [_f.from_numeral : _arg -> _ret, _g.from_numeral : _arg2 -> _ret2, _h.from_numeral : _arg3 -> _ret3, _i.from_numeral : _arg4 -> _ret4, _j.from_numeral : _arg5 -> _ret5, _k.from_numeral : _arg6 -> _ret6]"))
	...
	(expressions
		...
		(expr (type "{ count: _field, items: List(_a) } where [_b.from_numeral : _arg -> _ret]"))
		(expr (type "{ count: _field, items: List(_a) } where [_b.from_numeral : _arg -> _ret, _c.from_numeral : _arg2 -> _ret2]"))
		(expr (type "{ count: _field, items: List(Str) } where [_a.from_numeral : _arg -> _ret]"))
		(expr (type "{ data: List(_a), metadata: { description: Str, ratio: _field, version: _field2 } } where [_b.from_numeral : _arg -> _ret, _c.from_numeral : _arg2 -> _ret2]"))
		(expr (type "{ data: List(_a), metadata: { description: Str, ratio: _field, version: _field2 }, name: Str } where [_b.from_numeral : _arg -> _ret, _c.from_numeral : _arg2 -> _ret2, _d.from_numeral : _arg3 -> _ret3]"))
		(expr (type "{ data: List(Str), metadata: { description: Str, ratio: _field, version: _field2 }, name: Str } where [_a.from_numeral : _arg -> _ret, _b.from_numeral : _arg2 -> _ret2]"))
		(expr (type "a -> { value: a, wrapper: List(a) }"))
		(expr (type "{ value: a, wrapper: List(a) } where [a.from_numeral : b -> c]"))
		(expr (type "{ value: Str, wrapper: List(Str) }"))
		(expr (type "{ value: a, wrapper: List(a) } where [a.from_numeral : b -> c]"))
		(expr (type "{ level1: { collection: List(_a), level2: { items: List(_b), level3: { data: List(_c), value: _field } } }, results: List({ data: List(_d), tag: Str }) } where [_e.from_numeral : _arg -> _ret, _f.from_numeral : _arg2 -> _ret2, _g.from_numeral : _arg3 -> _ret3]"))
		(expr (type "_a where [_b.from_numeral : _arg -> _ret]"))
		(expr (type "_a where [_b.from_numeral : _arg -> _ret]"))
		(expr (type "List(_a) where [_b.from_numeral : _arg -> _ret]"))
		(expr (type "{ base: _field, derived: List(_a) } where [_b.from_numeral : _arg -> _ret, _c.from_numeral : _arg2 -> _ret2]"))
