...
(inferred-types
	(defs
		...
		(patt (type "List(List(_size)) where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]"))
		(patt (type "{ count: _size, items: List(_elem) } where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]"))
		(patt (type "{ count: _size, items: List(_size2) } where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]"))
		(patt (type "{ count: _size, items: List(Str) } where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]"))
	...
	(expressions
		...
		(expr (type "{ count: _size, items: List(_elem) } where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]"))
		(expr (type "{ count: _size, items: List(_size2) } where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]"))
		(expr (type "{ count: _size, items: List(Str) } where [_a.from_int_digits : _arg -> _ret, _b.from_dec_digits : _arg -> _ret]"))
