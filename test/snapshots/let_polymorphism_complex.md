...
(inferred-types
	(defs
		...
		(patt (type "List(List(_a))"))
		(patt (type "{ count: _field, items: List(_a) }"))
		(patt (type "{ count: _field, items: List(_a) }"))
		(patt (type "{ count: _field, items: List(Str) }"))
		(patt (type "{ data: List(_a), metadata: { description: Str, ratio: _field, version: _field2 } }"))
		(patt (type "{ data: List(_a), metadata: { description: Str, ratio: _field, version: _field2 }, name: Str }"))
		(patt (type "{ data: List(Str), metadata: { description: Str, ratio: _field, version: _field2 }, name: Str }"))
		(patt (type "a -> { value: a, wrapper: List(a) }"))
		(patt (type "{ value: a, wrapper: List(a) }"))
		(patt (type "{ value: Str, wrapper: List(Str) }"))
		(patt (type "{ value: a, wrapper: List(a) }"))
		(patt (type "{ level1: { collection: List(_a), level2: { items: List(_b), level3: { data: List(_c), value: _field } } }, results: List({ data: List(_d), tag: Str }) }"))
		(patt (type "_a"))
		(patt (type "_a"))
		(patt (type "List(_a)"))
		(patt (type "{ base: _field, derived: List(_a) }"))
	...
	(expressions
		...
		(expr (type "List(List(_a))"))
		(expr (type "{ count: _field, items: List(_a) }"))
		(expr (type "{ count: _field, items: List(_a) }"))
		(expr (type "{ count: _field, items: List(Str) }"))
		(expr (type "{ data: List(_a), metadata: { description: Str, ratio: _field, version: _field2 } }"))
		(expr (type "{ data: List(_a), metadata: { description: Str, ratio: _field, version: _field2 }, name: Str }"))
		(expr (type "{ data: List(Str), metadata: { description: Str, ratio: _field, version: _field2 }, name: Str }"))
		(expr (type "a -> { value: a, wrapper: List(a) }"))
		(expr (type "{ value: a, wrapper: List(a) }"))
		(expr (type "{ value: Str, wrapper: List(Str) }"))
		(expr (type "{ value: a, wrapper: List(a) }"))
		(expr (type "{ level1: { collection: List(_a), level2: { items: List(_b), level3: { data: List(_c), value: _field } } }, results: List({ data: List(_d), tag: Str }) }"))
		(expr (type "_a"))
		(expr (type "_a"))
		(expr (type "List(_a)"))
		(expr (type "{ base: _field, derived: List(_a) }"))
