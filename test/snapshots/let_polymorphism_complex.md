...
(can-ir
										...
										(field (name "items")
											(e-list
												(elems
													(e-lookup-local
														(p-assign (ident "num")))
													(e-dispatch-call (method "times") (constraint-fn-var 1255)
														(receiver
															(e-lookup-local
																(p-assign (ident "num"))))
														(args
															(e-num (value "2"))))
													(e-dispatch-call (method "times") (constraint-fn-var 1290)
														(receiver
															(e-lookup-local
																(p-assign (ident "num"))))
														(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 1622)
			(receiver
				(e-lookup-local
					(p-assign (ident "num"))))
			(args
			...
			(fields
				...
				(field (name "computations")
					(e-record
						(fields
							(field (name "from_num")
								(e-dispatch-call (method "times") (constraint-fn-var 1742)
									(receiver
										(e-lookup-local
											(p-assign (ident "num"))))
									(args
							...
							(field (name "from_frac")
								(e-dispatch-call (method "times") (constraint-fn-var 1777)
									(receiver
										(e-lookup-local
											(p-assign (ident "frac"))))
									(args
	...
	(d-let
		...
		(e-lambda
			(args
				(p-underscore))
			(e-block
				(e-dispatch-call (method "plus") (constraint-fn-var 1820)
					(receiver
