...
(inferred-types
	(defs
		...
		(patt (type "{ count: a, items: List(b) } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), b.try_from_str : Str -> Try(b, [InvalidStr(Str)])]"))
		(patt (type "{ data: List(_a), metadata: { description: b, ratio: c, version: d } } where [b.try_from_str : Str -> Try(b, [InvalidStr(Str)]), c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), d.from_numeral : Numeral -> Try(d, [InvalidNumeral(Str)])]"))
		(patt (type "{ data: List(a), metadata: { description: b, ratio: c, version: d }, name: e } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), b.try_from_str : Str -> Try(b, [InvalidStr(Str)]), c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), d.from_numeral : Numeral -> Try(d, [InvalidNumeral(Str)]), e.try_from_str : Str -> Try(e, [InvalidStr(Str)])]"))
		(patt (type "{ data: List(a), metadata: { description: b, ratio: c, version: d }, name: e } where [a.try_from_str : Str -> Try(a, [InvalidStr(Str)]), b.try_from_str : Str -> Try(b, [InvalidStr(Str)]), c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), d.from_numeral : Numeral -> Try(d, [InvalidNumeral(Str)]), e.try_from_str : Str -> Try(e, [InvalidStr(Str)])]"))
		(patt (type "a -> { value: a, wrapper: List(a) }"))
		(patt (type "{ value: a, wrapper: List(a) } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)])]"))
		(patt (type "{ value: a, wrapper: List(a) } where [a.try_from_str : Str -> Try(a, [InvalidStr(Str)])]"))
		(patt (type "{ value: a, wrapper: List(a) } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)])]"))
		(patt (type "{ level1: { collection: List(_a), level2: { items: List(b), level3: { data: List(_c), value: d } } }, results: List({ data: List(e), tag: f }) } where [b.from_numeral : Numeral -> Try(b, [InvalidNumeral(Str)]), d.from_numeral : Numeral -> Try(d, [InvalidNumeral(Str)]), e.from_numeral : Numeral -> Try(e, [InvalidNumeral(Str)]), f.try_from_str : Str -> Try(f, [InvalidStr(Str)])]"))
		(patt (type "a where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)])]"))
		(patt (type "a where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)])]"))
		(patt (type "List(a) where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)])]"))
		...
		(patt (type "{ computations: { from_frac: a, from_num: b, list_from_num: List(c) }, empty_lists: { in_list: List(List(_d)), in_record: { data: List(_e) }, raw: List(_f) }, numbers: { float: g, list: List(h), value: i }, strings: { list: List(j), value: k } } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), b.from_numeral : Numeral -> Try(b, [InvalidNumeral(Str)]), c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), g.from_numeral : Numeral -> Try(g, [InvalidNumeral(Str)]), h.from_numeral : Numeral -> Try(h, [InvalidNumeral(Str)]), i.from_numeral : Numeral -> Try(i, [InvalidNumeral(Str)]), j.try_from_str : Str -> Try(j, [InvalidStr(Str)]), k.try_from_str : Str -> Try(k, [InvalidStr(Str)])]"))
	...
	(expressions
		...
		(expr (type "{ count: a, items: List(b) } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), b.try_from_str : Str -> Try(b, [InvalidStr(Str)])]"))
		(expr (type "{ data: List(_a), metadata: { description: b, ratio: c, version: d } } where [b.try_from_str : Str -> Try(b, [InvalidStr(Str)]), c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), d.from_numeral : Numeral -> Try(d, [InvalidNumeral(Str)])]"))
		(expr (type "{ data: List(a), metadata: { description: b, ratio: c, version: d }, name: e } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), b.try_from_str : Str -> Try(b, [InvalidStr(Str)]), c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), d.from_numeral : Numeral -> Try(d, [InvalidNumeral(Str)]), e.try_from_str : Str -> Try(e, [InvalidStr(Str)])]"))
		(expr (type "{ data: List(a), metadata: { description: b, ratio: c, version: d }, name: e } where [a.try_from_str : Str -> Try(a, [InvalidStr(Str)]), b.try_from_str : Str -> Try(b, [InvalidStr(Str)]), c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), d.from_numeral : Numeral -> Try(d, [InvalidNumeral(Str)]), e.try_from_str : Str -> Try(e, [InvalidStr(Str)])]"))
		(expr (type "a -> { value: a, wrapper: List(a) }"))
		(expr (type "{ value: a, wrapper: List(a) } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)])]"))
		(expr (type "{ value: a, wrapper: List(a) } where [a.try_from_str : Str -> Try(a, [InvalidStr(Str)])]"))
		(expr (type "{ value: a, wrapper: List(a) } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)])]"))
