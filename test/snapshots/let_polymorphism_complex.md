...
(inferred-types
	(defs
		...
		(patt (type "List(List(_elem)) where [_a.from_int_digits : _arg -> _ret]"))
		(patt (type "{ count: _field, items: List(_elem) } where [_a.from_int_digits : _arg -> _ret]"))
		(patt (type "{ count: _field, items: List(_elem) } where [_a.from_int_digits : _arg -> _ret, _b.from_int_digits : _arg2 -> _ret2]"))
		(patt (type "{ count: _field, items: List(Str) } where [_a.from_int_digits : _arg -> _ret]"))
		(patt (type "{ data: List(_elem), metadata: { description: Str, ratio: Num(Frac(_size)), version: _field } } where [_a.from_int_digits : _arg -> _ret]"))
		(patt (type "{ data: List(_elem), metadata: { description: Str, ratio: Num(Frac(_size)), version: _field }, name: Str } where [_a.from_int_digits : _arg -> _ret, _b.from_int_digits : _arg2 -> _ret2]"))
		(patt (type "{ data: List(Str), metadata: { description: Str, ratio: Num(Frac(_size)), version: _field }, name: Str } where [_a.from_int_digits : _arg -> _ret]"))
		(patt (type "a -> { value: a, wrapper: List(a) }"))
		(patt (type "{ value: a, wrapper: List(a) } where [b.from_int_digits : b -> c]"))
		(patt (type "{ value: Str, wrapper: List(Str) }"))
		(patt (type "{ value: Num(Frac(_size)), wrapper: List(Num(Frac(_size2))) }"))
		(patt (type "{ level1: { collection: List(_elem), level2: { items: List(Num(_size)), level3: { data: List(_elem2), value: _field } } }, results: List({ data: List(_elem3), tag: Str }) } where [_a.from_int_digits : _arg -> _ret, _b.from_int_digits : _arg2 -> _ret2]"))
		(patt (type "Num(_size)"))
		(patt (type "Num(_size)"))
		(patt (type "List(_elem) where [_a.from_int_digits : _arg -> _ret]"))
		(patt (type "{ base: _field, derived: List(Num(_size)) } where [_a.from_int_digits : _arg -> _ret]"))
		(patt (type "{ computations: { from_frac: Num(Frac(_size)), from_num: Num(_size2), list_from_num: List(_elem) }, empty_lists: { in_list: List(List(_elem2)), in_record: { data: List(_elem3) }, raw: List(_elem4) }, numbers: { float: Num(Frac(_size3)), list: List(_elem5), value: _field }, strings: { list: List(Str), value: Str } } where [_a.from_int_digits : _arg -> _ret, _b.from_int_digits : _arg2 -> _ret2, _c.from_int_digits : _arg3 -> _ret3]"))
	...
	(expressions
		...
		(expr (type "{ count: _field, items: List(_elem) } where [_a.from_int_digits : _arg -> _ret]"))
		(expr (type "{ count: _field, items: List(_elem) } where [_a.from_int_digits : _arg -> _ret, _b.from_int_digits : _arg2 -> _ret2]"))
		(expr (type "{ count: _field, items: List(Str) } where [_a.from_int_digits : _arg -> _ret]"))
		(expr (type "{ data: List(_elem), metadata: { description: Str, ratio: Num(Frac(_size)), version: _field } } where [_a.from_int_digits : _arg -> _ret]"))
		(expr (type "{ data: List(_elem), metadata: { description: Str, ratio: Num(Frac(_size)), version: _field }, name: Str } where [_a.from_int_digits : _arg -> _ret, _b.from_int_digits : _arg2 -> _ret2]"))
		(expr (type "{ data: List(Str), metadata: { description: Str, ratio: Num(Frac(_size)), version: _field }, name: Str } where [_a.from_int_digits : _arg -> _ret]"))
		(expr (type "a -> { value: a, wrapper: List(a) }"))
		(expr (type "{ value: a, wrapper: List(a) } where [b.from_int_digits : b -> c]"))
		(expr (type "{ value: Str, wrapper: List(Str) }"))
		(expr (type "{ value: Num(Frac(_size)), wrapper: List(Num(Frac(_size2))) }"))
		(expr (type "{ level1: { collection: List(_elem), level2: { items: List(Num(_size)), level3: { data: List(_elem2), value: _field } } }, results: List({ data: List(_elem3), tag: Str }) } where [_a.from_int_digits : _arg -> _ret, _b.from_int_digits : _arg2 -> _ret2]"))
		(expr (type "Num(_size)"))
		(expr (type "Num(_size)"))
		(expr (type "List(_elem) where [_a.from_int_digits : _arg -> _ret]"))
		(expr (type "{ base: _field, derived: List(Num(_size)) } where [_a.from_int_digits : _arg -> _ret]"))
		(expr (type "{ computations: { from_frac: Num(Frac(_size)), from_num: Num(_size2), list_from_num: List(_elem) }, empty_lists: { in_list: List(List(_elem2)), in_record: { data: List(_elem3) }, raw: List(_elem4) }, numbers: { float: Num(Frac(_size3)), list: List(_elem5), value: _field }, strings: { list: List(Str), value: Str } } where [_a.from_int_digits : _arg -> _ret, _b.from_int_digits : _arg2 -> _ret2, _c.from_int_digits : _arg3 -> _ret3]"))
