...
(can-ir
										...
										(field (name "items")
											(e-list
												(elems
													(e-lookup-local
														(p-assign (ident "num")))
													(e-dispatch-call (method "times") (constraint-fn-var 813)
														(receiver
															(e-lookup-local
																(p-assign (ident "num"))))
														(args
															(e-num (value "2"))))
													(e-dispatch-call (method "times") (constraint-fn-var 822)
														(receiver
															(e-lookup-local
																(p-assign (ident "num"))))
														(args
	...
	(d-let
		...
		(e-dispatch-call (method "times") (constraint-fn-var 923)
			(receiver
				(e-lookup-local
					(p-assign (ident "num"))))
			(args
					...
					(e-record
						(fields
							...
							(field (name "from_frac")
								(e-dispatch-call (method "times") (constraint-fn-var 979)
									(receiver
										(e-lookup-local
											(p-assign (ident "frac"))))
									(args
	...
	(d-let
		...
		(e-lambda
			(args
				(p-underscore))
			(e-block
				(e-dispatch-call (method "plus") (constraint-fn-var 997)
					(receiver
						(e-field-access
							(receiver
								(e-lookup-local
