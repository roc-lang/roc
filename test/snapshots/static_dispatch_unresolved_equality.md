...
# PROBLEMS
**MISSING METHOD**
This is trying to compare values with `==`, but their type is an unresolved type variable, which has no methods.
**static_dispatch_unresolved_equality.md:3:10:3:16:**
```roc
result = poly() == poly()
```
         ^^^^^^
