		...
		(e-lambda
			...
			(e-block
				...
				(s-let
					...
					(e-dispatch-call (method "map") (constraint-fn-var 527)
						(receiver
							(e-lookup-local
								(p-assign (ident "container"))))
						(args
	...
	(d-let
		...
		(e-block
										...
										(s-let
											...
											(e-dispatch-call (method "map") (constraint-fn-var 529)
												...
												(args
													(e-lookup-local
														(p-assign (ident "f"))))))
										(e-dispatch-call (method "get_or") (constraint-fn-var 531)
											(receiver
												(e-lookup-local
													(p-assign (ident "mapped"))))
											(args
			...
			(s-let
				...
				(e-dispatch-call (method "map") (constraint-fn-var 762)
					(receiver
						(e-lookup-local
							(p-assign (ident "str_container"))))
					(args
			...
			(s-let
				...
				(e-dispatch-call (method "get_or") (constraint-fn-var 892)
					(receiver
						(e-dispatch-call (method "flat_map") (constraint-fn-var 852)
							(receiver
								(e-dispatch-call (method "map") (constraint-fn-var 804)
									(receiver
										(e-lookup-local
											(p-assign (ident "num_container"))))
									(args
										(e-lambda
											(args
												(p-assign (ident "x")))
											(e-dispatch-call (method "plus") (constraint-fn-var 802)
												(receiver
													(e-lookup-local
														(p-assign (ident "x"))))
												(args
							...
							(args
								(e-lambda
									...
									(e-nominal (nominal "Container")
										(e-tag (name "Value")
											(args
												(e-dispatch-call (method "plus") (constraint-fn-var 844)
													(receiver
														(e-lookup-local
															(p-assign (ident "x"))))
													(args
				...
				(fields
					...
					(field (name "transformed")
						(e-lookup-local
							(p-assign (ident "transformed"))))
					(field (name "final")
						(e-dispatch-call (method "get_or") (constraint-fn-var 968)
							(receiver
								(e-lookup-local
									(p-assign (ident "num_result"))))
							(args
