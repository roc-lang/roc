...
(inferred-types
	(defs
		...
		(patt (type "{ chained: a, final: a, id_results: (_field, Str, [True]_others), processed: c, transformed: a } where [_e.from_num_literal : _arg -> _ret, _h.from_num_literal : _arg2 -> _ret2, _i.from_num_literal : _arg3 -> _ret3, _j.from_num_literal : _arg4 -> _ret4, _k.from_num_literal : _arg5 -> _ret5]")))
	(type_decls
	...
	(expressions
		...
		(expr (type "{ chained: a, final: a, id_results: (_field, Str, [True]_others), processed: c, transformed: a } where [_e.from_num_literal : _arg -> _ret, _h.from_num_literal : _arg2 -> _ret2, _i.from_num_literal : _arg3 -> _ret3, _j.from_num_literal : _arg4 -> _ret4, _k.from_num_literal : _arg5 -> _ret5]"))))
~~~
