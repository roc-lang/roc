		...
		(e-lambda
			...
			(e-block
				...
				(s-let
					...
					(e-dispatch-call (method "map") (constraint-fn-var 528)
						(receiver
							(e-lookup-local
								(p-assign (ident "container"))))
						(args
	...
	(d-let
		...
		(e-block
										...
										(s-let
											...
											(e-dispatch-call (method "map") (constraint-fn-var 530)
												...
												(args
													(e-lookup-local
														(p-assign (ident "f"))))))
										(e-dispatch-call (method "get_or") (constraint-fn-var 532)
											(receiver
												(e-lookup-local
													(p-assign (ident "mapped"))))
											(args
				...
				(e-dispatch-call (method "map") (constraint-fn-var 753)
					...
					(args
						(e-lambda
							(args
								(p-assign (ident "x")))
							(e-dispatch-call (method "plus") (constraint-fn-var 751)
								(receiver
									(e-lookup-local
										(p-assign (ident "x"))))
								(args
			...
			(s-let
				...
				(e-dispatch-call (method "get_or") (constraint-fn-var 893)
					(receiver
						(e-dispatch-call (method "flat_map") (constraint-fn-var 853)
							(receiver
								(e-dispatch-call (method "map") (constraint-fn-var 805)
									(receiver
										(e-lookup-local
											(p-assign (ident "num_container"))))
									(args
										(e-lambda
											(args
												(p-assign (ident "x")))
											(e-dispatch-call (method "plus") (constraint-fn-var 803)
												(receiver
													(e-lookup-local
														(p-assign (ident "x"))))
												(args
							...
							(args
								(e-lambda
									...
									(e-nominal (nominal "Container")
										(e-tag (name "Value")
											(args
												(e-dispatch-call (method "plus") (constraint-fn-var 845)
													(receiver
														(e-lookup-local
															(p-assign (ident "x"))))
													(args
