...
(inferred-types
	(defs
		...
		(patt (type "{ chained: a, final: a, id_results: (e, Str, [True, ..]), processed: c, transformed: a } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), a.plus : a, h -> a, a.plus : a, i -> a, a.plus : a, a -> a, c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), c.plus : c, j -> c, e.from_numeral : Numeral -> Try(e, [InvalidNumeral(Str)]), h.from_numeral : Numeral -> Try(h, [InvalidNumeral(Str)]), i.from_numeral : Numeral -> Try(i, [InvalidNumeral(Str)]), j.from_numeral : Numeral -> Try(j, [InvalidNumeral(Str)])]")))
	(type_decls
	...
	(expressions
		...
		(expr (type "{ chained: a, final: a, id_results: (e, Str, [True, ..]), processed: c, transformed: a } where [a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), a.from_numeral : Numeral -> Try(a, [InvalidNumeral(Str)]), a.plus : a, h -> a, a.plus : a, i -> a, a.plus : a, a -> a, c.from_numeral : Numeral -> Try(c, [InvalidNumeral(Str)]), c.plus : c, j -> c, e.from_numeral : Numeral -> Try(e, [InvalidNumeral(Str)]), h.from_numeral : Numeral -> Try(h, [InvalidNumeral(Str)]), i.from_numeral : Numeral -> Try(i, [InvalidNumeral(Str)]), j.from_numeral : Numeral -> Try(j, [InvalidNumeral(Str)])]"))))
~~~
