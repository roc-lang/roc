...
(reports
	(report
		...
		(document
			(source-region (file "record_destructure.md") (start 1 7) (end 1 10) (annotation warning) (line-text "match ... {")))))
~~~
# TOKENS
~~~zig
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-dispatch-call (method "to_str") (constraint-fn-var 255)
								(receiver
									(e-lookup-local
										(p-assign (ident "age"))))
								(args)))
						(e-interpolation (constraint-fn-var 274) (dispatcher-var 19)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "name"))))
						(e-interpolation (constraint-fn-var 301) (dispatcher-var 41)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
