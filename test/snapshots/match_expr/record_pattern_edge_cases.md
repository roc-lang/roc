				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "x"))))
						(e-interpolation (constraint-fn-var 258)
							(first
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "simple"))))
						(e-interpolation (constraint-fn-var 327)
							(first
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "d"))))
						(e-interpolation (constraint-fn-var 397)
							(first
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-dispatch-call (method "to_str") (constraint-fn-var 466)
								(receiver
									(e-lookup-local
										(p-assign (ident "userAge"))))
								(args)))
						(e-interpolation (constraint-fn-var 533)
							(first
