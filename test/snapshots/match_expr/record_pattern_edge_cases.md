...
OpenCurly(2:5-2:6),LowerIdent(2:7-2:8),OpColon(2:8-2:9),OpenCurly(2:10-2:11),LowerIdent(2:12-2:13),OpColon(2:13-2:14),OpenCurly(2:15-2:16),LowerIdent(2:17-2:18),CloseCurly(2:19-2:20),CloseCurly(2:21-2:22),CloseCurly(2:23-2:24),OpFatArrow(2:25-2:27),StringStart(2:28-2:29),StringPart(2:29-2:44),OpenStringInterpolation(2:44-2:46),LowerIdent(2:46-2:47),CloseStringInterpolation(2:47-2:48),StringPart(2:48-2:48),StringEnd(2:48-2:49),
...
(e-match
	...
	(branches
		(branch @2.5-2.49
			(p-record @2.5-2.24
				(field @2.7-2.22 (name "a") (rest false)
					(p-record @2.10-2.22
						(field @2.12-2.20 (name "b") (rest false)
							(p-record @2.15-2.20
								(field @2.17-2.18 (name "c") (rest false)))))))
			(e-string @2.28-2.49
		...
		(branch @3.5-3.45
			(p-record @3.5-3.17
				(field @3.7-3.8 (name "x") (rest false))
				(field @3.10-3.15 (name "y") (rest false)
					(p-record @3.13-3.15)))
			(e-string @3.21-3.45
		...
		(branch @4.5-4.68
			(p-record @4.5-4.33
				(field @4.7-4.23 (name "outer") (rest false)
					(p-record @4.14-4.23
						(field @4.16-4.21 (name "inner") (rest false))))
				(field @4.25-4.31 (name "simple") (rest false)))
			(e-string @4.37-4.68
		...
		(branch @5.5-5.60
			(p-record @5.5-5.27
				(field @5.7-5.15 (name "a") (rest false)
					(p-record @5.10-5.15
						(field @5.12-5.13 (name "b") (rest false))))
				(field @5.17-5.25 (name "c") (rest false)
					(p-record @5.20-5.25
						(field @5.22-5.23 (name "d") (rest false)))))
			(e-string @5.31-5.60
		...
		(branch @6.5-6.35
			(p-record @6.5-6.16
				(field @6.7-6.14 (name "name") (rest false)
		...
		(branch @7.5-7.106
			(p-record @7.5-7.50
				(field @7.7-7.48 (name "person") (rest false)
					(p-record @7.15-7.48
						(field @7.17-7.32 (name "name") (rest false)
							(p-ident @7.23-7.32 (raw "firstName")))
						(field @7.34-7.46 (name "age") (rest false)
				...
				(patterns
					(pattern (degenerate false)
						(p-record-destructure @2.5-2.24
							(destructs
								(record-destruct @2.7-2.22 (label "a") (ident "a")
									(sub-pattern
										(p-record-destructure @2.10-2.22
											(destructs
												(record-destruct @2.12-2.20 (label "b") (ident "b")
													(sub-pattern
														(p-record-destructure @2.15-2.20
															(destructs
																(record-destruct @2.17-2.18 (label "c") (ident "c")
																	(required
																		(p-assign @2.17-2.18 (ident "c"))))))))))))))))
				(value
					(e-string @2.28-2.49
				...
				(patterns
					(pattern (degenerate false)
						(p-record-destructure @6.5-6.16
							(destructs
								(record-destruct @6.7-6.14 (label "name") (ident "name")
									(sub-pattern
				...
				(patterns
					(pattern (degenerate false)
						(p-record-destructure @7.5-7.50
							(destructs
								(record-destruct @7.7-7.48 (label "person") (ident "person")
									(sub-pattern
										(p-record-destructure @7.15-7.48
											(destructs
												(record-destruct @7.17-7.32 (label "name") (ident "name")
													(sub-pattern
														(p-assign @7.23-7.32 (ident "firstName"))))
												(record-destruct @7.34-7.46 (label "age") (ident "age")
													(sub-pattern
