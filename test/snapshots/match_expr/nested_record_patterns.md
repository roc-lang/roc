				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "country"))))
						(e-interpolation (constraint-fn-var 316) (dispatcher-var 27)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "city"))))
						(e-interpolation (constraint-fn-var 351) (dispatcher-var 59)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "value"))))
						(e-interpolation (constraint-fn-var 378) (dispatcher-var 76)
							(first
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "simple"))))
						(e-interpolation (constraint-fn-var 399) (dispatcher-var 89)
							(first
