				...
				(value
					(e-block
						...
						(s-let
							...
							(e-dispatch-call (method "to_str") (constraint-fn-var 179)
								(receiver
									(e-lookup-local
										(p-assign (ident "age"))))
								(args)))
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "city"))))
						(e-interpolation (constraint-fn-var 249)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "value"))))
						(e-interpolation (constraint-fn-var 316)
							(first
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "simple"))))
						(e-interpolation (constraint-fn-var 381)
							(first
