...
(reports
	(report
		...
		(document
			(source-region (file "nested_record_patterns.md") (start 1 7) (end 1 10) (annotation warning) (line-text "match ... {")))))
~~~
# TOKENS
~~~zig
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "country"))))
						(e-interpolation (constraint-fn-var 330) (dispatcher-var 27)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						...
						(s-let
							...
							(e-dispatch-call (method "to_str") (constraint-fn-var 345)
								(receiver
									(e-lookup-local
										(p-assign (ident "age"))))
								(args)))
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "city"))))
						(e-interpolation (constraint-fn-var 365) (dispatcher-var 59)
							(first
								(e-literal (string "")))
							(parts
								(e-lookup-local
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "value"))))
						(e-interpolation (constraint-fn-var 392) (dispatcher-var 76)
							(first
				...
				(value
					(e-block
						(s-let
							...
							(e-lookup-local
								(p-assign (ident "simple"))))
						(e-interpolation (constraint-fn-var 413) (dispatcher-var 89)
							(first
