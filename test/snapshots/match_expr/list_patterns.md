...
(reports
	...
	(report
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "list_patterns.md") (start 3 15) (end 3 19) (annotation error) (line-text "    [first, ..rest] => 0 # invalid rest pattern should error")))))
~~~
# TOKENS
~~~zig
