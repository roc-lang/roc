...
~~~
# EXPECTED
TYPE MODULE MISSING MATCHING TYPE - pattern_alternatives_basic.md:1:1:7:2
# PROBLEMS
**TYPE MODULE MISSING MATCHING TYPE**
Type modules must have a type declaration matching the module name.

This file is named `pattern_alternatives_basic.roc`, but no top-level type declaration named `pattern_alternatives_basic` was found.

Add either:
`pattern_alternatives_basic := ...` (nominal type)
or:
`pattern_alternatives_basic : ...` (type alias)
**pattern_alternatives_basic.md:1:1:7:2:**
```roc
Color : [Red, Green, Blue, Yellow, Orange, Purple]
