							...
							(value
								(e-block
									(s-let
										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 263)
											(receiver
												(e-lookup-local
													(p-assign (ident "x"))))
											(args)))
									(e-interpolation (constraint-fn-var 287) (dispatcher-var 20)
										(first
							...
							(value
								(e-block
									(s-let
										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 307)
											(receiver
												(e-lookup-local
													(p-assign (ident "x"))))
											(args)))
									(e-interpolation (constraint-fn-var 328) (dispatcher-var 35)
										(first
