							...
							(value
								(e-block
									(s-let
										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 273)
											(receiver
												(e-lookup-local
													(p-assign (ident "x"))))
											(args)))
									(e-interpolation (constraint-fn-var 297) (dispatcher-var 20)
										(first
										...
										(e-dispatch-call (method "to_str") (constraint-fn-var 317)
											(receiver
												(e-lookup-local
													(p-assign (ident "x"))))
											(args)))
									(e-interpolation (constraint-fn-var 338) (dispatcher-var 35)
										(first
