...
(reports
	...
	(report
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "list_rest_invalid.md") (start 2 15) (end 2 19) (annotation error) (line-text "    [first, ..rest] => 0 # invalid rest pattern should error"))))
	(report
		(severity warning)
		(title "Unused Variable")
		(region (start 3 8) (end 3 12))
		(headline
			(reflow "Variable ")
			(annotated symbol-unqualified "rest")
			(reflow " is defined here and then never used:"))
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "list_rest_invalid.md") (start 3 8) (end 3 12) (annotation error) (line-text "    [..rest, last] => 1 # invalid rest pattern should error"))))
	(report
		(severity warning)
		(title "Unused Variable")
	...
	(report
		...
		(document
			...
			(reflow " to suppress this warning.")
			(line-break)
			(source-region (file "list_rest_invalid.md") (start 4 11) (end 4 15) (annotation error) (line-text "    [x, ..rest, y] => 2 # invalid rest pattern should error"))))
	(report
		(severity warning)
		(title "Unused Variable")
