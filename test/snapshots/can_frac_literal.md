...
(inferred-types
	(defs
		(patt @1.1-1.2 (type "Num(Frac(_size))"))
		(patt @2.1-2.2 (type "Num(Frac(_size))"))
		(patt @3.1-3.2 (type "Num(Frac(_size))")))
	(expressions
		(expr @1.5-1.9 (type "Num(Frac(_size))"))
		(expr @2.5-2.12 (type "Num(Frac(_size))"))
		(expr @3.5-3.8 (type "Num(Frac(_size))"))))
~~~
