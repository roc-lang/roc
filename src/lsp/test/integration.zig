...
const issue_11521_tests = @import("issue_11521_test.zig");

pub const Spec = integration_spec.Spec;
pub const SpecError = integration_spec.SpecError;
pub const specs = parse_error_tests.specs ++ syntax_tests.specs ++ handler_integration_tests.specs ++ issue_10161_tests.specs ++ issue_11302_tests.specs ++ issue_11521_tests.specs;
