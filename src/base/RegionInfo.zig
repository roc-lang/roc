...
test "lineIdx" {
    ...
    try std.testing.expectEqual(0, RegionInfo.lineIdx(line_starts.items.toSlice(), 0));
    try std.testing.expectEqual(0, RegionInfo.lineIdx(line_starts.items.toSlice(), 5));
    try std.testing.expectEqual(0, RegionInfo.lineIdx(line_starts.items.toSlice(), 9));
    try std.testing.expectEqual(1, RegionInfo.lineIdx(line_starts.items.toSlice(), 10));
    try std.testing.expectEqual(1, RegionInfo.lineIdx(line_starts.items.toSlice(), 15));
    try std.testing.expectEqual(1, RegionInfo.lineIdx(line_starts.items.toSlice(), 19));
    try std.testing.expectEqual(2, RegionInfo.lineIdx(line_starts.items.toSlice(), 20));
    try std.testing.expectEqual(2, RegionInfo.lineIdx(line_starts.items.toSlice(), 25));
    try std.testing.expectEqual(2, RegionInfo.lineIdx(line_starts.items.toSlice(), 29));
    try std.testing.expectEqual(3, RegionInfo.lineIdx(line_starts.items.toSlice(), 30));
    try std.testing.expectEqual(3, RegionInfo.lineIdx(line_starts.items.toSlice(), 35));
}
...
test "columnIdx" {
    ...
    try std.testing.expectEqual(0, RegionInfo.columnIdx(line_starts.items.toSlice(), 0, 0));
    try std.testing.expectEqual(5, RegionInfo.columnIdx(line_starts.items.toSlice(), 0, 5));
    try std.testing.expectEqual(9, RegionInfo.columnIdx(line_starts.items.toSlice(), 0, 9));

    try std.testing.expectEqual(0, RegionInfo.columnIdx(line_starts.items.toSlice(), 1, 10));
    try std.testing.expectEqual(5, RegionInfo.columnIdx(line_starts.items.toSlice(), 1, 15));
}
...
test "getLineText" {
    ...
    try std.testing.expectEqualStrings("line0", RegionInfo.getLineText(source, line_starts.items.toSlice(), 0, 0));
    try std.testing.expectEqualStrings("line1", RegionInfo.getLineText(source, line_starts.items.toSlice(), 1, 1));
    try std.testing.expectEqualStrings("line0\nline1", RegionInfo.getLineText(source, line_starts.items.toSlice(), 0, 1));
    try std.testing.expectEqualStrings("line2", RegionInfo.getLineText(source, line_starts.items.toSlice(), 2, 2));
}
...
test "get" {
    ...
    const info1 = try RegionInfo.position(source, line_starts.items.toSlice(), 2, 4);
    ...
    try std.testing.expectEqualStrings("line0", info1.calculateLineText(source, line_starts.items.toSlice()));

    const info2 = try RegionInfo.position(source, line_starts.items.toSlice(), 8, 10);
    ...
    try std.testing.expectEqualStrings("line1", info2.calculateLineText(source, line_starts.items.toSlice()));
}
