...
pub fn initVirtual(allocator: Allocator, roc_ctx: CoreCtx, backend_kind: eval.EvalBackend) ReplInitError!ReplSession {
    var session = try init(allocator, roc_ctx, backend_kind);
