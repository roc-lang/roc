...
pub const io_spec_tests = [_]TestSpec{
    ...
    .{
        .roc_file = "test/fx/test_nested.roc",
        .io_spec = "1>Before my_any|1>In my_any|1>Done|1>After my_any|1>Before my_any|1>In my_any|1>Calling pred|1>Done|1>After my_any|1>Len: 2",
        .description = "Regression test: Closures capturing for-loop elements with list operations (issue #8946)",
    },
};
