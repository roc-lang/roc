...
pub const io_spec_tests = [_]TestSpec{
    ...
    .{
        .roc_file = "test/fx/issue8892.roc",
        .io_spec = "1>parsed: ValueCombinationMethod.Modulo",
        .description = "Regression test: match on tag with typed local assignment (issue #8892)",
    },
};
