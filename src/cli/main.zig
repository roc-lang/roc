...
pub fn main(init: std.process.Init) Allocator.Error!void {
    ...
    mainArgs(gpa, arena, args, init.io) catch |err| {
        ...
        switch (err) {
            ...
            error.HostedFunctionTypeMismatch,
            error.HttpError,
            error.Incomplete,
            error.InputOutput,
            error.Internal,
            ...
            error.InvalidRelocationSymbol,
            error.InvalidSection,
            error.InvalidSharedMemory,
            ...
            error.UnexpectedFunctionImport,
            error.UnexpectedGlobalImport,
            error.UnexpectedResult,
            error.UnexpectedTableImport,
            error.UnexpectedUndefinedFunctionSymbol,
            error.UnexpectedUndefinedSymbol,
            ...
            error.UnsupportedDevRunImageVersion,
            error.UnsupportedDevRunRelocation,
            error.UnsupportedHeader,
            error.UnsupportedLirImageVersion,
            error.UnsupportedLlvmTriple,
            error.UnsupportedLowLevel,
            error.UnsupportedPlatform,
            error.UnsupportedSectionSymbolRelocation,
            error.UnsupportedStaticDataRelocation,
