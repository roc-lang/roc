...
//     const func_expr_idx = try module_a_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
...
//     const module_b_common_idents: Check.CommonIdents = .{
//         .module_name = try module_b_env.insertIdent(base.Ident.for_text("test")),
//         .list = try module_b_env.insertIdent(base.Ident.for_text("List")),
//         .box = try module_b_env.insertIdent(base.Ident.for_text("Box")),
//     };

//     // Register the import of module A
//     _ = try module_b_cir.imports.getOrPut(allocator, &module_b_cir.common.strings, "ModuleA");
...
//     // Type check module B
//     var checker = try Check.init(allocator, &module_b_env.types, module_b_cir, modules.items, &module_b_cir.store.regions, module_b_common_idents);
...
//     const record_expr_idx = try module_a_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
...
//     // Store this as an integer literal expression (placeholder)
//     const flex_expr_idx = try module_a_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
//     } }, Content{ .flex_var = null }, base.Region.zero());
...
//     const i32_expr = try module_b_cir.addExprAndTypeVar(.{ .e_num = .{
...
//     const module_c_common_idents: Check.CommonIdents = .{
//         .module_name = try module_c_env.insertIdent(base.Ident.for_text("test")),
//         .list = try module_c_env.insertIdent(base.Ident.for_text("List")),
//         .box = try module_c_env.insertIdent(base.Ident.for_text("Box")),
//     };

//     // Module C imports from B (not A)
//     _ = try module_c_cir.imports.getOrPut(allocator, &module_c_cir.common.strings, "ModuleB");
...
//     // Type check module B
//     var checker_b = try Check.init(allocator, &module_b_env.types, module_b_cir, modules.items, &module_b_cir.store.regions, module_b_common_idents);
//     defer checker_b.deinit();

//     _ = try checker_b.checkExpr(b_lookup_expr);

//     // Type check module C
//     var checker_c = try Check.init(allocator, &module_c_env.types, module_c_cir, modules.items, &module_c_cir.store.regions, module_c_common_idents);
...
//     const map_expr_idx = try module_a_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
...
//     const map_i32_expr_idx = try module_b_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
...
//     const str_record_expr_idx = try module_b_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
...
//     const compose_expr_idx = try module_a_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
...
//     const compose_str_expr_idx = try module_b_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
...
//     const str_expr_idx = try module_a_cir.addExprAndTypeVar(.{ .e_num = .{
//         .value = .{ .bytes = [_]u8{0} ** 16, .kind = .i128 },
//         .requirements = .{ .bits_needed = 0, .sign_needed = false },
