...
pub fn makeTailRecursive(
    ...
    for (param_patterns) |pattern_id| {
        ...
        switch (pattern) {
            ...
            .int_literal, .float_literal, .str_literal, .tag, .record, .tuple, .list, .as_pattern => unreachable, // Only bind and wildcard should appear as function params after desugaring
        }
    }
