...
//! only declares roots from the core export set (builtin_registry.inCoreStaticLib).
...
/// Wrapper namespace re-exported for consumers of this root.
pub const dev_wrappers = @import("dev_wrappers.zig");

// Export the core subset of builtin wrappers. Membership is declared once,
// in builtin_registry.inCoreStaticLib.
comptime {
