...
const Opaque = @import("../sort.zig").Opaque;
const partial_backwards_merge = @import("../sort.zig").partial_backwards_merge;
const flux_default_partition = @import("../sort.zig").flux_default_partition;
const flux_reverse_partition = @import("../sort.zig").flux_reverse_partition;
const monobound_binary_first = @import("../sort.zig").monobound_binary_first;
const head_branchless_merge = @import("../sort.zig").head_branchless_merge;
const partial_forward_merge = @import("../sort.zig").partial_forward_merge;
const tail_branchless_merge = @import("../sort.zig").tail_branchless_merge;
const median_of_cube_root = @import("../sort.zig").median_of_cube_root;
const parity_merge_four = @import("../sort.zig").parity_merge_four;
const trinity_rotation = @import("../sort.zig").trinity_rotation;
const quad_merge_block = @import("../sort.zig").quad_merge_block;
const parity_merge_two = @import("../sort.zig").parity_merge_two;
const swap_branchless = @import("../sort.zig").swap_branchless;
const quad_swap_merge = @import("../sort.zig").quad_swap_merge;
const median_of_nine = @import("../sort.zig").median_of_nine;
const quad_reversal = @import("../sort.zig").quad_reversal;
const binary_median = @import("../sort.zig").binary_median;
const parity_merge = @import("../sort.zig").parity_merge;
const rotate_merge = @import("../sort.zig").rotate_merge;
const cross_merge = @import("../sort.zig").cross_merge;
const quad_merge = @import("../sort.zig").quad_merge;
const tail_merge = @import("../sort.zig").tail_merge;
const trim_four = @import("../sort.zig").trim_four;
const quad_swap = @import("../sort.zig").quad_swap;
const tail_swap = @import("../sort.zig").tail_swap;
const tiny_sort = @import("../sort.zig").tiny_sort;
