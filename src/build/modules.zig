...
pub const ModuleType = enum {
    ...
    pub fn getDependencies(self: ModuleType) []const ModuleType {
        return switch (self) {
            ...
            .eval => &.{ .tracy, .ctx, .collections, .base, .types, .builtins, .parse, .can, .check, .layout, .interpreter_layout, .values, .build_options, .reporting, .backend, .mir, .lir, .roc_target, .sljmp },
