...
fn computeTransformedExprType(
    ...
    switch (expr) {
        ...
        .e_frac_f32, .e_frac_f64, .e_dec, .e_dec_small, .e_typed_int, .e_typed_frac, .e_str_segment, .e_str, .e_lookup_external, .e_lookup_pending, .e_lookup_required, .e_list, .e_empty_list, .e_tuple, .e_if, .e_empty_record, .e_nominal, .e_nominal_external, .e_zero_argument_tag, .e_closure, .e_unary_minus, .e_unary_not, .e_dot_access, .e_tuple_access, .e_runtime_error, .e_crash, .e_dbg, .e_expect, .e_ellipsis, .e_anno_only, .e_return, .e_type_var_dispatch, .e_for, .e_hosted_lambda, .e_run_low_level => {
    ...
    switch (resolved.desc.content) {
        ...
        .structure => |flat_type| {
            switch (flat_type) {
                ...
                .record_unbound, .tuple, .nominal_type, .empty_record, .empty_tag_union => {},
            }
        },
        .rigid, .alias, .err => {},
    }
