...
fn replaceProvidedByCompilerLowLevels(env: *ModuleEnv) (Allocator.Error || error{ UnsupportedBuiltinAnnotationOnly, BuiltinLowLevelAnnotationMustBeFunction, LowLevelOperationsNotFound })!std.ArrayList(CIR.Def.Idx) {
    ...
    const internal_from_str_primitives = [_]struct {
        ...
        .{ .name = "u8_from_str_prefix_raw", .op = .u8_from_str_prefix },
        .{ .name = "u8_from_utf8_prefix_raw", .op = .u8_from_utf8_prefix },
        .{ .name = "i8_from_str_prefix_raw", .op = .i8_from_str_prefix },
        .{ .name = "i8_from_utf8_prefix_raw", .op = .i8_from_utf8_prefix },
        .{ .name = "u16_from_str_prefix_raw", .op = .u16_from_str_prefix },
        .{ .name = "u16_from_utf8_prefix_raw", .op = .u16_from_utf8_prefix },
        .{ .name = "i16_from_str_prefix_raw", .op = .i16_from_str_prefix },
        .{ .name = "i16_from_utf8_prefix_raw", .op = .i16_from_utf8_prefix },
        .{ .name = "u32_from_str_prefix_raw", .op = .u32_from_str_prefix },
        .{ .name = "u32_from_utf8_prefix_raw", .op = .u32_from_utf8_prefix },
        .{ .name = "i32_from_str_prefix_raw", .op = .i32_from_str_prefix },
        .{ .name = "i32_from_utf8_prefix_raw", .op = .i32_from_utf8_prefix },
        .{ .name = "u64_from_str_prefix_raw", .op = .u64_from_str_prefix },
        .{ .name = "u64_from_utf8_prefix_raw", .op = .u64_from_utf8_prefix },
        .{ .name = "i64_from_str_prefix_raw", .op = .i64_from_str_prefix },
        .{ .name = "i64_from_utf8_prefix_raw", .op = .i64_from_utf8_prefix },
        .{ .name = "u128_from_str_prefix_raw", .op = .u128_from_str_prefix },
        .{ .name = "u128_from_utf8_prefix_raw", .op = .u128_from_utf8_prefix },
        .{ .name = "i128_from_str_prefix_raw", .op = .i128_from_str_prefix },
        .{ .name = "i128_from_utf8_prefix_raw", .op = .i128_from_utf8_prefix },
        .{ .name = "dec_from_str_prefix_raw", .op = .dec_from_str_prefix },
        .{ .name = "dec_from_utf8_prefix_raw", .op = .dec_from_utf8_prefix },
        .{ .name = "f32_from_str_prefix_raw", .op = .f32_from_str_prefix },
        .{ .name = "f32_from_utf8_prefix_raw", .op = .f32_from_utf8_prefix },
        .{ .name = "f64_from_str_prefix_raw", .op = .f64_from_str_prefix },
        .{ .name = "f64_from_utf8_prefix_raw", .op = .f64_from_utf8_prefix },
    };
