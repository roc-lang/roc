...
test "Import.Store deduplicates module names" {
    ...
    const str_idx1 = store.imports.items.toSlice()[@intFromEnum(idx1)];
    const str_idx3 = store.imports.items.toSlice()[@intFromEnum(idx3)];
...
test "Import.Store basic CompactWriter roundtrip" {
    ...
    const str_idx1 = deserialized.imports.items.toSlice()[0];
    const str_idx2 = deserialized.imports.items.toSlice()[1];
    const str_idx3 = deserialized.imports.items.toSlice()[2];
...
test "Import.Store duplicate imports CompactWriter roundtrip" {
    ...
    const str_idx1 = deserialized.imports.items.toSlice()[@intFromEnum(idx1)];
    const str_idx2 = deserialized.imports.items.toSlice()[@intFromEnum(idx2)];
    ...
    const str_idx_0 = deserialized.imports.items.toSlice()[0];
    const str_idx_1 = deserialized.imports.items.toSlice()[1];
