...
test "record literal uses record_unbound" {
    ...
    // Test an empty record literal
    {
        ...
        switch (canonical_expr) {
            ...
            .e_hosted_lambda,
            .e_run_low_level,
            => return error.ExpectedEmptyRecord,
        }
    }
            ...
            switch (canonical_pattern) {
                .record_destructure => |rd| {
                    ...
                    switch (x_lookup) {
                        .found => {},
                        .not_found,
                        => return error.XNotInScope,
                    }
                    switch (y_lookup) {
                        .found => {},
                        .not_found,
                        => return error.YNotInScope,
                    }
                },
                .assign,
                .as,
                ...
                .underscore,
                .runtime_error,
                => return error.ExpectedRecordDestructure,
            }
        },
        .@"var",
        .expr,
            ...
            switch (canonical_pattern) {
                .record_destructure => |rd| {
                    ...
                    switch (n_lookup) {
                        .found => {},
                        .not_found,
                        => return error.NNotInScope,
                    }
                    switch (a_lookup) {
                        .found => {},
                        .not_found,
                        => return error.ANotInScope,
                    }
                },
                .assign,
                .as,
