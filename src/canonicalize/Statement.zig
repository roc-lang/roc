...
pub const Statement = union(enum) {
    ...
    pub fn pushToSExprTree(_: *const @This(), env: *const ModuleEnv, tree: *SExprTree, stmt_idx: Statement.Idx) std.mem.Allocator.Error!void {
        try env.pushStatementToSExprTree(tree, stmt_idx);
    }
};
