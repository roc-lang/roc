...
pub const BuiltinIndices = struct {
    ...
    parse_str_spec_type: Statement.Idx,
    parse_record_spec_type: Statement.Idx,
    parse_record_state_type: Statement.Idx,
    ...
    box_ident: Ident.Idx,
    parse_str_spec_ident: Ident.Idx,
    parse_record_spec_ident: Ident.Idx,
    parse_record_state_ident: Ident.Idx,
