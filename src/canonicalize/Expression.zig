...
pub const Expr = union(enum) {
    ...
    pub const LowLevel = enum {
        ...
        dec_to_i8_wrap, // Dec -> I8 (wrapping)
        dec_to_i8_try, // Dec -> Try(I8, [OutOfRange])
        dec_to_i16_wrap, // Dec -> I16 (wrapping)
        dec_to_i16_try, // Dec -> Try(I16, [OutOfRange])
        dec_to_i32_wrap, // Dec -> I32 (wrapping)
        dec_to_i32_try, // Dec -> Try(I32, [OutOfRange])
        dec_to_i64_wrap, // Dec -> I64 (wrapping)
        dec_to_i64_try, // Dec -> Try(I64, [OutOfRange])
        dec_to_i128_wrap, // Dec -> I128 (wrapping)
        dec_to_i128_try, // Dec -> Try(I128, [OutOfRange])
        dec_to_u8_wrap, // Dec -> U8 (wrapping)
        dec_to_u8_try, // Dec -> Try(U8, [OutOfRange])
        dec_to_u16_wrap, // Dec -> U16 (wrapping)
        dec_to_u16_try, // Dec -> Try(U16, [OutOfRange])
        dec_to_u32_wrap, // Dec -> U32 (wrapping)
        dec_to_u32_try, // Dec -> Try(U32, [OutOfRange])
        dec_to_u64_wrap, // Dec -> U64 (wrapping)
        dec_to_u64_try, // Dec -> Try(U64, [OutOfRange])
        dec_to_u128_wrap, // Dec -> U128 (wrapping)
        dec_to_u128_try, // Dec -> Try(U128, [OutOfRange])
