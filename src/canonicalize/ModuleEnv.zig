...
pub const CommonIdents = extern struct {
    ...
    builtin_fields: Ident.Idx,
    builtin_field: Ident.Idx,
    ...
    pub fn insert(gpa: std.mem.Allocator, common: *CommonEnv) std.mem.Allocator.Error!CommonIdents {
        return .{
            ...
            .builtin_fields = try common.insertIdent(gpa, Ident.for_text("Builtin.Fields")),
            .builtin_field = try common.insertIdent(gpa, Ident.for_text("Builtin.Field")),
    ...
    pub fn find(common: *const CommonEnv) CommonIdents {
        return .{
            ...
            .builtin_fields = common.findIdent("Builtin.Fields") orelse unreachable,
            .builtin_field = common.findIdent("Builtin.Field") orelse unreachable,
