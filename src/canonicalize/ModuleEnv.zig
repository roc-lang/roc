...
pub const CommonIdents = extern struct {
    ...
    builtin_decoder_str_spec: Ident.Idx,
    builtin_decoder_record: Ident.Idx,
    builtin_decoder_record_spec: Ident.Idx,
    builtin_decoder_record_state: Ident.Idx,
    builtin_decoder_tag_union: Ident.Idx,
    builtin_decoder_tag_union_spec: Ident.Idx,
    ...
    pub fn insert(gpa: std.mem.Allocator, common: *CommonEnv) std.mem.Allocator.Error!CommonIdents {
        return .{
            ...
            .decoder = try common.insertIdent(gpa, Ident.for_text("decoder")),
            ...
            .builtin_decoder = try common.insertIdent(gpa, Ident.for_text("Builtin.Decoder")),
            ...
            .builtin_decoder_str_spec = try common.insertIdent(gpa, Ident.for_text("Builtin.DecoderStrSpec")),
            .builtin_decoder_record = try common.insertIdent(gpa, Ident.for_text("Builtin.Decoder.Record")),
            .builtin_decoder_record_spec = try common.insertIdent(gpa, Ident.for_text("Builtin.DecoderRecordSpec")),
            .builtin_decoder_record_state = try common.insertIdent(gpa, Ident.for_text("Builtin.DecoderRecordState")),
            .builtin_decoder_tag_union = try common.insertIdent(gpa, Ident.for_text("Builtin.Decoder.TagUnion")),
            .builtin_decoder_tag_union_spec = try common.insertIdent(gpa, Ident.for_text("Builtin.DecoderTagUnionSpec")),
    ...
    pub fn find(common: *const CommonEnv) CommonIdents {
        return .{
            ...
            .decoder = common.findIdent("decoder") orelse unreachable,
            ...
            .builtin_decoder = common.findIdent("Builtin.Decoder") orelse unreachable,
            ...
            .builtin_decoder_str_spec = common.findIdent("Builtin.DecoderStrSpec") orelse unreachable,
            .builtin_decoder_record = common.findIdent("Builtin.Decoder.Record") orelse unreachable,
            .builtin_decoder_record_spec = common.findIdent("Builtin.DecoderRecordSpec") orelse unreachable,
            .builtin_decoder_record_state = common.findIdent("Builtin.DecoderRecordState") orelse unreachable,
            .builtin_decoder_tag_union = common.findIdent("Builtin.Decoder.TagUnion") orelse unreachable,
            .builtin_decoder_tag_union_spec = common.findIdent("Builtin.DecoderTagUnionSpec") orelse unreachable,
