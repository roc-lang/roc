...
pub const CommonIdents = extern struct {
    ...
    builtin_parse_str_spec: Ident.Idx,
    builtin_parse_record_spec: Ident.Idx,
    builtin_parse_record_state: Ident.Idx,
    ...
    pub fn insert(gpa: std.mem.Allocator, common: *CommonEnv) std.mem.Allocator.Error!CommonIdents {
        return .{
            ...
            .parse_from = try common.insertIdent(gpa, Ident.for_text("parse_from")),
            ...
            .builtin_parse_str_spec = try common.insertIdent(gpa, Ident.for_text("Builtin.ParseStrSpec")),
            .builtin_parse_record_spec = try common.insertIdent(gpa, Ident.for_text("Builtin.ParseRecordSpec")),
            .builtin_parse_record_state = try common.insertIdent(gpa, Ident.for_text("Builtin.ParseRecordState")),
    ...
    pub fn find(common: *const CommonEnv) CommonIdents {
        return .{
            ...
            .parse_from = common.findIdent("parse_from") orelse unreachable,
            ...
            .builtin_parse_str_spec = common.findIdent("Builtin.ParseStrSpec") orelse unreachable,
            .builtin_parse_record_spec = common.findIdent("Builtin.ParseRecordSpec") orelse unreachable,
            .builtin_parse_record_state = common.findIdent("Builtin.ParseRecordState") orelse unreachable,
