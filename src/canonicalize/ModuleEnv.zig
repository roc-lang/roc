...
pub const CommonIdents = extern struct {
    ...
    pub fn insert(gpa: std.mem.Allocator, common: *CommonEnv) std.mem.Allocator.Error!CommonIdents {
        return .{
            ...
            .range_exclusive = try common.insertIdent(gpa, Ident.for_text("range_exclusive_to")),
            .range_inclusive = try common.insertIdent(gpa, Ident.for_text("range_inclusive_to")),
    ...
    pub fn find(common: *const CommonEnv) CommonIdents {
        return .{
            ...
            .range_exclusive = common.findIdent("range_exclusive_to") orelse unreachable,
            .range_inclusive = common.findIdent("range_inclusive_to") orelse unreachable,
