...
pub const Repl = struct {
    ...
    fn evaluatePureExpression(self: *Repl, module_env: *ModuleEnv) ![]const u8 {
        ...
        const builtin_types_for_eval = BuiltinTypes.init(self.builtin_indices, self.builtin_module.env, self.builtin_module.env, self.builtin_module.env, self.builtin_module.env);
