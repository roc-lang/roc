...
pub const Store = struct {
    ...
    fn appendDescStoreToIovecs(descs: *const DescStore, writer: *serialization.IovecWriter) !void {
    ...
    fn appendDescriptorToIovecs(desc: *const Desc, writer: *serialization.IovecWriter) !void {
