...
/// Create a dynamic library search generator for the current process
/// This allows the JIT to find symbols like printf from libc
...
/// Add a definition generator to a JITDylib
