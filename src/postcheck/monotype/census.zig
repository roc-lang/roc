...
pub const Census = struct {
    ...
    template_dedup_request_resolved: Counter = Counter.init(0),
    template_dedup_request_unresolved: Counter = Counter.init(0),
    template_dedup_graph_walk: Counter = Counter.init(0),
    request_born_final_qualifies: Counter = Counter.init(0),
    request_born_final_blocked_expected: Counter = Counter.init(0),
    ...
    rehearsal_rule_stored_binding_attempt: Counter = Counter.init(0),
    rehearsal_rule_stored_binder_count_exceeds_paths: Counter = Counter.init(0),
    rehearsal_rule_stored_binder_position_absent: Counter = Counter.init(0),
    rehearsal_rule_stored_callable_position_absent: Counter = Counter.init(0),
    rehearsal_rule_stored_witness_disagreed: Counter = Counter.init(0),
    rehearsal_rule_stored_bound: Counter = Counter.init(0),
    rehearsal_stored_derive_source_absent: Counter = Counter.init(0),
    rehearsal_stored_derive_witness_not_callable: Counter = Counter.init(0),
    rehearsal_stored_derive_cursor_absent: Counter = Counter.init(0),
    rehearsal_stored_derive_emit_failed: Counter = Counter.init(0),
    rehearsal_stored_derive_emitted: Counter = Counter.init(0),
    rehearsal_rule_stored_row_remainder: Counter = Counter.init(0),
    ...
    cell_born_sealed_candidate: Counter = Counter.init(0),
    cell_born_open: Counter = Counter.init(0),
    seam_absent_under_callee_binding: Counter = Counter.init(0),
    seam_absent_under_frame: Counter = Counter.init(0),
    seam_absent_no_environment: Counter = Counter.init(0),
    seam_absent_reaches_variable: Counter = Counter.init(0),
    seam_absent_ground_position: Counter = Counter.init(0),
    seam_absent_address_out_of_range: Counter = Counter.init(0),
    seam_absent_module_absent: Counter = Counter.init(0),
    position_skip_recursive_cycle: Counter = Counter.init(0),
    position_skip_pending_or_err: Counter = Counter.init(0),
    position_skip_numeric_default: Counter = Counter.init(0),
    position_skip_open_row: Counter = Counter.init(0),
    position_skip_builtin_arity: Counter = Counter.init(0),
    position_skip_binder_not_found: Counter = Counter.init(0),
    position_skip_missing_backing: Counter = Counter.init(0),
    position_skip_engine_input: Counter = Counter.init(0),
    position_skip_undisposed_residual: Counter = Counter.init(0),
    seam_disposed_agrees: Counter = Counter.init(0),
    seam_disposed_differs: Counter = Counter.init(0),
    seam_disposed_absent: Counter = Counter.init(0),
    relation_noop_same_class: Counter = Counter.init(0),
    residual_had_disposition: Counter = Counter.init(0),
    residual_module_has_no_dispositions: Counter = Counter.init(0),
    residual_absent_from_table: Counter = Counter.init(0),
    relation_resolves_residual: Counter = Counter.init(0),
    relation_joins_two_stated: Counter = Counter.init(0),
    seam_disposed_differs_with_frame: Counter = Counter.init(0),
    seam_disposed_differs_no_frame: Counter = Counter.init(0),
    nested_dedup_graph_walk: Counter = Counter.init(0),
    nested_dedup_walk_selected_recursive: Counter = Counter.init(0),
    nested_dedup_walk_selected_merge: Counter = Counter.init(0),
    ...
    recursive_join_shadow_unstatable: Counter = Counter.init(0),
    recursive_join_shadow_both_none: Counter = Counter.init(0),
    recursive_join_shadow_agree: Counter = Counter.init(0),
    recursive_join_shadow_differs: Counter = Counter.init(0),
    recursive_join_shadow_extra: Counter = Counter.init(0),
    recursive_join_shadow_missed: Counter = Counter.init(0),
    dispatch_born_final_blocked_erased: Counter = Counter.init(0),
    rehearsal_stored_spec_scheme_absent: Counter = Counter.init(0),
    rehearsal_stored_spec_bound: Counter = Counter.init(0),
    rehearsal_stored_spec_bind_failed: Counter = Counter.init(0),
