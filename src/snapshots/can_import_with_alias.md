...
~~~
# EXPECTED
UNEXPECTED TOKEN IN EXPRESSION - can_import_with_alias.md:6:1:6:3
UNEXPECTED TOKEN IN EXPRESSION - can_import_with_alias.md:6:2:6:4
UNEXPECTED TOKEN IN EXPRESSION - can_import_with_alias.md:6:3:6:4
# PROBLEMS
...
**can_import_with_alias.md:6:1:6:3:**
```roc
~~~
```
^^
...
Here is the problematic code:
**can_import_with_alias.md:6:2:6:4:**
```roc
~~~
```
 ^^
...
Here is the problematic code:
**can_import_with_alias.md:6:3:6:4:**
```roc
~~~
```
  ^
...
Newline(1:1-1:1),
LowerIdent(5:1-5:5),OpAssign(5:6-5:7),UpperIdent(5:8-5:14),NoSpaceDotLowerIdent(5:14-5:21),Newline(1:1-1:1),
