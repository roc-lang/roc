...
(can-ir
	...
	(d-let (id 430)
		...
		(e-lambda @144.9-196.2 (id 423)
			...
			(e-block @144.13-196.2
				...
				(s-let @178.2-178.71
					(p-assign @178.2-178.8 (ident "record") (id 300))
					(e-record @178.11-178.71 (id 317)
						(fields
							(field (name "foo")
							...
							(field (name "qux")
								(e-call @178.52-178.61
									(e-tag @178.52-178.54 (ext-var 308) (name "Ok") (args "TODO"))
					...
					(e-tuple @179.10-179.68 (id 337)
						(elems
							...
							(e-call @179.30-179.39
								(e-tag @179.30-179.32 (ext-var 324) (name "Ok") (args "TODO"))
							...
							(e-tuple @179.41-179.56
								(elems
									...
									(e-lookup-local @179.50-179.55
										(pattern (id 319)))))
							(e-list @179.58-179.67 (elem-var 333)
								(elems
				...
				(s-let @180.2-187.3
					...
					(e-tuple @180.20-187.3 (id 358)
						(elems
							...
							(e-runtime-error (tag "ident_not_in_scope"))
							(e-call @184.3-184.12
								(e-tag @184.3-184.5 (ext-var 345) (name "Ok") (args "TODO"))
				...
				(s-let @189.2-190.8
					(p-assign @189.2-189.23 (ident "static_dispatch_style") (id 392))
					(e-dot-access @189.26-190.8 (field "unknown") (id 397)
						(receiver
				...
				(e-call @191.2-195.3
					(e-lookup-external
						(ext-decl @191.2-191.14 (qualified "pf.Stdout.line!") (module "pf.Stdout") (local "line!") (kind "value") (type-var 402)))
					(e-string @192.3-194.18
		...
		(annotation @144.1-144.6 (signature 428) (id 429)
			(declared-type
	...
	(d-let (id 438)
		(p-assign @199.1-199.6 (ident "empty") (id 432))
		(e-empty_record @199.9-199.11 (id 433))
		(annotation @199.1-199.6 (signature 436) (id 437)
			(declared-type
				(ty-record @198.9-198.11))))
...
(inferred-types
	(defs
		...
		(d_assign (name "main!") (def_var 430) (type "List -> Result"))
		(d_assign (name "empty") (def_var 438) (type "{  }")))
	(expressions
