...
(can-ir
	(d-let
		...
		(e-lookup-external @7.8-7.31 (module-idx 0) (field "method") (target-node-idx 0)))
	(d-let
		...
		(e-lambda @11.13-11.40
			...
			(e-call @11.20-11.40
				(e-lookup-external @11.20-11.34 (module-idx 0) (field "stringify") (target-node-idx 0))
	...
	(d-let
		...
		(e-lambda @15.18-15.51
			...
			(e-lookup-external @15.24-15.51 (module-idx 1) (field "defaultResponse") (target-node-idx 0)))
	...
	(d-let
		...
		(e-call @18.10-18.28
			(e-lookup-external @18.10-18.20 (module-idx 0) (field "prase") (target-node-idx 0))
			(e-string @18.21-18.27
	...
	(d-let
		...
		(e-lookup-external @24.10-24.28 (module-idx 1) (field "invalidMethod") (target-node-idx 0)))
	(d-let
		(p-assign @27.1-27.7 (ident "parser"))
		(e-lookup-external @27.10-27.49 (module-idx 0) (field "create") (target-node-idx 0)))
