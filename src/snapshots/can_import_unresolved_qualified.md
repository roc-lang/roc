...
(can-ir
	(d-let
		...
		(e-lookup-external
			(ext-decl (ident "json.Json.method") (kind "value"))))
	(d-let
		...
		(e-lambda @11.13-11.40
			...
			(e-call @11.20-11.40
				(e-lookup-external
					(ext-decl (ident "json.Json.stringify") (kind "value")))
				(e-lookup-local @11.35-11.39
					(p-assign @11.14-11.18 (ident "data")))))
		(annotation @11.1-11.10
			(declared-type
				(ty-func @10.13-10.36 (effectful false)
					(ty-lookup-external @10.13-10.29
						(ext-decl (ident "Json.InvalidType") (kind "type")))
					(ty-type @10.33-10.36 (name "Str"))))))
	(d-let
		...
		(annotation @15.1-15.15
			(declared-type
				(ty-func @14.18-14.61 (effectful false)
					(ty-lookup-external @14.18-14.37
						(ext-decl (ident "Http.Server.Request") (kind "type")))
					(ty-lookup-external @14.41-14.61
						(ext-decl (ident "Http.Server.Response") (kind "type")))))))
	(d-let
		(p-assign @18.1-18.7 (ident "result"))
		(e-call @18.10-18.28
			(e-lookup-external
				(ext-decl (ident "json.Json.prase") (kind "value")))
			(e-str @18.21-18.27
	...
	(d-let
		...
		(e-lookup-external
			(ext-decl (ident "http.Client.invalidMethod") (kind "value"))))
	(d-let
		(p-assign @27.1-27.7 (ident "parser"))
		(e-lookup-external
			(ext-decl (ident "json.Json.create") (kind "value"))))
...
(inferred-types
	(defs
		(patt @7.1-7.31 (type "*"))
		(patt @11.1-11.40 (type "Json.InvalidType -> Str"))
		(patt @15.1-15.51 (type "Http.Server.Request -> Http.Server.Response"))
		(patt @18.1-18.28 (type "*"))
		(patt @21.1-21.31 (type "*"))
		(patt @24.1-24.28 (type "*"))
		(patt @27.1-27.49 (type "*")))
	(expressions
		(expr (type "*"))
		(expr (type "Json.InvalidType -> Str"))
		(expr (type "Http.Server.Request -> Http.Server.Response"))
		(expr (type "*"))
		(expr (type "*"))
		(expr (type "*"))
		(expr (type "*"))))
