	...
	(fields
		...
		(field (name "status")
			(e-call @4-13-4-44
				...
				(e-record @4-20-4-43 (ext-var 91)
					(fields
						(field (name "since")
							(e-string @4-29-4-41
								(e-literal @4-30-4-40 (string "2023-01-15"))))))))
		(field (name "preferences")
			(e-record @5-18-5-76 (ext-var 105)
				(fields
					(field (name "theme")
		...
		(field (name "metadata")
			(e-call @6-15-9-7
				...
				(e-record @6-18-9-6 (ext-var 130)
					(fields
						(field (name "tags")
							(e-list @7-15-7-51 (elem-var 118)
								(elems
									(e-string @7-16-7-27
		...
		(field (name "nested")
			(e-record @11-13-14-6 (ext-var 178)
				(fields
					(field (name "items")
						(e-list @12-16-12-52 (elem-var 155)
							(elems
								(e-call @12-17-12-30
					...
					(field (name "result")
						(e-call @13-17-13-70
							...
							(e-record @13-25-13-69 (ext-var 172)
								(fields
									(field (name "data")
