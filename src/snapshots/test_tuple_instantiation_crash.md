...
LowerIdent(5:1-5:5),OpAssign(5:6-5:7),OpBar(5:8-5:9),NoSpaceOpenRound(5:9-5:10),LowerIdent(5:10-5:11),Comma(5:11-5:12),LowerIdent(5:13-5:14),CloseRound(5:14-5:15),OpBar(5:15-5:16),OpenRound(5:17-5:18),LowerIdent(5:18-5:19),Comma(5:19-5:20),LowerIdent(5:21-5:22),CloseRound(5:22-5:23),Newline(1:1-1:1),
Newline(1:1-1:1),
Newline(7:2-7:57),
Newline(8:2-8:70),
