...
~~~
# EXPECTED
UNEXPECTED TOKEN IN EXPRESSION - platform_header_empty_1.md:6:1:6:3
UNEXPECTED TOKEN IN EXPRESSION - platform_header_empty_1.md:6:2:6:4
UNEXPECTED TOKEN IN EXPRESSION - platform_header_empty_1.md:6:3:6:4
# PROBLEMS
...
**platform_header_empty_1.md:6:1:6:3:**
```roc
~~~
```
^^
...
Here is the problematic code:
**platform_header_empty_1.md:6:2:6:4:**
```roc
~~~
```
 ^^
...
Here is the problematic code:
**platform_header_empty_1.md:6:3:6:4:**
```roc
~~~
```
  ^
