...
(inferred-types
	(defs
		(patt @4.1-4.4 (type "Frac(size)"))
		(patt @5.1-5.5 (type "Frac(size)"))
		(patt @6.1-6.4 (type "Str"))
		(patt @7.1-7.14 (type "List(elem)"))
		(patt @8.1-8.17 (type "List(Frac(size))"))
		(patt @11.1-11.15 (type "arg -> { data: arg, count: Num(size) }"))
		(patt @14.1-14.14 (type "{ data: field, count: Num(size) }"))
		(patt @15.1-15.14 (type "{ data: field2, count: Num(size) }"))
		(patt @16.1-16.15 (type "{ data: field3, count: Num(size) }"))
		(patt @19.1-19.12 (type "arg2, arg3 -> ret"))
		(patt @22.1-22.12 (type "a"))
		(patt @23.1-23.12 (type "b"))
		(patt @26.1-26.16 (type "arg4 -> { value: arg4 }"))
		(patt @29.1-29.11 (type "{ value: field4 }"))
		(patt @30.1-30.11 (type "{ value: field5 }"))
		(patt @31.1-31.12 (type "{ value: field6 }"))
		(patt @33.1-33.5 (type "arg5 -> ret2")))
	(expressions
		(expr @4.7-4.9 (type "Frac(size)"))
		(expr @5.8-5.11 (type "Frac(size)"))
		(expr @6.7-6.14 (type "Str"))
		(expr @7.17-7.19 (type "List(elem)"))
		(expr @8.20-8.31 (type "List(Frac(size))"))
		(expr @11.18-11.51 (type "arg -> { data: arg, count: Num(size) }"))
		(expr @14.17-14.36 (type "{ data: field, count: Num(size) }"))
		(expr @15.17-15.36 (type "{ data: field2, count: Num(size) }"))
		(expr @16.18-16.47 (type "{ data: field3, count: Num(size) }"))
		(expr @19.15-19.69 (type "arg2, arg3 -> ret"))
		(expr @22.15-22.46 (type "a"))
		(expr @23.15-23.50 (type "b"))
		(expr @26.19-26.35 (type "arg4 -> { value: arg4 }"))
		(expr @29.14-29.33 (type "{ value: field4 }"))
		(expr @30.14-30.37 (type "{ value: field5 }"))
		(expr @31.15-31.41 (type "{ value: field6 }"))
		(expr @33.8-36.2 (type "arg5 -> ret2"))))
~~~
