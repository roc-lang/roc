...
(inferred-types
	(defs
		(patt @4.1-4.4 (type "Frac(a)"))
		(patt @5.1-5.5 (type "Frac(a)"))
		(patt @6.1-6.4 (type "Str"))
		(patt @7.1-7.14 (type "List(a)"))
		(patt @8.1-8.17 (type "List(Frac(a))"))
		(patt @11.1-11.15 (type "a -> { data: b, count: Num(c) }"))
		(patt @14.1-14.14 (type "{ data: a, count: Num(b) }"))
		(patt @15.1-15.14 (type "{ data: a, count: Num(b) }"))
		(patt @16.1-16.15 (type "{ data: a, count: Num(b) }"))
		(patt @19.1-19.12 (type "a, b -> c"))
		(patt @22.1-22.12 (type "a"))
		(patt @23.1-23.12 (type "a"))
		(patt @26.1-26.16 (type "a -> { value: b }"))
		(patt @29.1-29.11 (type "{ value: a }"))
		(patt @30.1-30.11 (type "{ value: a }"))
		(patt @31.1-31.12 (type "{ value: a }"))
		(patt @33.1-33.5 (type "a -> b")))
	(expressions
		(expr @4.7-4.9 (type "Frac(a)"))
		(expr @5.8-5.11 (type "Frac(a)"))
		(expr @6.7-6.14 (type "Str"))
		(expr @7.17-7.19 (type "List(a)"))
		(expr @8.20-8.31 (type "List(Frac(a))"))
		(expr @11.18-11.51 (type "a -> { data: b, count: Num(c) }"))
		(expr @14.17-14.36 (type "{ data: a, count: Num(b) }"))
		(expr @15.17-15.36 (type "{ data: a, count: Num(b) }"))
		(expr @16.18-16.47 (type "{ data: a, count: Num(b) }"))
		(expr @19.15-19.69 (type "a, b -> c"))
		(expr @22.15-22.46 (type "a"))
		(expr @23.15-23.50 (type "a"))
		(expr @26.19-26.35 (type "a -> { value: b }"))
		(expr @29.14-29.33 (type "{ value: a }"))
		(expr @30.14-30.37 (type "{ value: a }"))
		(expr @31.15-31.41 (type "{ value: a }"))
		(expr @33.8-36.2 (type "a -> b"))))
~~~
