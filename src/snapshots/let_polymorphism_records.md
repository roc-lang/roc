...
(inferred-types
	(defs
		...
		(patt @11.1-11.15 (type "a -> { data: a, count: Num(b) }"))
	...
	(expressions
		...
		(expr @11.18-11.51 (type "a -> { data: a, count: Num(a) }"))
		(expr @14.17-14.36 (type "{ data: a, count: Num(a) }"))
		(expr @15.17-15.36 (type "{ data: a, count: Num(a) }"))
		(expr @16.18-16.47 (type "{ data: a, count: Num(a) }"))
