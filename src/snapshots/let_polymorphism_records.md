...
(inferred-types
	(defs
		...
		(patt @14.1-14.14 (type "{ data: a, count: Num(size) }"))
		(patt @15.1-15.14 (type "{ data: b, count: Num(size) }"))
		(patt @16.1-16.15 (type "{ data: c, count: Num(size) }"))
		(patt @19.1-19.12 (type "arg2, arg3 -> d"))
		(patt @22.1-22.12 (type "e"))
		(patt @23.1-23.12 (type "f"))
		(patt @26.1-26.16 (type "arg4 -> { value: arg4 }"))
		(patt @29.1-29.11 (type "{ value: g }"))
		(patt @30.1-30.11 (type "{ value: h }"))
		(patt @31.1-31.12 (type "{ value: i }"))
		(patt @33.1-33.5 (type "arg5 -> j")))
	(expressions
		...
		(expr @14.17-14.36 (type "{ data: a, count: Num(size) }"))
		(expr @15.17-15.36 (type "{ data: b, count: Num(size) }"))
		(expr @16.18-16.47 (type "{ data: c, count: Num(size) }"))
		(expr @19.15-19.69 (type "arg2, arg3 -> d"))
		(expr @22.15-22.46 (type "e"))
		(expr @23.15-23.50 (type "f"))
		(expr @26.19-26.35 (type "arg4 -> { value: arg4 }"))
		(expr @29.14-29.33 (type "{ value: g }"))
		(expr @30.14-30.37 (type "{ value: h }"))
		(expr @31.15-31.41 (type "{ value: i }"))
		(expr @33.8-36.2 (type "arg5 -> j"))))
~~~
