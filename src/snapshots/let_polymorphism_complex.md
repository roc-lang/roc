...
# Demonstrating they are different types by using in context
list_with_ints = if True then [1, 2, 3] else empty_ints
list_with_strs = if True then ["a", "b"] else empty_strs
...
**let_polymorphism_complex.md:71:31:71:33:**
```roc
list_with_ints = if True then [1, 2, 3] else empty_ints
```
                              ^^
...
Here is the problematic code:
**let_polymorphism_complex.md:71:33:71:36:**
```roc
list_with_ints = if True then [1, 2, 3] else empty_ints
```
                                ^^^
...
Here is the problematic code:
**let_polymorphism_complex.md:71:36:71:39:**
```roc
list_with_ints = if True then [1, 2, 3] else empty_ints
```
                                   ^^^
...
Here is the problematic code:
**let_polymorphism_complex.md:71:39:71:45:**
```roc
list_with_ints = if True then [1, 2, 3] else empty_ints
```
                                      ^^^^^^
...
Here is the problematic code:
**let_polymorphism_complex.md:71:41:71:56:**
```roc
list_with_ints = if True then [1, 2, 3] else empty_ints
```
                                        ^^^^^^^^^^^^^^^
...
Here is the problematic code:
**let_polymorphism_complex.md:72:31:72:33:**
```roc
list_with_strs = if True then ["a", "b"] else empty_strs
```
                              ^^
...
Here is the problematic code:
**let_polymorphism_complex.md:72:35:72:38:**
```roc
list_with_strs = if True then ["a", "b"] else empty_strs
```
                                  ^^^
...
Here is the problematic code:
**let_polymorphism_complex.md:72:40:72:46:**
```roc
list_with_strs = if True then ["a", "b"] else empty_strs
```
                                       ^^^^^^
...
Here is the problematic code:
**let_polymorphism_complex.md:72:42:72:57:**
```roc
list_with_strs = if True then ["a", "b"] else empty_strs
```
                                         ^^^^^^^^^^^^^^^
...
Newline(1:1-1:1),
Newline(70:2-70:61),
LowerIdent(71:1-71:15),OpAssign(71:16-71:17),KwIf(71:18-71:20),UpperIdent(71:21-71:25),LowerIdent(71:26-71:30),OpenSquare(71:31-71:32),Int(71:32-71:33),Comma(71:33-71:34),Int(71:35-71:36),Comma(71:36-71:37),Int(71:38-71:39),CloseSquare(71:39-71:40),KwElse(71:41-71:45),LowerIdent(71:46-71:56),Newline(1:1-1:1),
LowerIdent(72:1-72:15),OpAssign(72:16-72:17),KwIf(72:18-72:20),UpperIdent(72:21-72:25),LowerIdent(72:26-72:30),OpenSquare(72:31-72:32),StringStart(72:32-72:33),StringPart(72:33-72:34),StringEnd(72:34-72:35),Comma(72:35-72:36),StringStart(72:37-72:38),StringPart(72:38-72:39),StringEnd(72:39-72:40),CloseSquare(72:40-72:41),KwElse(72:42-72:46),LowerIdent(72:47-72:57),Newline(1:1-1:1),
Newline(1:1-1:1),
LowerIdent(74:1-74:5),OpAssign(74:6-74:7),OpBar(74:8-74:9),Underscore(74:9-74:10),OpBar(74:10-74:11),OpenCurly(74:12-74:13),Newline(1:1-1:1),
Newline(75:6-75:60),
OpenCurly(76:5-76:6),LowerIdent(76:7-76:13),Comma(76:13-76:14),LowerIdent(76:15-76:21),Comma(76:21-76:22),LowerIdent(76:23-76:33),Comma(76:33-76:34),LowerIdent(76:35-76:45),Comma(76:45-76:46),LowerIdent(76:47-76:54),Comma(76:54-76:55),LowerIdent(76:56-76:65),Comma(76:65-76:66),LowerIdent(76:67-76:75),Comma(76:75-76:76),LowerIdent(76:77-76:85),CloseCurly(76:86-76:87),Newline(1:1-1:1),
CloseCurly(77:1-77:2),EndOfFile(77:2-77:2),
~~~
# PARSE
~~~clojure
(file @1.1-77.2
	...
	(statements
		...
		(s-decl @71.1-71.33
			(p-ident @71.1-71.15 (raw "list_with_ints"))
			(e-malformed @71.31-71.33 (reason "no_else")))
		(e-int @71.32-71.33 (raw "1"))
		(e-malformed @71.33-71.36 (reason "expr_unexpected_token"))
		(e-int @71.35-71.36 (raw "2"))
		(e-malformed @71.36-71.39 (reason "expr_unexpected_token"))
		(e-int @71.38-71.39 (raw "3"))
		(e-malformed @71.39-71.45 (reason "expr_unexpected_token"))
		(e-malformed @71.41-71.56 (reason "expr_unexpected_token"))
		(e-ident @71.46-71.56 (raw "empty_ints"))
		(s-decl @72.1-72.33
			(p-ident @72.1-72.15 (raw "list_with_strs"))
			(e-malformed @72.31-72.33 (reason "no_else")))
		(e-string @72.32-72.35
			(e-string-part @72.33-72.34 (raw "a")))
		(e-malformed @72.35-72.38 (reason "expr_unexpected_token"))
		(e-string @72.37-72.40
			(e-string-part @72.38-72.39 (raw "b")))
		(e-malformed @72.40-72.46 (reason "expr_unexpected_token"))
		(e-malformed @72.42-72.57 (reason "expr_unexpected_token"))
		(e-ident @72.47-72.57 (raw "empty_strs"))
		(s-decl @74.1-77.2
			(p-ident @74.1-74.5 (raw "main"))
			(e-lambda @74.8-77.2
				(args
					(p-underscore))
				(e-block @74.12-77.2
...
# True let-polymorphism: polymorphic identity function
id = |x| x
...
# Demonstrating they are different types by using in context
list_with_ints = 123empty_ints
list_with_strs = "a""b"empty_strs
...
(can-ir
	...
	(d-let
		(p-assign @71.1-71.15 (ident "list_with_ints"))
		(e-runtime-error (tag "expr_not_canonicalized")))
	(d-let
		(p-assign @72.1-72.15 (ident "list_with_strs"))
		(e-runtime-error (tag "expr_not_canonicalized")))
	(d-let
		(p-assign @74.1-74.5 (ident "main"))
		(e-lambda @74.8-77.2
			(args
				(p-underscore @74.9-74.10))
			(e-block @74.12-77.2
				(e-record @76.5-76.87
					(fields
						(field (name "id_int")
							(e-lookup-local @76.7-76.14
								(pattern @7.1-7.7)))
						(field (name "id_str")
							(e-lookup-local @76.15-76.22
								(pattern @8.1-8.7)))
						(field (name "result_int")
							(e-lookup-local @76.23-76.34
								(pattern @22.1-22.11)))
						(field (name "result_str")
							(e-lookup-local @76.35-76.46
								(pattern @23.1-23.11)))
						(field (name "int_use")
							(e-lookup-local @76.47-76.55
								(pattern @58.1-58.8)))
						(field (name "float_use")
							(e-lookup-local @76.56-76.66
								(pattern @61.1-61.10)))
						(field (name "int_pair")
							(e-lookup-local @76.67-76.76
								(pattern @30.1-30.9)))
						(field (name "str_pair")
							(e-lookup-local @76.77-76.87
								(pattern @31.1-31.9)))))))))
~~~
# TYPES
~~~clojure
(inferred-types
	(defs
		...
		(patt @71.1-71.15 (type "Error"))
		(patt @72.1-72.15 (type "Error"))
		(patt @74.1-74.5 (type "* -> { id_int: *, id_str: *, result_int: *, result_str: *, int_use: *, float_use: *, int_pair: { fst: *, snd: * }, str_pair: { fst: *, snd: * } }")))
	(expressions
		(expr @4.6-4.11 (type "* -> *"))
		(expr @7.10-7.16 (type "*"))
		(expr @8.10-8.21 (type "*"))
		...
		(expr @71.31-71.33 (type "Error"))
		(expr @72.31-72.33 (type "Error"))
		(expr @74.8-77.2 (type "* -> { id_int: *, id_str: *, result_int: *, result_str: *, int_use: *, float_use: *, int_pair: { fst: *, snd: * }, str_pair: { fst: *, snd: * } }"))))
~~~
