...
(inferred-types
	(defs
		...
		(patt @10.1-10.11 (type "List(Num(a))"))
		(patt @11.1-11.13 (type "{}"))
		(patt @14.1-14.9 (type "List(Num(a))"))
		(patt @15.1-15.9 (type "List(Str)"))
		(patt @16.1-16.10 (type "List([True, False]a)"))
		(patt @19.1-19.13 (type "List(List(Num(a)))"))
		(patt @20.1-20.13 (type "List(List(Num(a)))"))
		(patt @23.1-23.12 (type "{ items: List(Num(a)), count: Num(b) }"))
		(patt @24.1-24.17 (type "{ items: List(Num(a)), count: Num(b) }"))
		(patt @25.1-25.17 (type "{ items: List(Str), count: Num(a) }"))
		(patt @28.1-28.12 (type "{ data: List(Num(a)), metadata: { version: Num(b), ratio: Frac(c), description: Str } }"))
		(patt @38.1-38.8 (type "{ data: List(Num(a)), metadata: { version: Num(b), ratio: Frac(c), description: Str }, name: Str }"))
		(patt @48.1-48.8 (type "{ data: List(Str), metadata: { version: Num(a), ratio: Frac(b), description: Str }, name: Str }"))
		(patt @59.1-59.15 (type "a -> { value: b, wrapper: List(c) }"))
		(patt @60.1-60.11 (type "{ value: a, wrapper: List(b) }"))
		(patt @61.1-61.11 (type "{ value: a, wrapper: List(b) }"))
		(patt @62.1-62.11 (type "{ value: a, wrapper: List(b) }"))
		(patt @65.1-65.5 (type "{ level1: { level2: { level3: { data: List(Num(a)), value: Num(b) }, items: List(Num(c)) }, collection: List(Num(d)) }, results: List({ data: List(Num(e)), tag: Str }) }"))
		(patt @84.1-84.9 (type "a"))
		(patt @85.1-85.9 (type "a"))
		(patt @86.1-86.9 (type "List(Num(a))"))
		(patt @87.1-87.9 (type "{ base: Num(a), derived: List(Num(b)) }"))
		(patt @90.1-90.6 (type "{ numbers: { value: Num(a), list: List(Num(b)), float: Frac(c) }, strings: { value: Str, list: List(Str) }, empty_lists: { raw: List(Num(d)), in_list: List(List(Num(e))), in_record: { data: List(Num(f)) } }, computations: { from_num: g, from_frac: h, list_from_num: List(Num(i)) } }"))
		(patt @105.1-105.5 (type "a -> b")))
	(expressions
		(expr @4.7-4.9 (type "Num(a)"))
		(expr @5.8-5.11 (type "Frac(a)"))
		(expr @6.7-6.14 (type "Str"))
		(expr @7.8-7.12 (type "[True]a"))
		(expr @10.14-10.16 (type "List(Num(a))"))
		(expr @11.16-11.18 (type "{}"))
		(expr @14.12-14.21 (type "List(Num(a))"))
		(expr @15.12-15.27 (type "List(Str)"))
		(expr @16.13-16.26 (type "List([True, False]a)"))
		(expr @19.16-19.52 (type "List(List(Num(a)))"))
		(expr @20.16-20.56 (type "List(List(Num(a)))"))
		(expr @23.15-23.46 (type "{ items: List(Num(a)), count: Num(b) }"))
		(expr @24.20-24.50 (type "{ items: List(Num(a)), count: Num(b) }"))
		(expr @25.20-25.56 (type "{ items: List(Str), count: Num(a) }"))
		(expr @28.15-35.2 (type "{ data: List(Num(a)), metadata: { version: Num(b), ratio: Frac(c), description: Str } }"))
		(expr @38.11-46.2 (type "{ data: List(Num(a)), metadata: { version: Num(b), ratio: Frac(c), description: Str }, name: Str }"))
		(expr @48.11-56.2 (type "{ data: List(Str), metadata: { version: Num(a), ratio: Frac(b), description: Str }, name: Str }"))
		(expr @59.18-59.54 (type "a -> { value: b, wrapper: List(c) }"))
		(expr @60.14-60.33 (type "{ value: a, wrapper: List(b) }"))
		(expr @61.14-61.33 (type "{ value: a, wrapper: List(b) }"))
		(expr @62.14-62.34 (type "{ value: a, wrapper: List(b) }"))
		(expr @65.8-81.2 (type "{ level1: { level2: { level3: { data: List(Num(a)), value: Num(b) }, items: List(Num(c)) }, collection: List(Num(d)) }, results: List({ data: List(Num(e)), tag: Str }) }"))
		(expr @84.12-84.20 (type "a"))
		(expr @85.12-85.19 (type "a"))
		(expr @86.12-86.22 (type "List(Num(a))"))
		(expr @87.12-87.59 (type "{ base: Num(a), derived: List(Num(b)) }"))
		(expr @90.9-103.2 (type "{ numbers: { value: Num(a), list: List(Num(b)), float: Frac(c) }, strings: { value: Str, list: List(Str) }, empty_lists: { raw: List(Num(d)), in_list: List(List(Num(e))), in_record: { data: List(Num(f)) } }, computations: { from_num: g, from_frac: h, list_from_num: List(Num(i)) } }"))
		(expr @105.8-108.2 (type "a -> b"))))
~~~
