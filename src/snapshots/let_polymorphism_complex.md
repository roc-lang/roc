...
(inferred-types
	(defs
		...
		(patt @60.1-60.11 (type "{ value: c, wrapper: List(elem) }"))
		(patt @61.1-61.11 (type "{ value: d, wrapper: List(elem2) }"))
		(patt @62.1-62.11 (type "{ value: e, wrapper: List(elem3) }"))
		...
		(patt @84.1-84.9 (type "f"))
		(patt @85.1-85.9 (type "g"))
		(patt @86.1-86.9 (type "List(Num(size))"))
		(patt @87.1-87.9 (type "{ base: Num(size), derived: List(Num(size2)) }"))
		(patt @90.1-90.6 (type "{ numbers: { value: Num(size), list: List(Num(size2)), float: Frac(size3) }, strings: { value: Str, list: List(Str) }, empty_lists: { raw: List(Num(size4)), in_list: List(List(Num(size5))), in_record: { data: List(Num(size6)) } }, computations: { from_num: h, from_frac: i, list_from_num: List(Num(size7)) } }"))
		(patt @105.1-105.5 (type "arg2 -> j")))
	(expressions
		...
		(expr @60.14-60.33 (type "{ value: c, wrapper: List(elem) }"))
		(expr @61.14-61.33 (type "{ value: d, wrapper: List(elem2) }"))
		(expr @62.14-62.34 (type "{ value: e, wrapper: List(elem3) }"))
		...
		(expr @84.12-84.20 (type "f"))
		(expr @85.12-85.19 (type "g"))
		(expr @86.12-86.22 (type "List(Num(size))"))
		(expr @87.12-87.59 (type "{ base: Num(size), derived: List(Num(size2)) }"))
		(expr @90.9-103.2 (type "{ numbers: { value: Num(size), list: List(Num(size2)), float: Frac(size3) }, strings: { value: Str, list: List(Str) }, empty_lists: { raw: List(Num(size4)), in_list: List(List(Num(size5))), in_record: { data: List(Num(size6)) } }, computations: { from_num: h, from_frac: i, list_from_num: List(Num(size7)) } }"))
		(expr @105.8-108.2 (type "arg2 -> j"))))
~~~
