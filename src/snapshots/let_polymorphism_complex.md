...
(inferred-types
	...
	(expressions
		...
		(expr @90.9-103.2 (type "{ numbers: { value: Num(a), list: List(Num(b)), float: Frac(c) }, strings: { value: Str, list: List(Str) }, empty_lists: { raw: List(Num(d)), in_list: List(List(Num(e))), in_record: { data: List(Num(f)) } }, computations: { from_num: g, from_frac: h, list_from_num: List(Num(g)) } }"))
