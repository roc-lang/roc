	...
	(d-let (id 103)
		...
		(e-block @5-8-10-2 (id 102)
			(s-let @6-5-6-38
				...
				(e-record @6-12-6-38 (ext-var 84) (id 85)
					(fields
						(field (name "name")
							(e-string @6-20-6-27
								(e-literal @6-21-6-26 (string "Alice"))))
						(field (name "age")
							(e-int @6-34-6-36 (num-var 82) (sign-needed "false") (bits-needed "7") (value "30"))))))
			(s-let @7-5-7-27
				(p-assign @7-5-7-12 (ident "encoded") (id 89))
				(e-call @7-15-7-27 (id 93)
					(e-lookup-external
						(ext-decl @7-15-7-21 (qualified "json.Json.encode") (module "json.Json") (local "encode") (kind "value") (type-var 90)))
