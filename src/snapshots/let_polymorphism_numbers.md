...
(inferred-types
	(defs
		(patt @4.1-4.4 (type "Num(a)"))
		(patt @5.1-5.5 (type "Frac(a)"))
		(patt @8.1-8.8 (type "Num(a)"))
		(patt @9.1-9.10 (type "Frac(a)"))
		(patt @12.1-12.8 (type "a"))
		(patt @13.1-13.13 (type "a"))
		(patt @16.1-16.10 (type "a"))
		(patt @17.1-17.15 (type "a"))
		(patt @20.1-20.7 (type "a -> b"))
		(patt @23.1-23.12 (type "a"))
		(patt @24.1-24.14 (type "a"))
		(patt @26.1-26.5 (type "a -> b")))
	(expressions
		(expr @4.7-4.9 (type "Num(a)"))
		(expr @5.8-5.11 (type "Frac(a)"))
		(expr @8.11-8.14 (type "Num(a)"))
		(expr @9.13-9.17 (type "Frac(a)"))
		(expr @12.11-12.19 (type "a"))
		(expr @13.16-13.23 (type "a"))
		(expr @16.13-16.23 (type "a"))
		(expr @17.18-17.27 (type "a"))
		(expr @20.10-20.19 (type "a -> b"))
		(expr @23.15-23.24 (type "a"))
		(expr @24.17-24.28 (type "a"))
		(expr @26.8-29.2 (type "a -> b"))))
~~~
