...
(can-ir
	(d-let (id 90)
		...
		(e-lambda @5.12-5.17 (id 82)
			(args
				(p-assign @5.13-5.14 (ident "a") (id 79)))
	...
	(d-let (id 96)
		(p-assign @7.1-7.6 (ident "main!") (id 91))
		(e-lambda @7.9-7.15 (id 95)
			(args
				(p-underscore @7.10-7.11 (id 92)))
...
(inferred-types
	(defs
		...
		(d_assign (name "main!") (def_var 96) (type "* ? {}")))
	(expressions
