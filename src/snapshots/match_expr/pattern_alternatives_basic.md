...
Newline(1:1-1:1),
UpperIdent(3:1-3:6),OpColon(3:7-3:8),OpenSquare(3:9-3:10),UpperIdent(3:10-3:13),Comma(3:13-3:14),UpperIdent(3:15-3:20),Comma(3:20-3:21),UpperIdent(3:22-3:26),Comma(3:26-3:27),UpperIdent(3:28-3:34),Comma(3:34-3:35),UpperIdent(3:36-3:42),Comma(3:42-3:43),UpperIdent(3:44-3:50),CloseSquare(3:50-3:51),Newline(1:1-1:1),
Newline(1:1-1:1),
LowerIdent(5:1-5:5),OpColon(5:6-5:7),UpperIdent(5:8-5:13),OpArrow(5:14-5:16),UpperIdent(5:17-5:20),Newline(1:1-1:1),
LowerIdent(6:1-6:5),OpAssign(6:6-6:7),OpBar(6:8-6:9),LowerIdent(6:9-6:14),OpBar(6:14-6:15),KwMatch(6:16-6:21),LowerIdent(6:22-6:27),OpenCurly(6:28-6:29),Newline(1:1-1:1),
UpperIdent(7:5-7:8),OpBar(7:9-7:10),UpperIdent(7:11-7:16),OpBar(7:17-7:18),UpperIdent(7:19-7:23),OpFatArrow(7:24-7:26),StringStart(7:27-7:28),StringPart(7:28-7:35),StringEnd(7:35-7:36),Newline(1:1-1:1),
UpperIdent(8:5-8:11),OpBar(8:12-8:13),UpperIdent(8:14-8:20),OpBar(8:21-8:22),UpperIdent(8:23-8:29),OpFatArrow(8:30-8:32),StringStart(8:33-8:34),StringPart(8:34-8:43),StringEnd(8:43-8:44),Newline(1:1-1:1),
