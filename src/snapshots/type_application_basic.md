...
~~~
# EXPECTED
UNEXPECTED TOKEN IN EXPRESSION - type_application_basic.md:7:1:7:3
UNEXPECTED TOKEN IN EXPRESSION - type_application_basic.md:7:2:7:4
UNEXPECTED TOKEN IN EXPRESSION - type_application_basic.md:7:3:7:4
# PROBLEMS
...
**type_application_basic.md:7:1:7:3:**
```roc
~~~
```
^^
...
Here is the problematic code:
**type_application_basic.md:7:2:7:4:**
```roc
~~~
```
 ^^
...
Here is the problematic code:
**type_application_basic.md:7:3:7:4:**
```roc
~~~
```
  ^
