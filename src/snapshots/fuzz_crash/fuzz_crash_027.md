...
(can-ir
	...
	(d-let
		...
		(annotation @48.1-48.8
			(declared-type
				(ty-func @47.11-47.21 (effectful false)
					(ty-type @47.11-47.14 (name "U64"))
					(ty-type @47.18-47.21 (name "U64"))))))
	(d-let
	...
	(d-let
		...
		(annotation @100.1-100.6
			(declared-type
				(ty-func @99.9-99.38 (effectful false)
					(ty-apply @99.9-99.21 (symbol "List")
						(ty-type @99.14-99.20 (name "String")))
	...
	(s-alias-decl @16.1-24.15
		...
		(ty-func @21.3-24.15 (effectful false)
			(ty-apply @21.3-22.4 (symbol "List"))
			(ty-parens @23.3-23.11
				(ty-func @23.4-23.10 (effectful false)
	...
	(s-alias-decl @26.1-26.17
		...
		(ty-tuple @26.7-26.17
			(ty-type @26.8-26.11 (name "Bar"))
			(ty-type @26.13-26.16 (name "Baz"))))
	...
	(s-alias-decl @43.1-43.34
		...
		(ty-func @43.11-43.34 (effectful false)
...
(inferred-types
	(defs
		(patt @45.1-47.8 (type "Bool -> Num(*)"))
		(patt @48.1-58.2 (type "Error -> U64"))
		(patt @60.1-94.3 (type "Error"))
		(patt @100.1-159.2 (type "Error -> Error")))
	(type_decls
