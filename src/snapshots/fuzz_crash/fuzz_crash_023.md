...
(can-ir
	...
	(d-let (id 422)
		...
		(e-lambda @144.9-196.2 (id 415)
			...
			(e-block @144.13-196.2
				...
				(s-let @188.2-189.23
					(p-assign @188.2-188.15 (ident "bin_op_result") (id 352))
					(e-binop @188.18-189.23 (op "or") (id 382)
						(e-binop @188.18-188.74 (op "or")
				...
				(s-let @189.2-190.8
					(p-assign @189.2-189.23 (ident "static_dispatch_style") (id 384))
					(e-dot-access @189.26-190.8 (field "unknown") (id 389)
						(receiver
				...
				(e-call @191.2-195.3
					(e-lookup-external
						(ext-decl @191.2-191.14 (qualified "pf.Stdout.line!") (module "pf.Stdout") (local "line!") (kind "value") (type-var 394)))
					(e-string @192.3-194.18
		...
		(annotation @144.1-144.6 (signature 420) (id 421)
			(declared-type
	...
	(d-let (id 430)
		(p-assign @199.1-199.6 (ident "empty") (id 424))
		(e-empty_record @199.9-199.11 (id 425))
		(annotation @199.1-199.6 (signature 428) (id 429)
			(declared-type
				(ty-record @198.9-198.11))))
...
(inferred-types
	(defs
		...
		(d_assign (name "main!") (def_var 422) (type "List -> Result"))
		(d_assign (name "empty") (def_var 430) (type "{  }")))
	(expressions
