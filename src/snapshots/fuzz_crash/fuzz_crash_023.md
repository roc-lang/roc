			...
			(e-lambda @144.9-196.2
				...
				(e-block @144.13-196.2
					(statements
						...
						(s-type-anno @178.47-179.7 (name "qux")
							(ty-malformed @178.52-179.7 (tag "expected_arrow")))
						(s-decl @179.2-179.68
	...
	(d-let
		...
		(e-lambda @144.9-196.2
			...
			(e-block @144.13-196.2
				...
				(s-crash @162.2-164.18 (msg "Unreachable!"))
				(s-let @164.2-164.31
