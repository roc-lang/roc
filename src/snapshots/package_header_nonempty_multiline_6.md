...
**EXPOSED BUT NOT DEFINED**
The module header says that `ecode` is exposed, but it is not defined anywhere in this module.
...
```
  ^^^^^^^^
You can fix this by either defining `ecode` in this module, or by removing it from the list of exposed values.
	...
	(package @1.1-9.3
		(exposes @2.2-5.3
			(exposed-lower-ident @3.3-3.12
				(text "Bool"))
			(exposed-upper-ident @4.3-4.11 (text "ecode")))
		(packages @6.2-9.3
