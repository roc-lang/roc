...
(can-ir
	...
	(d-let (id 137)
		...
		(e-call @17-15-17-28 (id 136)
			(e-lookup-local @17-15-17-24
				(pattern (id 91)))
			(e-int @17-25-17-27 (value "42"))))
	(d-let (id 144)
		(p-assign @18-5-18-12 (ident "result3") (id 138))
		(e-call @18-15-18-34 (id 143)
...
(inferred-types
	(defs
		...
		(d_assign (name "result2") (def_var 137) (type "*"))
		(d_assign (name "result3") (def_var 144) (type "*")))
	(expressions
