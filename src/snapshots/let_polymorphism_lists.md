...
(inferred-types
	(defs
		(patt @4.1-4.14 (type "List(a)"))
		(patt @7.1-7.9 (type "List(Num(a))"))
		(patt @8.1-8.9 (type "List(Str)"))
		(patt @9.1-9.11 (type "List(Frac(a))"))
		(patt @12.1-12.13 (type "a"))
		(patt @13.1-13.13 (type "a"))
		(patt @14.1-14.15 (type "a"))
		(patt @17.1-17.10 (type "a -> List(b)"))
		(patt @20.1-20.15 (type "List(a)"))
		(patt @21.1-21.15 (type "List(a)"))
		(patt @23.1-23.5 (type "a -> b")))
	(expressions
		(expr @4.17-4.19 (type "List(a)"))
		(expr @7.12-7.21 (type "List(Num(a))"))
		(expr @8.12-8.30 (type "List(Str)"))
		(expr @9.14-9.29 (type "List(Frac(a))"))
