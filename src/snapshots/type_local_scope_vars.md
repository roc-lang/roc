...
~~~
# EXPECTED
UNEXPECTED TOKEN IN EXPRESSION - type_local_scope_vars.md:12:1:12:3
UNEXPECTED TOKEN IN EXPRESSION - type_local_scope_vars.md:12:2:12:4
UNEXPECTED TOKEN IN EXPRESSION - type_local_scope_vars.md:12:3:12:4
# PROBLEMS
...
**type_local_scope_vars.md:12:1:12:3:**
```roc
~~~
```
^^
...
Here is the problematic code:
**type_local_scope_vars.md:12:2:12:4:**
```roc
~~~
```
 ^^
...
Here is the problematic code:
**type_local_scope_vars.md:12:3:12:4:**
```roc
~~~
```
  ^
