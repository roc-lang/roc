...
(e-block @1-1-19-2 (id 188)
	...
	(s-let @4-5-4-11
		...
		(e-int @4-9-4-11 (num-var 80) (sign-needed "false") (bits-needed "7") (value "10") (id 80)))
	(s-let @5-5-5-11
		(p-assign @5-5-5-6 (ident "y") (id 82))
		(e-int @5-9-5-11 (num-var 85) (sign-needed "false") (bits-needed "7") (value "20") (id 85)))
	(s-let @6-5-6-11
		(p-assign @6-5-6-6 (ident "z") (id 87))
		(e-int @6-9-6-11 (num-var 90) (sign-needed "false") (bits-needed "7") (value "30") (id 90)))
	(s-let @9-2-9-12
		(p-assign @9-2-9-7 (ident "empty") (id 92))
		(e-tuple @9-10-9-12 (tuple-var 93) (id 94)
			(elems)))
	(s-let @10-2-10-15
		(p-assign @10-2-10-8 (ident "single") (id 96))
		(e-tuple @10-11-10-15 (tuple-var 100) (id 101)
			(elems
				(e-int @10-12-10-14 (num-var 99) (sign-needed "false") (bits-needed "7") (value "42")))))
	(s-let @11-2-11-15
		(p-assign @11-2-11-6 (ident "pair") (id 103))
		(e-tuple @11-9-11-15 (tuple-var 110) (id 111)
			(elems
				(e-int @11-10-11-11 (num-var 106) (sign-needed "false") (bits-needed "7") (value "1"))
				(e-int @11-13-11-14 (num-var 109) (sign-needed "false") (bits-needed "7") (value "2")))))
	(s-let @12-2-12-29
		(p-assign @12-2-12-8 (ident "triple") (id 113))
		(e-tuple @12-11-12-29 (tuple-var 121) (id 122)
			(elems
				(e-int @12-12-12-13 (num-var 116) (sign-needed "false") (bits-needed "7") (value "1"))
				(e-string @12-15-12-22
					(e-literal @12-16-12-21 (string "hello")))
				(e-tag @12-24-12-28 (ext-var 0) (name "True") (args "TODO")))))
	(s-let @13-2-13-27
		(p-assign @13-2-13-8 (ident "nested") (id 124))
		(e-tuple @13-11-13-27 (tuple-var 141) (id 142)
			(elems
				(e-tuple @13-12-13-18 (tuple-var 131)
					(elems
						(e-int @13-13-13-14 (num-var 127) (sign-needed "false") (bits-needed "7") (value "1"))
						(e-int @13-16-13-17 (num-var 130) (sign-needed "false") (bits-needed "7") (value "2"))))
				(e-tuple @13-20-13-26 (tuple-var 139)
					(elems
						(e-int @13-21-13-22 (num-var 135) (sign-needed "false") (bits-needed "7") (value "3"))
						(e-int @13-24-13-25 (num-var 138) (sign-needed "false") (bits-needed "7") (value "4")))))))
	(s-let @14-2-14-42
		(p-assign @14-2-14-7 (ident "mixed") (id 144))
		(e-tuple @14-10-14-42 (tuple-var 163) (id 164)
			(elems
				(e-call @14-11-14-21
					(e-lookup-local @14-11-14-18
						(pattern (id 72)))
					(e-int @14-19-14-20 (num-var 148) (sign-needed "false") (bits-needed "7") (value "5")))
				(e-string @14-23-14-30
					(e-literal @14-24-14-29 (string "world")))
				(e-list @14-32-14-41 (elem-var 161)
					(elems
						(e-int @14-33-14-34 (num-var 154) (sign-needed "false") (bits-needed "7") (value "1"))
						(e-int @14-36-14-37 (num-var 157) (sign-needed "false") (bits-needed "7") (value "2"))
						(e-int @14-39-14-40 (num-var 160) (sign-needed "false") (bits-needed "7") (value "3")))))))
	(s-let @15-2-15-23
		(p-assign @15-2-15-11 (ident "with_vars") (id 166))
		(e-tuple @15-14-15-23 (tuple-var 170) (id 171)
			(elems
				...
				(e-lookup-local @15-21-15-22
					(pattern (id 87))))))
	(s-let @16-2-16-31
		(p-assign @16-2-16-13 (ident "with_lambda") (id 173))
		(e-tuple @16-16-16-31 (tuple-var 184) (id 185)
			(elems
				(e-lambda @16-17-16-27
					(args
						(p-assign @16-18-16-19 (ident "n") (id 174)))
					(e-binop @16-21-16-27 (op "add")
						(e-lookup-local @16-21-16-22
							(pattern (id 174)))
						(e-int @16-25-16-26 (num-var 178) (sign-needed "false") (bits-needed "7") (value "1"))))
				(e-int @16-28-16-30 (num-var 183) (sign-needed "false") (bits-needed "7") (value "42")))))
