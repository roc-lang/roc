...
pub const Interpreter = struct {
    ...
    /// refcount operations, refcount-presence queries, and value
    /// materialization into evaluation-arena storage.
    const BoxyFrameHooks = struct {
        ...
        pub fn resolveDescRef(self: BoxyFrameHooks, desc_ref: LIR.BoxyDescRef) Error!*const LirProgram.BoxyTypeDesc {
            return self.interp.resolveBoxyDescRef(self.frame, desc_ref);
        }
        ...
        pub fn traceProcId(self: BoxyFrameHooks) u32 {
            return @intFromEnum(self.frame.proc_id);
        }
    };
