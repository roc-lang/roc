            ...
            .e_low_level_lambda => |ll| {
                ...
                if (value.ptr) |ptr| {
                    ...
                    header.* = .{
                        ...
                        .params = can.CIR.Pattern.Span{ .span = .{ .start = 0, .len = 0 } }, // Will be set when called
                        .captures_pattern_idx = @enumFromInt(@intFromEnum(ll.low_level)), // Encode the low-level variant here
                        .captures_layout_idx = closure_layout.data.closure.captures_layout_idx,
                        .lambda_expr_idx = expr_idx,
                        .source_env = self.env,
                    };
