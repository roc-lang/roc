        ...
        while (true) {
            ...
            switch (stmt) {
                ...
                .assign_call_dict => |assign| {
                    ...
                    for (arg_locals, 0..) |local, arg_index| {
                        call_args[arg_index] = .{
