...
pub const tests = [_]TestCase{
    ...
    .{ .name = "comptime float bits - F32 atan2 negative zero", .source_kind = .module, .source = "main : F32\nmain = F32.atan2({ x: 0.0, y: F32.from_bits(2147483648) })", .expected = .{ .comptime_f32_bits = 0x80000000 } },
    .{ .name = "comptime float bits - F32 atan2 negative x zero", .source_kind = .module, .source = "main : F32\nmain = F32.atan2({ x: F32.from_bits(2147483648), y: 0.0 })", .expected = .{ .comptime_f32_bits = 0x40490fdb } },
    .{ .name = "comptime float bits - F32 atan2 finite", .source_kind = .module, .source = "main : F32\nmain = F32.atan2({ x: 1.0, y: 1.0 })", .expected = .{ .comptime_f32_bits = 0x3f490fdb } },
    .{ .name = "comptime float bits - F32 atan2 NaN", .source_kind = .module, .source = "main : F32\nmain = F32.atan2({ x: F32.nan, y: 0.0 })", .expected = .{ .comptime_f32_bits = 0x7fc00000 } },
    .{ .name = "comptime float bits - F64 atan2 negative zero", .source_kind = .module, .source = "main : F64\nmain = F64.atan2({ x: 0.0, y: F64.from_bits(9223372036854775808) })", .expected = .{ .comptime_f64_bits = 0x8000000000000000 } },
    .{ .name = "comptime float bits - F64 atan2 negative x zero", .source_kind = .module, .source = "main : F64\nmain = F64.atan2({ x: F64.from_bits(9223372036854775808), y: 0.0 })", .expected = .{ .comptime_f64_bits = 0x400921fb54442d18 } },
    .{ .name = "comptime float bits - F64 atan2 finite", .source_kind = .module, .source = "main : F64\nmain = F64.atan2({ x: 1.0, y: 1.0 })", .expected = .{ .comptime_f64_bits = 0x3fe921fb54442d18 } },
    .{ .name = "comptime float bits - F64 atan2 NaN", .source_kind = .module, .source = "main : F64\nmain = F64.atan2({ x: F64.nan, y: 0.0 })", .expected = .{ .comptime_f64_bits = 0x7ff8000000000000 } },
