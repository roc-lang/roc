...
pub const ComptimeEvaluator = struct {
    ...
    fn evalDecl(self: *ComptimeEvaluator, def_idx: CIR.Def.Idx) !EvalResult {
        ...
        const is_lambda = switch (expr) {
            ...
            .e_num, .e_frac_f32, .e_frac_f64, .e_dec, .e_dec_small, .e_typed_int, .e_typed_frac, .e_str_segment, .e_str, .e_lookup_local, .e_lookup_external, .e_lookup_pending, .e_list, .e_empty_list, .e_tuple, .e_match, .e_if, .e_call, .e_record, .e_empty_record, .e_block, .e_tag, .e_nominal, .e_nominal_external, .e_zero_argument_tag, .e_binop, .e_unary_minus, .e_unary_not, .e_dot_access, .e_tuple_access, .e_crash, .e_dbg, .e_expect, .e_ellipsis, .e_return, .e_type_var_dispatch, .e_for, .e_hosted_lambda, .e_run_low_level => false,
        };
