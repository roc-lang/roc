...
pub const CommonMisspellings = struct {
    ...
    pub const identifiers = std.StaticStringMap([]const u8).initComptime(.{
        ...
        .{ "trait", "Roc doesn't have a `trait` keyword. Docs for nominal types can be found at <https://www.roc-lang.org/docs>" },
        .{ "impl", "Roc doesn't have an `impl` keyword. Docs for nominal types can be found at <https://www.roc-lang.org/docs>" },
        ...
        .{ "interface", "Roc doesn't have an `interface` keyword. Docs for nominal types can be found at <https://www.roc-lang.org/docs>" },
