...
pub fn parseDiagnosticToReport(self: *AST, env: *const CommonEnv, diagnostic: Diagnostic, allocator: std.mem.Allocator, filename: []const u8) !reporting.Report {
    ...
    const title = switch (diagnostic.tag) {
        ...
        .expected_package_or_platform_name, .expected_package_or_platform_colon, .expected_package_or_platform_string, .expected_package_platform_close_curly, .expected_package_platform_open_curly, .expected_platform_name_end, .expected_platform_name_start, .expected_platform_name_string, .expected_platform_string, .expected_provides, .expected_provides_open_square, .expected_provides_close_curly, .expected_provides_open_curly, .expected_requires, .expected_requires_rigids_open_curly, .expected_requires_signatures_close_curly, .expected_for_clause_close_square, .expected_for_clause_alias_name, .expected_for_clause_colon, .expected_for_clause_rigid_name, .expected_for_keyword, .expected_for_clause_entrypoint_name, .expected_for_clause_type_colon, .header_expected_open_square, .header_expected_close_square, .bad_as_pattern_name, .statement_unexpected_token, .string_expected_close_interpolation, .string_unclosed, .expr_no_space_dot_int, .import_exposing_no_open, .import_exposing_no_close, .expected_type_field_name, .expected_colon_after_type_field_name, .expected_arrow, .multi_arrow_needs_parens, .expected_ty_close_curly_or_comma, .expected_ty_close_square_or_comma, .expected_lower_name_after_exposed_item_as, .expected_upper_name_after_exposed_item_as, .exposed_item_unexpected_token, .expected_upper_name_after_import_as, .expected_colon_after_type_annotation, .expected_lower_ident_pat_field_name, .expected_colon_after_pat_field_name, .expected_expr_bar, .expected_expr_close_curly_or_comma, .expected_expr_close_round_or_comma, .expected_close_curly_at_end_of_match, .expected_open_curly_after_match, .expected_expr_record_field_name, .expected_ty_apply_close_round, .expected_expr_apply_close_round, .invalid_type_arg, .expr_arrow_expects_ident, .var_only_allowed_in_a_body, .var_must_have_ident, .var_expected_equals, .var_type_anno_needs_var_keyword, .for_expected_in, .match_branch_wrong_arrow, .match_branch_missing_arrow, .match_has_no_branches, .expected_ty_anno_close_round, .expected_ty_anno_close_round_or_comma, .expected_expr_comma, .expected_expr_close_curly, .expr_dot_suffix_not_allowed, .incomplete_import, .expected_targets_colon, .expected_targets_open_curly, .expected_targets_close_curly, .expected_targets_field_name, .expected_targets_field_colon, .expected_target_link_open_curly, .expected_target_link_close_curly, .expected_target_name, .expected_target_colon, .expected_target_files_open_square, .expected_target_files_close_square, .expected_target_file, .expected_target_file_string_end => "PARSE ERROR",
    };
    ...
    switch (diagnostic.tag) {
        ...
        .expected_package_or_platform_name, .expected_package_or_platform_colon, .expected_package_or_platform_string, .expected_package_platform_close_curly, .expected_package_platform_open_curly, .expected_platform_name_end, .expected_platform_name_start, .expected_platform_name_string, .expected_platform_string, .expected_provides, .expected_provides_open_square, .expected_provides_close_curly, .expected_provides_open_curly, .expected_requires, .expected_requires_rigids_open_curly, .expected_requires_signatures_close_curly, .expected_for_clause_close_square, .expected_for_clause_alias_name, .expected_for_clause_colon, .expected_for_clause_rigid_name, .expected_for_keyword, .expected_for_clause_entrypoint_name, .expected_for_clause_type_colon, .header_expected_open_square, .header_expected_close_square, .bad_as_pattern_name, .statement_unexpected_token, .string_expected_close_interpolation, .string_unclosed, .expr_no_space_dot_int, .import_exposing_no_open, .import_exposing_no_close, .expected_type_field_name, .expected_colon_after_type_field_name, .expected_arrow, .expected_ty_close_curly_or_comma, .expected_ty_close_square_or_comma, .expected_lower_name_after_exposed_item_as, .expected_upper_name_after_exposed_item_as, .exposed_item_unexpected_token, .expected_upper_name_after_import_as, .expected_lower_ident_pat_field_name, .expected_colon_after_pat_field_name, .expected_expr_bar, .expected_expr_close_curly_or_comma, .expected_expr_close_round_or_comma, .expected_close_curly_at_end_of_match, .expected_open_curly_after_match, .expected_expr_record_field_name, .expected_ty_apply_close_round, .expected_expr_apply_close_round, .invalid_type_arg, .expr_arrow_expects_ident, .var_only_allowed_in_a_body, .var_must_have_ident, .var_expected_equals, .var_type_anno_needs_var_keyword, .for_expected_in, .match_branch_missing_arrow, .expected_ty_anno_close_round, .expected_ty_anno_close_round_or_comma, .expected_expr_comma, .expected_expr_close_curly, .expr_dot_suffix_not_allowed, .incomplete_import, .expected_targets_colon, .expected_targets_open_curly, .expected_targets_close_curly, .expected_targets_field_name, .expected_targets_field_colon, .expected_target_link_open_curly, .expected_target_link_close_curly, .expected_target_name, .expected_target_colon, .expected_target_files_open_square, .expected_target_files_close_square, .expected_target_file, .expected_target_file_string_end => {
