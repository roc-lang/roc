...
fn parseReport(ctx: ParseReportContext) Allocator.Error!reporting.Report {
    return switch (ctx.tag) {
        ...
        .expected_expr_apply_close_round => reportParseProblem(ctx, "Expected Call Argument End", "I was parsing function or method call arguments, and I expected `,` or `)`.", "Function call arguments go inside parentheses and are separated with commas.", .{ .example = "add(1, 2)" }),
