...
//! Should always be inserted and fetched from a Self Store.
//!
//! The Tag represents what type of Self it is, and
...
pub const List = collections.SafeMultiList(Self);
...
/// Unstructured information about a Self.  These
/// can actually point to either Tokens or other Selfs,
/// or represent lengths or be packed structs with more
/// densely represented information.
///
/// The conventions should be documented for each Self
/// Tag.
