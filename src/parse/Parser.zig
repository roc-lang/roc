    ...
    expr_kernel: switch (switch (root) {
        ...
        .type_complete => {
            ...
            if (open_syntax.peekType()) |kind| {
                ...
                if (kind == .statement_type_after_anno) {
                ...
                if (kind == .statement_type_decl_anno) {
        ...
        .pattern_complete => {
            ...
            if (open_syntax.peekPattern()) |kind| {
                ...
                if (kind == .statement_destructure_pattern) {
