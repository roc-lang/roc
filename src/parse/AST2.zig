...
const NodeStore = @import("NodeStore2.zig");
...
/// Returns whether this Self has any diagnostic errors.
...
pub fn calcRegionInfo(self: *Self, region: TokenizedRegion, line_starts: []const u32) base.RegionInfo {
...
pub fn appendRegionInfoToSexprTree(self: *const Self, env: *const CommonEnv, tree: *SExprTree, region: TokenizedRegion) std.mem.Allocator.Error!void {
    const start = self.tokens.resolve(region.start);
...
pub fn tokenizeDiagnosticToReport(self: *Self, diagnostic: tokenize.Diagnostic, allocator: std.mem.Allocator) !reporting.Report {
...
pub fn tokenizedRegionToRegion(self: *Self, tokenized_region: TokenizedRegion) base.Region {
...
fn getTokenText(self: *Self, token_idx: Token.Idx) []const u8 {
...
pub fn parseDiagnosticToReport(self: *Self, env: *const CommonEnv, diagnostic: Diagnostic, allocator: std.mem.Allocator, filename: []const u8) !reporting.Report {
...
pub fn resolve(self: *const Self, token: Token.Idx) []const u8 {
...
/// Helper function to convert the Self to a human friendly representation in S-expression format
...
pub const Statement = union(enum) {
    ...
    pub fn pushToSExprTree(self: @This(), gpa: std.mem.Allocator, env: *const CommonEnv, ast: *const Self, tree: *SExprTree) std.mem.Allocator.Error!void {
        switch (self) {
            .decl => |decl| {
                const begin = tree.beginNode();
...
pub const BinOp = struct {
    ...
    pub fn pushToSExprTree(self: *const @This(), gpa: std.mem.Allocator, env: *const CommonEnv, ast: *const Self, tree: *SExprTree) std.mem.Allocator.Error!void {
        const begin = tree.beginNode();
