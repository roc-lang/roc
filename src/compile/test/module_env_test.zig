...
test "ModuleEnv.Serialized roundtrip" {
    ...
    try testing.expectEqual(@as(u32, 119), original.common.idents.interner.entry_count);
    ...
    try testing.expectEqual(@as(u32, 119), env.common.idents.interner.entry_count);
