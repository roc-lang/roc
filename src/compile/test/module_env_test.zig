...
test "ModuleEnv.Serialized roundtrip" {
    ...
    // plus Str.find_first for allocation-free slicing searches.
    try testing.expectEqual(@as(u32, 93), original.common.idents.interner.entry_count);
