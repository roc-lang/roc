...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x46, 0xBD, 0x11, 0x84, 0x3E, 0x35, 0x66, 0x94, 0xB5, 0x29, 0xCA, 0xC9, 0xDC, 0x3F, 0x17, 0x85,
        0xCA, 0xA1, 0xFC, 0xB3, 0x2D, 0xF3, 0xA3, 0xFC, 0x93, 0xE3, 0x02, 0xCD, 0xD9, 0x40, 0x63, 0x85,
    };
