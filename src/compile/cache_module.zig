...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xDC, 0x1A, 0x00, 0x9D, 0x93, 0x22, 0xF9, 0x7F, 0xF8, 0xC8, 0x9A, 0x78, 0xF6, 0x51, 0xE0, 0x4F,
        0x10, 0x5C, 0xED, 0xAF, 0xD6, 0xBC, 0x0F, 0xF7, 0x22, 0x7D, 0x16, 0x25, 0xE0, 0xCC, 0x94, 0xC7,
    };
