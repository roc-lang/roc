...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x2B, 0xB3, 0x52, 0x3E, 0xB5, 0xFD, 0x5D, 0xC2, 0xB5, 0xFB, 0xB6, 0xD0, 0x62, 0xEE, 0xF1, 0xF5,
        0x5F, 0xCF, 0x75, 0x9C, 0x97, 0x37, 0xC9, 0x68, 0x8B, 0x41, 0xDF, 0xAC, 0xE4, 0x94, 0x80, 0x9F,
    };
