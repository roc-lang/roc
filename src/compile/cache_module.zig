...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xD0, 0x43, 0x08, 0x56, 0x04, 0xC4, 0xF6, 0x29, 0x48, 0x73, 0x90, 0xB1, 0x99, 0xD0, 0x62, 0xEB,
        0x7B, 0xF9, 0x8F, 0x12, 0xCD, 0x67, 0x56, 0xCA, 0x32, 0x9D, 0x00, 0xC2, 0xF0, 0x48, 0xDB, 0x7C,
    };
