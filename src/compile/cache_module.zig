...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x09, 0x55, 0x6B, 0x0C, 0x4F, 0x34, 0x81, 0xC0, 0x92, 0xFE, 0xD3, 0x69, 0xC9, 0x49, 0xB2, 0x1E,
        0x16, 0x02, 0xD7, 0x2B, 0x17, 0xC2, 0x4B, 0xDE, 0xD1, 0x17, 0x7B, 0xFD, 0xBE, 0x13, 0x6A, 0x57,
    };
