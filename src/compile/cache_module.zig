...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x32, 0xDE, 0xE6, 0x2A, 0x1F, 0x2C, 0x24, 0x56, 0x40, 0x8C, 0xAE, 0xB3, 0xBD, 0x4C, 0x45, 0x5B,
        0x04, 0x79, 0xD7, 0x00, 0x06, 0xF2, 0xFF, 0xD1, 0x52, 0x86, 0xC1, 0xDD, 0x5B, 0xA5, 0x5C, 0x9A,
    };
