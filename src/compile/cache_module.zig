...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xE8, 0x44, 0x58, 0x40, 0xDF, 0x50, 0x56, 0xEF, 0x41, 0xC9, 0x1B, 0x49, 0x24, 0x26, 0xB9, 0x0F,
        0x1D, 0x64, 0x8F, 0xCA, 0x3F, 0x26, 0xCC, 0x44, 0xB9, 0xAA, 0x77, 0x30, 0x81, 0x80, 0xCC, 0xC0,
    };
