...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xD4, 0x13, 0x99, 0xF9, 0x3C, 0x68, 0xB3, 0x04, 0x29, 0xDD, 0x97, 0xE6, 0x15, 0x39, 0x02, 0x5A,
        0xF0, 0xD5, 0x1E, 0x76, 0xF0, 0x7E, 0xF4, 0xEB, 0xCD, 0x5D, 0xAB, 0x80, 0x6F, 0x8A, 0xF9, 0xFC,
    };
