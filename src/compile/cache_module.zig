...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x44, 0x60, 0x4C, 0x3C, 0x20, 0xC7, 0xF8, 0xCF, 0x40, 0x61, 0xCA, 0x4F, 0xB9, 0x24, 0xBD, 0x9D,
        0x00, 0xCB, 0xE4, 0xBE, 0x81, 0x7C, 0x6F, 0x48, 0x19, 0xB6, 0x4A, 0xE7, 0x89, 0x4C, 0x95, 0x8B,
    };
