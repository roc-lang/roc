...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x4C, 0x5A, 0x17, 0x5F, 0xDE, 0xC5, 0xB8, 0xAD, 0xE1, 0xAA, 0x25, 0x7A, 0x1A, 0x43, 0x3E, 0xD1,
        0x9E, 0x79, 0xCD, 0xC8, 0x84, 0xFA, 0xBC, 0xF0, 0x4F, 0xDF, 0x2C, 0x71, 0xBD, 0x92, 0xBB, 0x6F,
    };
