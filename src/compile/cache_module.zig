...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x86, 0xC0, 0x06, 0x35, 0x0F, 0x0B, 0xCE, 0x76, 0x02, 0x6D, 0x1F, 0x54, 0x44, 0x50, 0x3B, 0x32,
        0x96, 0x1F, 0x26, 0x63, 0xD6, 0xDC, 0x98, 0xCD, 0x55, 0x12, 0xCC, 0xAE, 0xC7, 0x57, 0xCA, 0x8E,
    };
