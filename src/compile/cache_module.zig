...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xBD, 0x54, 0x81, 0x6F, 0xF5, 0x70, 0x9A, 0xE3, 0xCE, 0xC1, 0xEF, 0xBE, 0x2C, 0xE1, 0x11, 0xAA,
        0x44, 0x51, 0x43, 0xE0, 0x58, 0xE3, 0x2B, 0x5B, 0x3F, 0xB4, 0x7D, 0xD7, 0xC8, 0xB1, 0xCD, 0xA2,
    };
