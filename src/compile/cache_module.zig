...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x66, 0xC2, 0x5C, 0x64, 0x29, 0x10, 0x4A, 0x5E, 0xD0, 0xC0, 0xAE, 0x31, 0x01, 0x14, 0xF1, 0x2B,
        0xC5, 0xC1, 0xF0, 0x87, 0x1A, 0xBC, 0x4E, 0x5F, 0x25, 0xB4, 0x0F, 0x78, 0xAE, 0xC2, 0x42, 0x8F,
    };
