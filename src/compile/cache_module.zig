...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xA2, 0x0C, 0x1B, 0xCF, 0x0D, 0x0D, 0x9C, 0x5B, 0xDD, 0x8C, 0x8D, 0xA4, 0x76, 0xF9, 0x4F, 0x31,
        0x44, 0x19, 0x6A, 0xB3, 0x2B, 0xCC, 0xEF, 0x52, 0x4B, 0xBB, 0x90, 0x76, 0x50, 0x6D, 0xDA, 0xA9,
    };
