...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xEE, 0xFD, 0x19, 0xBF, 0xC6, 0xB2, 0x92, 0x31, 0x4A, 0xE8, 0xAE, 0xAD, 0xE4, 0x1F, 0xC8, 0x02,
        0xF3, 0x8A, 0x0F, 0xB4, 0x0B, 0xC2, 0xF5, 0xAF, 0x97, 0xE7, 0x62, 0xCB, 0x90, 0x1A, 0xBE, 0xFF,
    };
