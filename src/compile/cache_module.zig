...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xB8, 0x6B, 0x27, 0x8B, 0xED, 0xF6, 0xC3, 0x8F, 0xC8, 0x81, 0xBE, 0x11, 0x8C, 0x96, 0x6C, 0x16,
        0x32, 0x2B, 0x06, 0x32, 0x49, 0x20, 0xB3, 0xDD, 0x60, 0x25, 0xC1, 0xC4, 0x36, 0xFC, 0x6A, 0x5F,
    };
