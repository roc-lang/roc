...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x1B, 0x80, 0x3C, 0x4E, 0x81, 0xD4, 0x45, 0xC0, 0xB2, 0xA3, 0x19, 0x8B, 0xDE, 0xF8, 0x22, 0xF2,
        0xD2, 0x24, 0xA4, 0x72, 0x1E, 0xC0, 0x24, 0x3E, 0xDB, 0xCD, 0x6F, 0xBD, 0x3D, 0x01, 0x05, 0xC4,
    };
