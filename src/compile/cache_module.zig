...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x76, 0x52, 0x73, 0x8F, 0x9D, 0xA5, 0x8E, 0x24, 0x20, 0xF1, 0xCD, 0x66, 0xE0, 0xF5, 0xAD, 0x0D,
        0x2F, 0x1D, 0x28, 0xEB, 0x90, 0x19, 0x11, 0x9C, 0x4A, 0xCE, 0xCA, 0x06, 0x87, 0xB7, 0xC0, 0x59,
    };
