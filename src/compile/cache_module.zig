...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xC3, 0xC1, 0x84, 0x6E, 0x69, 0xD3, 0xFA, 0xC5, 0xFB, 0xBE, 0xEE, 0x48, 0xF7, 0xF9, 0x57, 0x20,
        0x07, 0xAF, 0x58, 0x76, 0x0F, 0x65, 0x95, 0x72, 0x7C, 0x14, 0x90, 0x81, 0x32, 0xEB, 0xD7, 0x35,
    };
