...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x66, 0xC9, 0xAC, 0x40, 0xE8, 0xD7, 0x03, 0x04, 0x0B, 0xCA, 0x70, 0xA8, 0x8F, 0xF9, 0x43, 0x6B,
        0xB1, 0xB1, 0xB8, 0x00, 0x4A, 0xF5, 0x5A, 0x10, 0x64, 0x8A, 0x44, 0x9E, 0xFB, 0x1B, 0x8E, 0x1F,
    };
