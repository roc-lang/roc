...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x30, 0x0E, 0x28, 0xF3, 0xAE, 0xF2, 0xA9, 0xB0, 0xFA, 0x09, 0xFF, 0x6F, 0xB8, 0x9F, 0x1B, 0x8D,
        0xE1, 0x0F, 0x7C, 0x2D, 0x8B, 0x51, 0xAC, 0xB6, 0xE8, 0xD2, 0x17, 0x78, 0x6A, 0x72, 0x99, 0xA5,
    };
