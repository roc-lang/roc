...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xEB, 0xF5, 0xBE, 0xEA, 0x08, 0x13, 0xF2, 0x49, 0xFE, 0xAC, 0x6E, 0x56, 0x95, 0xC2, 0x26, 0xC1,
        0x9E, 0x3A, 0x7F, 0x8B, 0x2D, 0x8A, 0x08, 0x39, 0x0D, 0x6F, 0xF8, 0x25, 0xA6, 0xDE, 0x1A, 0x86,
    };
