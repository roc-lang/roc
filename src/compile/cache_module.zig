...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xB5, 0x00, 0x68, 0x72, 0x7F, 0xB2, 0x17, 0x82, 0xFF, 0xF1, 0x60, 0xBF, 0x19, 0x09, 0xF4, 0xC6,
        0x6B, 0xCD, 0x3B, 0x50, 0x92, 0xBD, 0x37, 0x7F, 0x6F, 0x4E, 0x4D, 0x2F, 0xC7, 0xD0, 0x4A, 0xF5,
    };
