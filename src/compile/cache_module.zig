...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xCE, 0x20, 0x29, 0x8D, 0xFA, 0x8E, 0xAF, 0x7F, 0xBD, 0xAC, 0xEF, 0x7E, 0xE8, 0x13, 0x17, 0x75,
        0x3F, 0x1A, 0x16, 0x55, 0x8D, 0x5B, 0xE9, 0xB9, 0x2E, 0x9D, 0x27, 0x74, 0xBE, 0x5F, 0xF0, 0x00,
    };
