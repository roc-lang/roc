...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x36, 0x63, 0x92, 0x13, 0xC1, 0x99, 0xEE, 0x04, 0xBF, 0x39, 0x3E, 0x5A, 0xF0, 0x56, 0xCC, 0xD1,
        0x9F, 0xDE, 0x03, 0x11, 0x50, 0xAD, 0x2A, 0x50, 0x9F, 0x14, 0x8D, 0x4E, 0xBB, 0x4D, 0x8C, 0x5E,
    };
