...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x39, 0xAE, 0x88, 0xCD, 0x59, 0x87, 0xC9, 0x2D, 0x76, 0xE8, 0xC4, 0x6D, 0xD7, 0xF0, 0x58, 0x4E,
        0x47, 0x6F, 0x60, 0x34, 0x78, 0x9F, 0x74, 0x3C, 0xFC, 0x82, 0xBE, 0xB6, 0xBE, 0xB2, 0xFF, 0xC4,
    };
