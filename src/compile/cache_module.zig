...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x97, 0xA0, 0xF6, 0x60, 0x3B, 0x12, 0xEC, 0x19, 0x26, 0x6F, 0x93, 0xA4, 0xD1, 0xE5, 0x4A, 0xC0,
        0xE6, 0xDE, 0x81, 0xDD, 0x4A, 0x39, 0xCF, 0x87, 0xCC, 0x7A, 0xBB, 0x48, 0xBC, 0xE3, 0xC2, 0x2F,
    };
