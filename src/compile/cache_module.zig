...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x7F, 0x2B, 0xFA, 0xE8, 0xDA, 0x9F, 0xCB, 0x5C, 0x26, 0xB4, 0x4F, 0x3F, 0xC4, 0x16, 0xB4, 0xBD,
        0xF3, 0xFE, 0xDE, 0xBA, 0x9D, 0x6A, 0xFA, 0xB7, 0x58, 0xCB, 0x8D, 0x7A, 0x03, 0x3A, 0x28, 0xCA,
    };
