...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xB5, 0x15, 0x6F, 0x3B, 0x56, 0x10, 0xA7, 0x74, 0x6F, 0x2C, 0xEC, 0x6A, 0x79, 0x4D, 0x0C, 0x35,
        0x29, 0x2C, 0xB1, 0xEF, 0x60, 0x95, 0xC9, 0xCB, 0x18, 0xC9, 0xED, 0xA0, 0x08, 0x82, 0xAB, 0xE2,
    };
