...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xDF, 0x87, 0x5B, 0x7C, 0xED, 0xDD, 0x33, 0x62, 0xA5, 0xB4, 0xD7, 0x5F, 0x1E, 0x5F, 0xD5, 0x9B,
        0x14, 0xF6, 0x2F, 0xA7, 0xC0, 0x24, 0xD5, 0x7F, 0xCF, 0x6E, 0x68, 0x08, 0x1C, 0x52, 0x7F, 0xCE,
    };
