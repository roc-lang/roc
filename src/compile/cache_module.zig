...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xC8, 0x1F, 0x16, 0x88, 0x9F, 0xCA, 0x83, 0x4A, 0x58, 0x52, 0x4C, 0xD8, 0x84, 0x91, 0x89, 0x4E,
        0x16, 0x9B, 0x25, 0x9F, 0xC1, 0xAB, 0x0F, 0x95, 0x3A, 0xBA, 0xFB, 0xF8, 0xDB, 0x2F, 0xA3, 0x81,
    };
