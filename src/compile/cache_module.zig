...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x7C, 0x30, 0xA2, 0x31, 0xBB, 0xD5, 0xD4, 0xE5, 0x38, 0x6A, 0x95, 0x7B, 0x6F, 0x9D, 0x1E, 0xEF,
        0x41, 0x45, 0x7D, 0xFC, 0x3A, 0x78, 0xFE, 0x94, 0xC9, 0x71, 0x01, 0xC5, 0xF5, 0xB6, 0x0C, 0x46,
    };
