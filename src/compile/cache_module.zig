...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x63, 0x1A, 0x30, 0xFB, 0x4A, 0x3A, 0xB0, 0x07, 0x30, 0x6B, 0x23, 0x61, 0xC5, 0xBE, 0x9C, 0xA8,
        0xF3, 0xDC, 0x24, 0xAE, 0x01, 0x13, 0x03, 0x6F, 0x12, 0xFB, 0x0F, 0x9C, 0x4C, 0x1B, 0x1B, 0x48,
    };
