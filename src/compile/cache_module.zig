...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xA2, 0xA4, 0xF8, 0x47, 0x05, 0xFF, 0x8B, 0xEC, 0xB8, 0x57, 0x4D, 0xB2, 0x68, 0xF8, 0x1B, 0xC7,
        0xDE, 0xA0, 0xE4, 0xC6, 0x55, 0x84, 0xB5, 0x2A, 0xF0, 0x1B, 0xCC, 0x10, 0xB2, 0x4F, 0xF7, 0x01,
    };
