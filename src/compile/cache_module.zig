...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x56, 0xD2, 0xB2, 0x42, 0x78, 0x6C, 0x5B, 0x2E, 0xEB, 0x33, 0x78, 0xE7, 0x0C, 0xEB, 0x1D, 0x6C,
        0x0D, 0x44, 0xFC, 0xBE, 0x31, 0x22, 0xEC, 0xC2, 0x5C, 0x22, 0x2F, 0x7E, 0x6C, 0x90, 0x99, 0x9E,
    };
