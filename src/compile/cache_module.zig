...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0xA1, 0x1E, 0x03, 0xE3, 0xF3, 0xB3, 0x43, 0x21, 0x9E, 0x6C, 0x03, 0x91, 0x09, 0xD7, 0x85, 0xF7,
        0x0B, 0x50, 0x08, 0xAA, 0xA5, 0xB9, 0x78, 0x5E, 0x31, 0x40, 0xC2, 0x72, 0x2F, 0xC9, 0xCF, 0x06,
    };
