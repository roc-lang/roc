...
test "MODULE_ENV_VERSION_HASH golden value" {
    ...
    const golden: [32]u8 = .{
        0x9F, 0x9D, 0x25, 0x0B, 0xB6, 0xEF, 0x48, 0xB0, 0x6E, 0xE5, 0x67, 0xE1, 0x36, 0xDE, 0x17, 0xD8,
        0x9A, 0xC2, 0x3A, 0x38, 0x91, 0x30, 0xC0, 0x9B, 0x7B, 0xC2, 0x65, 0x0A, 0xBF, 0x25, 0xF4, 0xC7,
    };
