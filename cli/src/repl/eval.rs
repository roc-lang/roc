...
use roc_mono::layout::{
    union_sorted_tags_help, union_sorted_tags_help2, Builtin, Layout, UnionLayout, UnionVariant,
};
            ...
            match content {
                Content::Structure(FlatType::TagUnion(tags, _)) => {
                    ...
                    let tags_vec: std::vec::Vec<(TagName, std::vec::Vec<Variable>)> = tags
                        .sorted_iterator(&env.subs, Variable::EMPTY_TAG_UNION)
                    ...
                    let union_variant =
                        union_sorted_tags_help2(env.arena, tags_vec, None, env.subs);
