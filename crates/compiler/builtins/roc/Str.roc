...
## Append a [U32] [Unicode scalar value](https://unicode.org/glossary/#unicode_scalar_value)
## to the given string. If the given [U32] is not a valid Unicode scalar value, returns
## `Err InvalidScalar`.
##
## ```
## expect Str.appendScalar "Who" 97 == Ok "Whoa"
## expect Str.appendScalar "Who" 'a' == Ok "Whoa"
## expect Str.appendScalar "😢" 0xabcdef == Err InvalidScalar
## ```
##
## This can be useful when parsing non-UTF8 bytes into a string.
