...
const expect_utils = @import("expect.zig");
...
comptime {
    ...
    exportUtilsFn(utils.test_expect_failed, "test_expect_failed");
    ...
    @export(expect_utils.expect_impl, .{ .name = "roc_builtins.utils." ++ "expect_impl", .linkage = .Weak });
