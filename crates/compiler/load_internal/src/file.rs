    ...
    let module_docs = {
        ...
        module_name.map(|module_name| {
            ...
            crate::docs::generate_module_docs(
                ...
                module_name.into(),
                aliases,
                module_output.rigid_variables,
                module_output.declarations,
                module_output.exposed_imports,
                exposed_module_ids,
                module_output.exposed_symbols.clone(),
                header_comments_to_doc_comment(parsed.header_comments),
            )
        })
    };
...
fn header_comments_to_doc_comment(header_comments: &[CommentOrNewline<'_>]) -> String {
    for comment in header_comments {
        if let CommentOrNewline::DocComment(str) = comment {
