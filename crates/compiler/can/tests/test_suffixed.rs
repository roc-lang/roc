    ...
    fn multi_defs_stmts() {
        run_test(
            ...
            main = 
                ...
                Task.ok {}
            "#,
            r#"Defs { tags: [Index(2147483648)], regions: [@0-125], space_before: [Slice(start = 0, length = 0)], space_after: [Slice(start = 0, length = 0)], spaces: [], type_defs: [], value_defs: [Body(@0-4 Identifier { ident: "main" }, @24-36 Apply(@24-36 Var { module_name: "Task", ident: "await" }, [@24-36 Apply(@24-36 Var { module_name: "", ident: "line" }, [@30-36 Str(PlainLine("Ahoy"))], Space), @24-36 Closure([@24-36 RecordDestructure([])], @58-80 Apply(@58-80 Var { module_name: "Task", ident: "await" }, [@58-80 Apply(@58-80 Var { module_name: "Stdout", ident: "line" }, [@58-65 Str(PlainLine("There"))], BinOp(Pizza)), @58-80 Closure([@53-55 RecordDestructure([])], @115-125 Apply(@115-122 Var { module_name: "Task", ident: "ok" }, [@123-125 Record([])], Space))], BangSuffix))], BangSuffix))] }"#,
        );
    }
    ...
    */
    ...
    fn basic() {
        ...
        main = 
            ...
            ok {}
        "#,
            r#"Defs { tags: [Index(2147483648)], regions: [@0-47], space_before: [Slice(start = 0, length = 0)], space_after: [Slice(start = 0, length = 0)], spaces: [], type_defs: [], value_defs: [Body(@0-4 Identifier { ident: "main" }, @20-24 Apply(@20-24 Var { module_name: "Task", ident: "await" }, [@20-24 Var { module_name: "", ident: "foo" }, @20-24 Closure([@20-24 RecordDestructure([])], @42-47 Apply(@42-44 Var { module_name: "", ident: "ok" }, [@45-47 Record([])], Space))], BangSuffix))] }"#,
        );
    }
    ...
    fn last_suffixed_multiple() {
        run_test(
            ...
            main = 
                ...
                baz!
            "#,
            r#"Defs { tags: [Index(2147483648)], regions: [@0-70], space_before: [Slice(start = 0, length = 0)], space_after: [Slice(start = 0, length = 0)], spaces: [], type_defs: [], value_defs: [Body(@0-4 Identifier { ident: "main" }, @24-28 Apply(@24-28 Var { module_name: "Task", ident: "await" }, [@24-28 Var { module_name: "", ident: "foo" }, @24-28 Closure([@24-28 RecordDestructure([])], @45-49 Apply(@45-49 Var { module_name: "Task", ident: "await" }, [@45-49 Var { module_name: "", ident: "bar" }, @45-49 Closure([@45-49 RecordDestructure([])], @66-70 Var { module_name: "", ident: "baz" })], BangSuffix))], BangSuffix))] }"#,
        );
    }
    ...
    fn simple_pizza() {
        run_test(
            ...
            main = 
                ...
                Task.ok {}
            "#,
            r#"Defs { tags: [Index(2147483648)], regions: [@0-130], space_before: [Slice(start = 0, length = 0)], space_after: [Slice(start = 0, length = 0)], spaces: [], type_defs: [], value_defs: [Body(@0-4 Identifier { ident: "main" }, @24-93 Apply(@24-93 Var { module_name: "Task", ident: "await" }, [@24-93 Apply(@24-93 Var { module_name: "", ident: "line" }, [@24-69 Apply(@51-61 Var { module_name: "Str", ident: "concat" }, [@24-31 Str(PlainLine("hello")), @62-69 Str(PlainLine("world"))], BinOp(Pizza))], BinOp(Pizza)), @24-93 Closure([@51-93 RecordDestructure([])], @120-130 Apply(@120-127 Var { module_name: "Task", ident: "ok" }, [@128-130 Record([])], Space))], BangSuffix))] }"#,
        );
    }
    ...
    fn multiple_suffix() {
        run_test(
            ...
            main = 
                ...
                bar
            "#,
            r##"Defs { tags: [Index(2147483648)], regions: [@0-49], space_before: [Slice(start = 0, length = 0)], space_after: [Slice(start = 0, length = 0)], spaces: [], type_defs: [], value_defs: [Body(@0-4 Identifier { ident: "main" }, @24-49 Apply(@24-49 Var { module_name: "Task", ident: "await" }, [@24-29 Var { module_name: "", ident: "foo" }, @24-49 Closure([@24-29 Identifier { ident: "#!a0" }], @24-29 Apply(@24-29 Var { module_name: "Task", ident: "await" }, [@24-29 Var { module_name: "", ident: "#!a0" }, @24-29 Closure([@24-29 RecordDestructure([])], @46-49 Var { module_name: "", ident: "bar" })], BangSuffix))], BangSuffix))] }"##,
        );
    }
    ...
    fn closure_with_defs() {
        run_test(
            ...
            main = 
                ...
                foo "bar" {} "baz"
            "#,
            r#"Defs { tags: [Index(2147483648)], regions: [@0-249], space_before: [Slice(start = 0, length = 0)], space_after: [Slice(start = 0, length = 0)], spaces: [], type_defs: [], value_defs: [Body(@0-4 Identifier { ident: "main" }, @25-249 Defs(Defs { tags: [Index(2147483648)], regions: [@81-193], space_before: [Slice(start = 0, length = 0)], space_after: [Slice(start = 0, length = 0)], spaces: [], type_defs: [], value_defs: [AnnotatedBody { ann_pattern: @25-28 Identifier { ident: "foo" }, ann_type: @31-58 Function([@31-34 Apply("", "Str", []), @36-38 Record { fields: [], ext: None }, @40-43 Apply("", "Str", [])], @47-58 Apply("", "Task", [@52-54 Record { fields: [], ext: None }, @55-58 Apply("", "I32", [])])), comment: None, body_pattern: @75-78 Identifier { ident: "foo" }, body_expr: @81-193 Closure([@82-83 Identifier { ident: "a" }, @85-86 Underscore(""), @88-89 Identifier { ident: "b" }], @114-121 Apply(@114-121 Var { module_name: "Task", ident: "await" }, [@114-121 Apply(@114-121 Var { module_name: "", ident: "line" }, [@120-121 Var { module_name: "", ident: "a" }], Space), @114-121 Closure([@114-121 RecordDestructure([])], @142-149 Apply(@142-149 Var { module_name: "Task", ident: "await" }, [@142-149 Apply(@142-149 Var { module_name: "", ident: "line" }, [@148-149 Var { module_name: "", ident: "b" }], Space), @142-149 Closure([@142-149 RecordDestructure([])], @183-193 Apply(@183-190 Var { module_name: "Task", ident: "ok" }, [@191-193 Record([])], Space))], BangSuffix))], BangSuffix)) }] }, @231-249 Apply(@231-234 Var { module_name: "", ident: "foo" }, [@235-240 Str(PlainLine("bar")), @241-243 Record([]), @244-249 Str(PlainLine("baz"))], Space)))] }"#,
        );
    }
    ...
    fn trailing_binops() {
        run_test(
            ...
            copy = \a,b ->
                ...
                |> mapErr! ERR
            "#,
            r#"Defs { tags: [Index(2147483648)], regions: [@0-103], space_before: [Slice(start = 0, length = 0)], space_after: [Slice(start = 0, length = 0)], spaces: [], type_defs: [], value_defs: [Body(@0-4 Identifier { ident: "copy" }, @7-103 Closure([@8-9 Identifier { ident: "a" }, @10-11 Identifier { ident: "b" }], @31-42 Apply(@31-42 Var { module_name: "Task", ident: "await" }, [@31-42 Apply(@31-42 Var { module_name: "", ident: "line" }, [@37-42 Str(PlainLine("FOO"))], Space), @31-42 Closure([@31-42 RecordDestructure([])], @60-103 Apply(@60-103 Var { module_name: "", ident: "mapErr" }, [@60-72 Apply(@60-67 Var { module_name: "CMD", ident: "new" }, [@68-72 Str(PlainLine("cp"))], Space), @100-103 Tag("ERR")], BinOp(Pizza)))], BangSuffix)))] }"#,
        );
    }
