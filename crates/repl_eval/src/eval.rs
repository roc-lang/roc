...
//
//     let union_variant = {
//         let mut cache = LayoutCache::new(env.target_info, interner.fork());
//         let mut layout_env =
...
//                 let content = env.subs.get_content_without_compacting(*structure);
//     let interner = GlobalInterner::with_capacity(0);
//                 let union_layout = LayoutCache::new(env.target_info, interner.fork())
...
//     let interner = GlobalInterner::with_capacity(0);
//     let mut layout_cache = LayoutCache::new(env.target_info, interner.fork());
//
