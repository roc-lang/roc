...
const _SIZE_CHECK_union_Fields: () = assert!(core::mem::size_of::<union_Fields>() == 24);
const _ALIGN_CHECK_union_Fields: () = assert!(core::mem::align_of::<union_Fields>() == 8);

const _SIZE_CHECK_Fields: () = assert!(core::mem::size_of::<Fields>() == 32);
const _ALIGN_CHECK_Fields: () = assert!(core::mem::align_of::<Fields>() == 8);
...
impl Fields {
    ...
    pub fn discriminant(&self) -> discriminant_Fields {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_Fields>(*bytes.as_ptr().add(24))
        }
    }
...
const _SIZE_CHECK_union_U1: () = assert!(core::mem::size_of::<union_U1>() == 8);
...
impl core::fmt::Debug for U1 {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        unsafe {
            match self.discriminant {
                Some => {
                    let field: &u64 = &self.payload.Some;
...
impl U1 {
    ...
    pub fn unwrap_Some(mut self) -> u64 {
...
const _SIZE_CHECK_union_SingleTagPayload: () = assert!(core::mem::size_of::<union_SingleTagPayload>() == 24);
const _ALIGN_CHECK_union_SingleTagPayload: () = assert!(core::mem::align_of::<union_SingleTagPayload>() == 8);

const _SIZE_CHECK_SingleTagPayload: () = assert!(core::mem::size_of::<SingleTagPayload>() == 32);
const _ALIGN_CHECK_SingleTagPayload: () = assert!(core::mem::align_of::<SingleTagPayload>() == 8);
...
impl SingleTagPayload {
    ...
    pub fn discriminant(&self) -> discriminant_SingleTagPayload {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_SingleTagPayload>(*bytes.as_ptr().add(24))
        }
    }
...
const _SIZE_CHECK_union_RocTagUnion: () = assert!(core::mem::size_of::<union_RocTagUnion>() == 64);
const _ALIGN_CHECK_union_RocTagUnion: () = assert!(core::mem::align_of::<union_RocTagUnion>() == 8);

const _SIZE_CHECK_RocTagUnion: () = assert!(core::mem::size_of::<RocTagUnion>() == 72);
const _ALIGN_CHECK_RocTagUnion: () = assert!(core::mem::align_of::<RocTagUnion>() == 8);
...
impl RocTagUnion {
    ...
    pub fn discriminant(&self) -> discriminant_RocTagUnion {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_RocTagUnion>(*bytes.as_ptr().add(64))
        }
    }
...
const _SIZE_CHECK_union_Type: () = assert!(core::mem::size_of::<union_Type>() == 96);
const _ALIGN_CHECK_union_Type: () = assert!(core::mem::align_of::<union_Type>() == 8);

const _SIZE_CHECK_Type: () = assert!(core::mem::size_of::<Type>() == 104);
const _ALIGN_CHECK_Type: () = assert!(core::mem::align_of::<Type>() == 8);
...
impl Type {
    ...
    pub fn discriminant(&self) -> discriminant_Type {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_Type>(*bytes.as_ptr().add(96))
        }
    }
...
impl core::fmt::Debug for Type {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        unsafe {
            match self.discriminant {
                Box => {
                    let field: &u64 = &self.payload.Box;
                ...
                List => {
                    let field: &u64 = &self.payload.List;
                ...
                RecursivePointer => {
                    let field: &u64 = &self.payload.RecursivePointer;
                ...
                Set => {
                    let field: &u64 = &self.payload.Set;
...
impl Type {
    ...
    pub fn unwrap_Box(mut self) -> u64 {
    ...
    pub fn unwrap_List(mut self) -> u64 {
    ...
    pub fn unwrap_RecursivePointer(mut self) -> u64 {
    ...
    pub fn unwrap_Set(mut self) -> u64 {
...
impl Type {
    ...
    pub fn RecursivePointer(payload: u64) -> Self {
        Self {
...
pub struct Module {
    ...
    pub entrypoints: roc_std::RocDict<roc_std::RocStr, u64>,
    pub name: roc_std::RocStr,
