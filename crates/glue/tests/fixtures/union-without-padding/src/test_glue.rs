...
impl NonRecursive {
    ...
    /// Unsafely assume this `NonRecursive` has a `.discriminant()` of `Bar` and convert it to `Bar`'s payload.
            ...
            pub unsafe fn into_Bar(self) -> i64 {
    ...
    pub fn discriminant(&self) -> discriminant_NonRecursive {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_NonRecursive>(*bytes.as_ptr().add(24))
        }
    }
    ...
    pub const Baz: Self = unsafe {
        ...
        bytes[24] = discriminant_NonRecursive::Baz as u8;
    ...
    pub fn discriminant(&self) -> discriminant_NonRecursive {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_NonRecursive>(*bytes.as_ptr().add(12))
        }
    }
    ...
    pub const Baz: Self = unsafe {
        ...
        bytes[12] = discriminant_NonRecursive::Baz as u8;
