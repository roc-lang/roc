...
use crate::llvm::build_str::{
    str_concat, str_count_graphemes, str_drop_prefix_unsafe, str_ends_with, str_from_float,
    str_from_int, str_from_utf8, str_from_utf8_range, str_join_with, str_number_of_bytes,
    str_repeat, str_split, str_starts_with, str_starts_with_code_point, str_to_utf8, str_trim,
...
fn run_low_level<'a, 'ctx, 'env>(
    ...
    match op {
        ...
        StrDropPrefixUnsafe => {
            ...
            str_drop_prefix_unsafe(env, scope, args[0], args[1])
        }
        ListLen => {
            // List.len : List * -> Int
            debug_assert_eq!(args.len(), 1);
