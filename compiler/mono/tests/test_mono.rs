...
mod test_mono {
    ...
    fn ir_plus() {
        compiles_to_ir(
            ...
            indoc!(
                r#"
                procedure Num.14 (#Attr.2, #Attr.3, #Attr.0):
    ...
    fn ir_round() {
        compiles_to_ir(
            ...
            indoc!(
                r#"
                procedure Num.36 (#Attr.2, #Attr.0):
    ...
    fn ir_when_idiv() {
        compiles_to_ir(
            ...
            indoc!(
                r#"
                procedure Num.32 (#Attr.2, #Attr.3, #Attr.0):
                    let Test.18 = 0i64;
    ...
    fn guard_pattern_true() {
        compiles_to_ir(
            ...
            indoc!(
                r#"
                procedure Test.0 (Test.2, #Attr.0):
                    let Test.5 = 2i64;
                    let Test.11 = true;
                    let Test.12 = 2i64;
    ...
    fn list_append_closure() {
        compiles_to_ir(
            ...
            indoc!(
                ...
                procedure List.5 (#Attr.2, #Attr.3, #Attr.0):
                    let Test.9 = lowlevel ListAppend #Attr.2 #Attr.3;
                    ret Test.9;
    ...
    fn list_len() {
        compiles_to_ir(
            ...
            indoc!(
                r#"
                procedure List.7 (#Attr.2, #Attr.0):
    ...
    fn when_joinpoint() {
        compiles_to_ir(
            ...
            indoc!(
                r#"
                procedure Test.0 (Test.4, #Attr.0):
                    let Test.2 = 0u8;
                    switch Test.2:
                        case 1:
                            let Test.9 = 1i64;
    ...
    fn if_guard_bind_variable_false() {
        compiles_to_ir(
            ...
            indoc!(
                r#"
<<<<<<< HEAD
                procedure Bool.5 (#Attr.2, #Attr.3, #Attr.0):
    ...
    fn list_pass_to_function() {
        compiles_to_ir(
            ...
            indoc!(
                r#"
<<<<<<< HEAD
                procedure Test.1 (Test.3, #Attr.0):
                    let Test.9 = 0i64;
                    let Test.10 = 0i64;
                    let Test.8 = CallByName List.4 Test.3 Test.9 Test.10;
                    ret Test.8;

                procedure List.4 (#Attr.2, #Attr.3, #Attr.4, #Attr.0):
=======
...
>>>>>>> origin/trunk
                ...
                procedure Num.16 (#Attr.2, #Attr.3, #Attr.0):
                    let Test.11 = lowlevel NumMul #Attr.2 #Attr.3;
                    ret Test.11;

<<<<<<< HEAD
                procedure Num.15 (#Attr.2, #Attr.3, #Attr.0):
    ...
    fn list_map() {
        compiles_to_ir(
            ...
            indoc!(
                ...
                procedure Test.0 (Test.6, #Attr.0):
                    let Test.27 = true;
                    let Test.29 = false;
