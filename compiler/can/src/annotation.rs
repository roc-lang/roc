...
fn can_annotation_help(
    ...
    match annotation {
        ...
        Apply(module_name, ident, type_arguments) => {
            ...
            // duplication!
            let mut uninstantiated_args = Vec::new();
            for arg in *type_arguments {
                use roc_types::types::AppliedAliasArgument;
                ...
                match arg.value {
                    ...
                    _ => {
                        ...
                        uninstantiated_args.push(AppliedAliasArgument::Concrete(arg_ann));
                    }
                }
            }
