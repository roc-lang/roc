...
pub fn types() -> MutMap<Symbol, (SolvedType, Region)> {
    ...
    add_type(Symbol::LIST_REPEAT, {
        ...
        unique_function(
            vec![
                int_type(star1),
                SolvedType::Apply(Symbol::ATTR_ATTR, vec![boolean(u), flex(elem)]),
            ],
            SolvedType::Apply(
                Symbol::ATTR_ATTR,
                vec![
                    boolean(star2),
                    SolvedType::Apply(Symbol::LIST_LIST, vec![attr_type(u, elem)]),
                ],
            ),
        )
    });

    // push : Attr * (List (Attr u a))
    //      , Attr u a
    //     -> Attr * (List (Attr u a))
    //
    ...
    add_type(Symbol::MAP_GET, {
        ...
        unique_function(
            vec![
                ...
                SolvedType::Apply(
                    Symbol::ATTR_ATTR,
                    vec![container(star2, vec![u]), flex(key)],
                ),
            ],
            SolvedType::Apply(
                Symbol::ATTR_ATTR,
    ...
    add_type(Symbol::MAP_INSERT, {
        ...
        unique_function(
            vec![
                ...
                SolvedType::Apply(
                    Symbol::ATTR_ATTR,
                    vec![container(star2, vec![v]), flex(val)],
                ),
            ],
            SolvedType::Apply(
                Symbol::ATTR_ATTR,
    ...
    add_type(Symbol::SET_INSERT, {
        ...
        unique_function(
            vec![
                ...
                SolvedType::Apply(Symbol::ATTR_ATTR, vec![container(star2, vec![u]), flex(a)]),
            ],
            SolvedType::Apply(
                Symbol::ATTR_ATTR,
                vec![
