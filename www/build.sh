...
RUSTFLAGS=-Awarnings ROC_DOCS_URL_ROOT=builtins cargo run -p roc_cli --no-default-features docs compiler/builtins/docs/Bool.roc compiler/builtins/docs/Str.roc compiler/builtins/docs/Num.roc compiler/builtins/docs/List.roc
