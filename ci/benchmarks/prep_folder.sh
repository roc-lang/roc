...
mkdir -p bench-folder/crates/cli_tests/benchmarks
mkdir -p bench-folder/crates/compiler/builtins/bitcode/src
mkdir -p bench-folder/target/release/deps
cp "crates/cli_tests/benchmarks/"*".roc" bench-folder/crates/cli_tests/benchmarks/
cp -r crates/cli_tests/benchmarks/platform bench-folder/crates/cli_tests/benchmarks/
